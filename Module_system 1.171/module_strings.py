...
#npc16 = klethi
  ...
  ("npc17_intro", "Good day to you!"),
  ("npc18_intro", "Good day to you!"),
  ("npc19_intro", "Good day to you!"),
  ("npc20_intro", "Good day to you!"),
  ("npc21_intro", "Good day to you!"),
  ("npc22_intro", "Good day to you!"),
  ...
  ("npc17_intro_response_1", "I could be. What's your story?"),
  ("npc18_intro_response_1", "I could be. What's your story?"),
  ("npc19_intro_response_1", "I could be. What's your story?"),
  ("npc20_intro_response_1", "I could be. What's your story?"),
  ("npc21_intro_response_1", "I could be. What's your story?"),
  ("npc22_intro_response_1", "I could be. What's your story?"),
  ...
  ("npc17_intro_response_2", " I have better things to do."),
  ("npc18_intro_response_2", " I have better things to do."),
  ("npc19_intro_response_2", " I have better things to do."),
  ("npc20_intro_response_2", " I have better things to do."),
  ("npc21_intro_response_2", " I have better things to do."),
  ("npc22_intro_response_2", " I have better things to do."),
...
#backstory intro
  ...
  ("npc17_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ...
  ("npc20_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc21_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc22_backstory_a", "Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
#backstory main body
  ...
  ("npc17_backstory_b","A while back, I left Geroia with a caravan of goods"), 
  ("npc18_backstory_b","A while back, I left Geroia with a caravan of goods"), 
  ("npc19_backstory_b","A while back, I left Geroia with a caravan of goods"), 
  ("npc20_backstory_b","A while back, I left Geroia with a caravan of goods"), 
  ("npc21_backstory_b","A while back, I left Geroia with a caravan of goods"), 
  ("npc22_backstory_b","A while back, I left Geroia with a caravan of goods"), 
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "Unfortunately"),
  ("npc18_backstory_c", "Unfortunately"),
  ("npc19_backstory_c", "Unfortunately"),
  ("npc20_backstory_c", "Unfortunately"),
  ("npc21_backstory_c", "Unfortunately"),
  ("npc22_backstory_c", "Unfortunately"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc17_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),
  ...
  ("npc20_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),
  ("npc21_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),
  ("npc22_backstory_later", "I do the odd job from time to time. But there's naught like steady employment, and a regular run of corpses to loot."),
  ...
  ("npc17_backstory_response_1", "I might be. What can you do?"),
  ("npc18_backstory_response_1", "I might be. What can you do?"),
  ("npc19_backstory_response_1", "I might be. What can you do?"),
  ("npc20_backstory_response_1", "I might be. What can you do?"),
  ("npc21_backstory_response_1", "I might be. What can you do?"),
  ("npc22_backstory_response_1", "I might be. What can you do?"),
  ...
  ("npc17_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),
  ...
  ("npc20_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),
  ("npc21_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),
  ("npc22_backstory_response_2", "Sorry, lass. You sound like you might be trouble."),
  ...
  ("npc17_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc18_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc19_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc20_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc21_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc22_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ...
  ("npc17_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ("npc18_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ("npc19_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ("npc20_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ("npc21_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ("npc22_signup_2", "Siegework is my speciality, although I reckon can handle myself well enough in an open battle, if need be."),
  ...
  ("npc17_signup_response_1", "It sounds like you can do the job. I will hire you."),
  ...
  ("npc20_signup_response_1", "It sounds like you can do the job. I will hire you."),
  ("npc21_signup_response_1", "It sounds like you can do the job. I will hire you."),
  ("npc22_signup_response_1", "It sounds like you can do the job. I will hire you."),
...
#11
  ...
  ("npc17_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ...
  ("npc20_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ("npc21_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ("npc22_signup_response_2", "To be honest, I'd prefer someone who was a little less tempted to larceny."),
  ...
  ("npc17_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ("npc18_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ("npc19_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ("npc20_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ("npc21_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ("npc22_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
...
### set off by behavior after victorious battle
  ...
  ("npc17_retirement_speech", "I'm a bit tired of"),
  ("npc18_retirement_speech", "I'm a bit tired of"),
  ("npc19_retirement_speech", "I'm a bit tired of"),
  ("npc20_retirement_speech", "I'm a bit tired of"),
  ("npc21_retirement_speech", "I'm a bit tired of"),
  ("npc22_retirement_speech", "I'm a bit tired of"),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc17_home_recap", "I'm from the undead"),
  ("npc18_home_recap", "I'm from the undead"),
  ("npc19_home_recap", "I'm from the undead"),
  ("npc20_home_recap", "I'm from the undead."),
  ("npc21_home_recap", "I'm from the undead."),
  ("npc22_home_recap", "I'm from the undead"),
...
#courtship
  ...
  ("kingdom_7_adjective",                     "Zenda"),
  ("kingdom_undead_adjective",                     "Undead Heresy"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_8", "Bishop {s0}"),
  ...
  ("faction_title_female_8", "Bishop Lady {s0}"),
  ...
  ("bandit_hideout_welcome", "You approach the hideout. The {s4} welcome you to {s5} "),
...
("the_coast", "the coast"),
  ...
  ("kidnap_suc", "You managed to tie up the rich man and get a big ransom and escape."),
  ("sea_raiders_army_appear","The sea raiders army has emerged at Rivacheg,the chamber of Commerce paid big money to admire them"),
  ("desert_bandits_army_appear","The desert bandits army has emerged at Ahmerrad,the chamber of Commerce paid big money to admire them"),
  ("forest_bandits_army_appear","The forest bandits army has emerged at Ahmerrad,the chamber of Commerce paid big money to admire them"),
  ("steppe_bandits_army_appear","The steppe bandits army has emerged at Ahmerrad,the chamber of Commerce paid big money to admire them"),
  ("taiga_bandits_army_appear","The taiga bandits army has emerged at Ahmerrad,the chamber of Commerce paid big money to admire them"),
  ("mountain_bandits_army_appear","The mountain bandits army has emerged at Ahmerrad,the chamber of Commerce paid big money to admire them"),
  
  ("traveling_businessmen_appear","Alog Sennar's huge armed caravan began its journey from Dherim"),
  
  ("sea_raiders_army_qust","wipe out sea raiders army"),
  ("desert_bandits_army_qust","wipe out desert bandits army"),
  ("forest_bandits_army_qust","wipe out forest bandits army"),
  ("steppe_bandits_army_qust","wipe out steppe bandits army"),
  ("taiga_bandits_army_qust","wipe out taiga bandits army"),
  ("mountain_bandits_army_qust","wipe out mountain bandits army"),
  ("deal_skolderbrotva_team_qust","wipe out skolderbrotva team"),
  ("kill_local_merchant_1_qust","kill rich local merchant {s3} qust"),
  ("loot_khanate_village_message","Ransacked {reg3} Kujit villages"),
  ("loot_sarranid_merchant_message","Loot {reg3} Sarranid merchant"),
  ("party_strength","Party strength {reg0}"),
  ("undead_start","undead mod start"),
  ("bandit_start","bandit mod start"),
  ("civilian_mod_start","civilian mod start"),
  ...
  ("mod_option","Mod option"), 
  ("mod_option1","NPC departure"), 
  ("mod_option2","Mounted shooting AI"), 
  ("mod_option3","The cavalry returns to charge AI"), 
  ("mod_option4","Allow flight with flying AI"), 
  ("mod_option5","Allow hit-and-fly switch"), 
  ("mod_option6","Friendly forces avoid the player"), 
  
  ("remaining","Remaining:{reg10}"), 
  ("own","Own:{reg10}"), 
  ("expend","Expend:{reg10}"), 
  #INVASION MODE END
  
  ("empty_string","Empty string"), 
  ("driving_vehicle","Driving vehicle"), 
