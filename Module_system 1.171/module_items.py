...
imodbits_magic_staff = imodbit_cracked|imodbit_fine| imodbit_large_bag


magic_attack_trigger = [
  (ti_on_weapon_attack, 
    [
     (store_trigger_param_1, ":agent_shooter"),
     (agent_play_sound, ":agent_shooter","snd_magic_attack"),
    

    ])]
    
magic_undead_missile_hit = [
  (ti_on_missile_hit, 
    [
     (store_trigger_param_1, ":agent_shooter"),
     ...
     (agent_get_troop_id,":troop_id",":agent_shooter"),
     #(agent_get_wielded_item,":item_weapon",":agent_shooter"),
     (store_skill_level, ":cur_skill", "skl_power_magic", ":troop_id"),
     (store_mul,":value",":cur_skill",2),
     #(store_mul,":harm",":cur_skill",3),
     #(store_mul,":dist_judg",":cur_skill",4),
     (val_add,":value",4),
     (particle_system_burst,"psys_undead_magic_fire_purple",pos1,":value"),
     
    ])]

magic_sept_missile_hit = [
  (ti_on_missile_hit, 
    [
     (store_trigger_param_1, ":agent_shooter"),
     (agent_get_team,":team_shooter",":agent_shooter"),
     #(copy_position,pos10,pos1),
     (copy_position,pos5,pos1),
     #(position_move_z,pos10,50),
     ...
     (store_skill_level, ":cur_skill", "skl_power_magic", ":troop_id"),
     (store_mul,":value",":cur_skill",2),
     (store_mul,":harm",":cur_skill",2),
     (store_mul,":dist_judg",":cur_skill",3),
     (val_add,":value",4),
     (particle_system_burst,"psys_sept_magic_fire_purple",pos1,":value"),   
     ...
     (try_for_agents,":possable_agent"),
       ...
       (try_begin),
          ...
          (agent_get_horse,":horse",":possable_agent"),
          (try_begin),
            (gt, ":horse", -1),
            (position_move_z,pos3,180),
          (else_try),
     ...
     (le,":dist",":dist_judg"),
     (agent_get_team,":team_possable",":possable_agent"),
     (try_begin),
        (eq,":team_shooter",":team_possable"),
        #(store_agent_hit_points, ":agent_hit_points", ":possable_agent",1),
        #(val_add,":agent_hit_points",":harm"),
        #(agent_set_hit_points,":possable_agent",":agent_hit_points",1),
     (else_try),
        (agent_deliver_damage_to_agent,":agent_shooter",":possable_agent",":harm",":item_weapon"),
        (call_script,"script_cf_attack_agent_play_sound",":possable_agent",0),
     (try_end),
   (try_end),     
    ])]
    
magic_undead_dragon_missile_hit = [
  (ti_on_missile_hit, 
    [
     ...
     (try_begin),
        ...
        (eq,":object_type",4),
        (particle_system_burst,"psys_undead_magic_fire_purple",pos5,30),
     (else_try),
        (particle_system_burst,"psys_undead_magic_fire_purple",pos5,10),
     (try_end),
...
explosive_arrows_missile_hit = [
  (ti_on_missile_hit, 
    [
     ...
     (particle_system_burst,"psys_explosive_arrows_fire",pos5,10),
     (agent_get_troop_id,":troop_id",":agent_shooter"),
     (store_skill_level, ":power_magic", "skl_power_magic", ":troop_id"),
     (store_skill_level, ":power_draw", "skl_power_draw", ":troop_id"),
     (store_mul,":harm",":power_draw",5),
     (store_mul,":harm_add",":harm",":power_magic"),
     (val_div,":harm_add",10),
     (store_add,":harm",":harm",":harm_add"),
     
     (agent_get_team,":team_shooter",":agent_shooter"),
     (agent_get_wielded_item, ":wielded_item", ":agent_shooter", 0),
     #保护防止玩家突然切换武器或者空手
     (try_begin),
        (lt,":wielded_item",0),
        (assign,":wielded_item","itm_tutorial_short_bow"),
     (else_try),
     ...
     (try_for_agents,":enemies",pos5,300),
        (agent_is_human,":enemies"),
        (agent_is_alive,":enemies"),
        (agent_get_team,":enemies_team",":enemies"),
        (teams_are_enemies,":team_shooter",":enemies_team"),
        (agent_get_position,pos6,":enemies"),
        
        (assign,":impact_level",0),
        (try_begin),
            (ge,":harm",50),
            (assign,":impact_level",1),
            (ge,":harm",100),
            (assign,":impact_level",2),
            (ge,":harm",200),
            (assign,":impact_level",3),
        (try_end),
        (assign,":behind",0),
        (try_begin),#判断玩家是否在敌人后面
           (ge,":impact_level",1),
           (position_is_behind_position,pos5,pos6),
           (assign,":behind",1),
        (try_end),
        
        (agent_deliver_damage_to_agent, ":agent_shooter", ":enemies",0),
        (agent_deliver_damage_to_agent, ":agent_shooter", ":enemies",":harm",":wielded_item"),
        (call_script,"script_cf_attack_agent_play_sound",":enemies",":impact_level",":behind"),
     (try_end),
     
])]
tank_shell_missile_hit = [
  (ti_on_missile_hit, 
    [
     (set_fixed_point_multiplier, 100),
     ...
     (particle_system_burst,"psys_explosive_tank_fire",pos5,10),
    
     (try_for_agents,":enemies",pos5,1000),
        (agent_is_human,":enemies"),
        (agent_is_alive,":enemies"),
        (agent_get_team,":enemies_team",":enemies"),
        (teams_are_enemies,":team_shooter",":enemies_team"),
        ...
        (agent_deliver_damage_to_agent, ":agent_shooter", ":enemies",500),
        (call_script,"script_cf_attack_agent_play_sound",":enemies",":impact_level",":behind"),
     (try_end),
     
])]

artillery_ammunition_missile_hit = [
  (ti_on_missile_hit, 
    [
     (set_fixed_point_multiplier, 100),
     ...
     (try_for_agents,":enemies",pos5,300),
        ...
        (agent_deliver_damage_to_agent, ":agent_shooter", ":enemies",200),
        (call_script,"script_cf_attack_agent_play_sound",":enemies",":impact_level",":behind"),
     (try_end),
      ...
      (ti_on_missile_hit,
        [
          ...
          (try_begin),
            ...
            (display_message, "@Shot distance: {reg61} meters.", 0xCCCCCC),
          (try_end),
])]
## CC
...
#foods (first one is wine)
 ["wine","Wine", [("amphora_slim",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 220,weight(30)|abundance(60)|max_ammo(50)|food_quality(200),imodbits_none],
 ["ale","Ale", [("ale_barrel",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 120,weight(30)|abundance(70)|max_ammo(50)|food_quality(100),imodbits_none],
...
# Carthorse, hunter, heavy hunter, hackney, palfrey, courser, destrier.
 ...
 ["came","Came", [("camel",0)], itp_merchandise|itp_type_horse, 0, 400,abundance(80)|hit_points(140)|body_armor(20)|difficulty(1)|horse_speed(38)|horse_maneuver(39)|horse_charge(8)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_3, fac_kingdom_6]],
 ...
 ["courser_pluse","Courser Pluse", [("exp_charger_w",0)], itp_merchandise|itp_type_horse, 0, 800,abundance(70)|body_armor(28)|hit_points(110)|difficulty(2)|horse_speed(50)|horse_maneuver(44)|horse_charge(12)|horse_scale(106),imodbits_horse_basic|imodbit_champion],
 ...
 ["undead_hunter","Undead Hunter", [("zombi_horse",0),("zombi_horse",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 510,abundance(60)|hit_points(320)|body_armor(36)|difficulty(3)|horse_speed(32)|horse_maneuver(40)|horse_charge(20)|horse_scale(100),imodbits_horse_basic|imodbit_champion,[],[fac_kingdom_undead]],
 ["hunter_pluse_a","Hunter Pluse", [("exp_charger_b",0),("exp_charger_b",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 910,abundance(60)|hit_points(160)|body_armor(32)|difficulty(3)|horse_speed(43)|horse_maneuver(44)|horse_charge(24)|horse_scale(108),imodbits_horse_basic|imodbit_champion],
 ["hunter_pluse_b","Hunter Pluse", [("exp_charger_c",0),("exp_charger_c",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 910,abundance(60)|hit_points(160)|body_armor(30)|difficulty(3)|horse_speed(45)|horse_maneuver(44)|horse_charge(24)|horse_scale(108),imodbits_horse_basic|imodbit_champion],
 ["warhorse","War Horse", [("warhorse_chain",0)], itp_merchandise|itp_type_horse, 0, 1424,abundance(50)|hit_points(165)|body_armor(40)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
 ["sarranid_light_warhorse","Sarranian Light Warhorse", [("3lamellar_charger",0)], itp_merchandise|itp_type_horse, 0, 1200,abundance(70)|hit_points(160)|body_armor(35)|difficulty(3)|horse_speed(43)|horse_maneuver(48)|horse_charge(36)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_6]],
 ["warhorse_sarranid","Sarranian War Horse", [("warhorse_sarranid",0)], itp_merchandise|itp_type_horse, 0, 1911,abundance(40)|hit_points(165)|body_armor(50)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_6]],
 ["warhorse_steppe","Steppe Charger", [("warhorse_steppe",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(45)|hit_points(150)|body_armor(40)|difficulty(4)|horse_speed(44)|horse_maneuver(50)|horse_charge(28)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_3,fac_kingdom_2]],
 ["charger","Charger Red", [("charger_new",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(47)|difficulty(4)|horse_speed(42)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1]],
 ["charger_1","Scale Piece Charger", [("lamellar_charger_a",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(42)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_5]],
 ["charger_2","Charger Light", [("war_horse_03",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(43)|horse_maneuver(48)|horse_charge(30)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_5]],
 ["charger_3_1","Charger Light", [("5warhorse_holy",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(43)|horse_maneuver(48)|horse_charge(30)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["charger_3","Charger Blacak", [("chargerblack",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(50)|difficulty(4)|horse_speed(39)|horse_maneuver(43)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["charger_4","Charger general", [("charger2",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(48)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_5]],
 ["charger_5","Charger White", [("barded5W",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(43)|horse_maneuver(42)|horse_charge(36)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_sept]],
 ["charger_undead_a","Charger Undead Red", [("kongjuzhanma",0)], itp_merchandise|itp_type_horse, 0, 1711,abundance(40)|hit_points(150)|body_armor(42)|difficulty(4)|horse_speed(46)|horse_maneuver(44)|horse_charge(28)|horse_scale(103),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["charger_undead_b","Charger Undead Black", [("siwangzhanma",0)], itp_merchandise|itp_type_horse, 0, 1711,abundance(40)|hit_points(150)|body_armor(45)|difficulty(4)|horse_speed(42)|horse_maneuver(44)|horse_charge(32)|horse_scale(103),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["charger_undead_c","Charger Undead blue", [("youlingzhanma",0)], itp_merchandise|itp_type_horse, 0, 1711,abundance(40)|hit_points(150)|body_armor(42)|difficulty(4)|horse_speed(44)|horse_maneuver(45)|horse_charge(29)|horse_scale(103),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["undead_horse","Undead Horse", [("barf_skeletal_horse",0),("barf_skeletal_horse",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 320,abundance(90)|hit_points(70)|body_armor(6)|difficulty(1)|horse_speed(52)|horse_maneuver(42)|horse_charge(12)|horse_scale(100),imodbits_horse_basic,[], [fac_kingdom_undead]],
 ["plate_horse","Plate armour horse", [("charger_01",0)], itp_merchandise|itp_type_horse, 0, 2500,abundance(40)|hit_points(165)|body_armor(55)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(34)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], []],
 ["plate_horse_1","Plate armour horse", [("charger_02",0)], itp_merchandise|itp_type_horse, 0, 2500,abundance(40)|hit_points(165)|body_armor(60)|difficulty(4)|horse_speed(38)|horse_maneuver(44)|horse_charge(40)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["plate_horse_2","Plate armour horse", [("charger_03",0)], itp_merchandise|itp_type_horse, 0, 2800,abundance(40)|hit_points(165)|body_armor(55)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(34)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_sept]],
 ["plate_horse_3","Plate armour horse", [("WPlatedCharger2",0)], itp_merchandise|itp_type_horse, 0, 2300,abundance(40)|hit_points(165)|body_armor(52)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], []],
 ["plate_horse_4","Plate armour horse", [("heavy_charger",0)], itp_merchandise|itp_type_horse, 0, 2600,abundance(40)|hit_points(165)|body_armor(52)|difficulty(5)|horse_speed(45)|horse_maneuver(42)|horse_charge(36)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], []],
 ["plate_horse_5","Plate armour horse", [("WPlatedCharger9",0)], itp_merchandise|itp_type_horse, 0, 2500,abundance(40)|hit_points(165)|body_armor(55)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(34)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_undead]],
 ["barded_warhorse","Barded Warhorse", [("barded8W",0)], itp_merchandise|itp_type_horse, 0, 3500,abundance(40)|hit_points(165)|body_armor(42)|difficulty(4)|horse_speed(45)|horse_maneuver(46)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_5]],
 ["griffin","Griffin", [("shijiu0",0),("shijiu0",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 4500,abundance(25)|hit_points(170)|body_armor(40)|difficulty(6)|horse_speed(50)|horse_maneuver(40)|horse_charge(35)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_1]],
 ["royal_griffin","Royal Griffin", [("shijiu",0),("shijiu",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 5500,abundance(25)|hit_points(200)|body_armor(55)|difficulty(6)|horse_speed(50)|horse_maneuver(45)|horse_charge(40)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_1]],
 ["bone_dragon","Bone Dragon", [("bonedrake",0),("bonedrake",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 6500,abundance(25)|hit_points(250)|body_armor(40)|difficulty(7)|horse_speed(55)|horse_maneuver(36)|horse_charge(45)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_undead]],
 ["shad_dragon","Shad Dragon", [("yinyinglong",0),("yinyinglong",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 7000,abundance(25)|hit_points(350)|body_armor(50)|difficulty(7)|horse_speed(50)|horse_maneuver(30)|horse_charge(50)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_4]],
 ["golden_dragon","Golden Dragon", [("fire_dragon",0),("fire_dragon",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 7500,abundance(25)|hit_points(380)|body_armor(50)|difficulty(7)|horse_speed(45)|horse_maneuver(28)|horse_charge(55)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_6]],
 ["ico_dragon","Golden Dragon", [("ice_dragon",0),("ice_dragon",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 7500,abundance(25)|hit_points(380)|body_armor(50)|difficulty(7)|horse_speed(45)|horse_maneuver(28)|horse_charge(55)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_6]],
 ["shadow_dragon","Shad Dragon", [("anheilong",0),("anheilong",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 8000,abundance(25)|hit_points(350)|body_armor(60)|difficulty(8)|horse_speed(52)|horse_maneuver(28)|horse_charge(55)|horse_scale(112 ),imodbits_horse_basic,[], [fac_kingdom_2]],
 ["demon_dragon","Demon Dragon", [("fxg",0),("fxg",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 8000,abundance(25)|hit_points(280)|body_armor(45)|difficulty(6)|horse_speed(53)|horse_maneuver(40)|horse_charge(48)|horse_scale(112),imodbits_horse_basic,[], [fac_kingdom_undead]],
 ["earthworm_dragon","Earthworm Dragon", [("Earthworm",0),("Earthworm",imodbits_horse_good)], itp_unique|itp_merchandise|itp_type_horse, 0, 40000,abundance(25)|hit_points(800)|body_armor(100)|difficulty(10)|horse_speed(65)|horse_maneuver(10)|horse_charge(100)|horse_scale(120),imodbits_horse_basic,[], [fac_kingdom_undead]],
 ["destroy_dragon","Destroy Dragon", [("yuangumolong",0),("yuangumolong",imodbits_horse_good)], itp_unique|itp_merchandise|itp_type_horse, 0, 40000,abundance(25)|hit_points(800)|body_armor(100)|difficulty(10)|horse_speed(65)|horse_maneuver(10)|horse_charge(100)|horse_scale(120),imodbits_horse_basic,[], [fac_kingdom_undead]],
...
#whalebone crossbow, yew bow, war bow, arming sword 
 ...
 72,weight(3)|abundance(160)|weapon_length(95)|thrust_damage(1,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger],
 ...
 410,weight(3.5)|abundance(30)|weapon_length(95)|thrust_damage(3,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger],
 ...
 124,weight(3)|abundance(70)|weapon_length(95)|thrust_damage(2,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger],
 ...
 350,weight(3)|abundance(50)|weapon_length(91)|thrust_damage(3,pierce)|max_ammo(28),imodbits_missile,missile_distance_trigger],
 ["fuel_arrows","Fuel Arrows", [("amazon_arrow",0),("huojian_fly",ixmesh_flying_ammo),("huojian_fly",ixmesh_inventory),("quiver_c", ixmesh_carry)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 
 650,weight(4)|abundance(50)|weapon_length(91)|thrust_damage(5,pierce)|max_ammo(28),imodbits_missile,fuel_arrows_missile_hit],
 ...
 64,weight(2.25)|abundance(90)|weapon_length(63)|thrust_damage(1,pierce)|max_ammo(29),imodbits_missile,missile_distance_trigger ],
 ...
 210,weight(2.5)|abundance(20)|weapon_length(63)|thrust_damage(2,pierce)|max_ammo(29),imodbits_missile,missile_distance_trigger],
 ["fuel_bolts","Steel Bolts", [("bolt",0),("huojian_fly",ixmesh_flying_ammo),("bolt_bag_c", ixmesh_carry)], itp_type_bolts|itp_merchandise|itp_can_penetrate_shield, itcf_carry_quiver_right_vertical, 
 420,weight(3)|abundance(20)|weapon_length(63)|thrust_damage(3,pierce)|max_ammo(29),imodbits_missile,fuel_arrows_missile_hit],
 
 ["hight_fire_arrows","Hight Fire Arrows", [("toumingtou",0),("hight_fire_arrow",ixmesh_flying_ammo),("hight_fire_arrow",ixmesh_inventory),("quiver_c", ixmesh_carry)], itp_no_pick_up_from_ground|itp_type_arrows|itp_unique|itp_can_penetrate_shield, itcf_carry_quiver_back_right, 
 6500,weight(4)|abundance(50)|weapon_length(91)|thrust_damage(20,pierce)|max_ammo(28),imodbits_missile,fuel_arrows_missile_hit],

 ["explosive_arrows","Explosive Fire Arrows", [("toumingtou",0),("explosive_arrows",ixmesh_flying_ammo),("explosive_arrows",ixmesh_inventory),("quiver_c", ixmesh_carry)], itp_no_pick_up_from_ground|itp_type_arrows|itp_unique|itp_can_penetrate_shield, itcf_carry_quiver_back_right, 
 6500,weight(4)|abundance(50)|weapon_length(91)|thrust_damage(20,pierce)|max_ammo(28),imodbits_missile,explosive_arrows_missile_hit], 

 ["cartridges","Cartridges", [("cartridge_a",0)], itp_type_bullets|itp_merchandise|itp_can_penetrate_shield|itp_default_ammo, 0, 
 600,weight(2.25)|abundance(90)|weapon_length(3)|thrust_damage(1,pierce)|max_ammo(50),imodbits_missile],
 
 ["artillery_ammunition","Artillery ammunition", [("artillery_ammunition",0),("artillery_ammunition",ixmesh_flying_ammo),("artillery_ammunition", ixmesh_inventory)], itp_type_bullets|itp_unique|itp_can_penetrate_shield|itp_default_ammo, 0, 
 10000,weight(5)|abundance(90)|weapon_length(20)|thrust_damage(50,pierce)|max_ammo(30),imodbits_missile,artillery_ammunition_missile_hit],
 
 ["tank_shell","Tank Shell", [("artillery_ammunition",0),("artillery_ammunition",ixmesh_flying_ammo),("artillery_ammunition", ixmesh_inventory)], itp_type_bullets|itp_unique|itp_can_penetrate_shield|itp_default_ammo, 0, 
 10000,weight(50)|abundance(90)|weapon_length(20)|thrust_damage(100,pierce)|max_ammo(1),imodbits_missile,tank_shell_missile_hit],
 
 ["magic_undead","Magic Undead Ammos", [("magic_undead",0),("magic_undead",ixmesh_flying_ammo),("magic_undead", ixmesh_inventory)], itp_merchandise|itp_type_bullets|itp_can_penetrate_shield|itp_default_ammo|itp_is_magic_staff, 0, 
 4000,weight(0)|abundance(40)|weapon_length(3)|thrust_damage(3,pierce)|max_ammo(30),imodbits_missile,magic_undead_missile_hit,[fac_kingdom_undead]],
 
 ["magic_step","Magic Step Ammos", [("holy_ball",0),("holy_ball",ixmesh_flying_ammo),("holy_ball", ixmesh_inventory)], itp_type_bullets|itp_merchandise|itp_can_penetrate_shield|itp_default_ammo|itp_is_magic_staff, 0, 
 4000,weight(0)|abundance(40)|weapon_length(3)|thrust_damage(1,pierce)|max_ammo(30),imodbits_missile,magic_sept_missile_hit,[fac_kingdom_sept]],
 

 ["magic_undead_dragon","Magic Undead Dragon Ammos", [("fireThree",0),("fireThree",ixmesh_flying_ammo),("fireThree", ixmesh_inventory)], itp_type_bullets|itp_unique|itp_can_penetrate_shield|itp_default_ammo|itp_is_magic_staff, 0, 
 15000,weight(0)|abundance(0)|weapon_length(10)|thrust_damage(1,pierce)|max_ammo(30),imodbits_missile,magic_undead_dragon_missile_hit],
...
["fur_gauntlets","Fur Gauntlets", [("beargauntlets_L",0),("beargauntlets_L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 1040, weight(1.2)|abundance(100)|body_armor(8)|difficulty(0),imodbits_armor],
["steel_gauntlets","Steel Gauntlets", [("steel_gauntlets_L",0),("steel_gauntlets_L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 1500, weight(0.8)|abundance(100)|body_armor(7)|difficulty(0),imodbits_armor,[]],
["steel_mittens","Steel mittens", [("steel_mittens_L",0),("steel_mittens_L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 1800, weight(1.0)|abundance(50)|body_armor(8)|difficulty(0),imodbits_armor],
["black_steel_mittens","Blacak Steel mittens", [("g_scale_gauntlets_a_L",0),("g_scale_gauntlets_a_L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 1900, weight(1.0)|abundance(50)|body_armor(9)|difficulty(0),imodbits_armor,[],[fac_kingdom_undead]],
["black_steel_mittens_a","Blacak Steel mittens", [("twilight_gloves_L",0),("twilight_gloves_L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 2400, weight(1.0)|abundance(50)|body_armor(11)|difficulty(0),imodbits_armor,[],[fac_kingdom_undead]],
["dark_steel_mittens","Dark Steel mittens", [("Black_Knight-L",0),("Black_Knight-L",imodbit_reinforced)], itp_merchandise|itp_type_hand_armor,0, 2800, weight(1.0)|abundance(50)|body_armor(12)|difficulty(0),imodbits_armor,[],[fac_kingdom_undead]],
["carved_gauntlets","Carved Gauntlets", [("female_plate_falcon_fist_L",0)], itp_unique|itp_type_hand_armor,0, 1500, weight(0.8)|abundance(0)|body_armor(8)|difficulty(0),imodbits_armor],
["carved_gauntlets_1","Carved Gold Gauntlets", [("female_plate_falcon_gold_fist_L",0)], itp_unique|itp_type_hand_armor,0, 1600, weight(0.8)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["carved_gauntlets_2","Carved Gold Gauntlets", [("female_plate_falcon_fist_blue_L",0)], itp_unique|itp_type_hand_armor,0, 1500, weight(0.8)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["carved_gauntlets_3","Carved Gold Gauntlets", [("female_plate_falcon_fist_blck_L",0)], itp_unique|itp_type_hand_armor,0, 2000, weight(0.8)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["iron_gloves_red_undead","Carved Gold Gauntlets", [("kongjuhushou_L",0)], itp_unique|itp_type_hand_armor,0, 1120, weight(1)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["iron_gloves_black_undead","Carved Gold Gauntlets", [("siwangshou_L",0)], itp_unique|itp_type_hand_armor,0, 1120, weight(1)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["iron_gloves_blue_undead","Carved Gold Gauntlets", [("youlingshou_L",0)], itp_unique|itp_type_hand_armor,0, 1120, weight(1)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
["jinweishou","Carved Gold Gauntlets", [("jinweishou-L",0)], itp_unique|itp_type_hand_armor,0, 1120, weight(1)|abundance(25)|body_armor(8)|difficulty(0),imodbits_armor],
#footwear
...
["bear_boots", "Bear Boots", [("bear_boots",0)], itp_merchandise| itp_type_foot_armor  |itp_civilian | itp_attach_armature,0,
 370 , weight(2.5)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(26)|difficulty(0) ,imodbits_armor ],
...
["heresy_mail_chausses", "Mail Chausses", [("g_mail_chausses_a",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature  ,0,
 630 , weight(3.3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(27)|difficulty(0) ,imodbits_armor ],
...
["heresy_mail_boots", "Heresy Mail Boots", [("g_mail_boots_a",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature  ,0,
 1350 , weight(3.3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(33)|difficulty(8) ,imodbits_armor ],
...
["black_greaves", "Black Greaves", [("black_greaves",0)], itp_merchandise|itp_type_foot_armor  | itp_attach_armature,0,
 2361 , weight(3.5)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(0) ,imodbits_armor,[],[fac_kingdom_undead] ],
["black_greaves_a", "Black Greaves", [("twilight_boots",0)], itp_merchandise|itp_type_foot_armor  | itp_attach_armature,0,
 2461 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(37)|difficulty(0) ,imodbits_armor,[],[fac_kingdom_undead] ],
...
["mail_with_tunic_red", "Res Mail with Tunic", [("arena_armorR_new",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor ,[],[fac_kingdom_1]],
["mail_with_tunic_green", "Green Mail with Tunic", [("arena_armorG_new",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor ,[],[fac_kingdom_5]],
["mail_with_tunic_blue", "Blue Mail with Tunic", [("arena_armorB_new",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor ],
["mail_with_tunic_white", "White Mail with Tunic", [("arena_armorW_new",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor,[],[fac_kingdom_sept] ],
["mail_with_tunic_yellow", "Yellow Mail with Tunic", [("arena_armorY_new",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor ],
["mail_with_tunic_black", "Yellow Mail with Tunic", [("arena_armorBlack",0)], itp_type_body_armor  |itp_covers_legs ,0, 600 , weight(16)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8), imodbits_armor ],
["hide_coat", "Hide Coat", [("nobleman_outf",0)], itp_type_body_armor|itp_covers_legs|itp_civilian,0, 348 , weight(4)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(10)|difficulty(0) ,imodbits_cloth ,[],[fac_kingdom_undead]],
...
["robe_a", "Robe", [("gandaofu_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(1.5)|abundance(100)|head_armor(0)|body_armor(18)|leg_armor(8)|difficulty(0) ,imodbits_cloth ,[],[fac_kingdom_sept]],
...
["red_gambeson", "Red Gambeson", [("red_gambeson_a",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian,0,
 ...
 ["white_gambeson", "white Gambeson", [("white_gambeson_a",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian,0,
 275 , weight(5)|abundance(100)|head_armor(0)|body_armor(21)|leg_armor(5)|difficulty(0) ,imodbits_cloth ],
 ["green_gambeson", "Green Gambeson", [("green_gambeson_a",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian,0,
 275 , weight(5)|abundance(100)|head_armor(0)|body_armor(21)|leg_armor(5)|difficulty(0) ,imodbits_cloth ],
 ["yellow_gambeson", "Yellow Gambeson", [("empire_gambeson_a",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian,0,
 275 , weight(5)|abundance(100)|head_armor(0)|body_armor(21)|leg_armor(5)|difficulty(0) ,imodbits_cloth ],
 ["black_gambeson", "Black Gambeson", [("black_gambeson_a",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs|itp_civilian,0,
 275 , weight(5)|abundance(100)|head_armor(0)|body_armor(21)|leg_armor(5)|difficulty(0) ,imodbits_cloth,[],[fac_kingdom_undead] ],
 
 ["blue_gambeson_plate", "Red Gambeson Plate", [("cuirass_on_blue",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120  , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], []],
 ["red_gambeson_plate", "Red Gambeson Plate", [("cuirass_on_red",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120  , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], []],
 ["white_gambeson_plate", "white Gambeson Plate", [("cuirass_on_white",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120 , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], []],
 ["green_gambeson_plate", "Green Gambeson Plate", [("cuirass_on_green",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120 , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], []],
 ["yellow_gambeson_plate", "Yellow Gambeson Plate", [("cuirass_on_empire",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120 , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], []],
 ["black_gambeson_plate", "Black Gambeson Plate", [("cuirass_on_black",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1120 , weight(12)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(5)|difficulty(0) ,imodbits_cloth ,[], [fac_kingdom_undead]],
...
["demonrobe", "Demonrobe", [("demonrobe",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 720 , weight(17)|abundance(100)|head_armor(0)|body_armor(36)|leg_armor(13)|difficulty(0) ,imodbits_armor,[],[fac_kingdom_undead] ],
...
["surgeon", "Surgeon", [("surgeon",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 500 , weight(13)|abundance(100)|head_armor(0)|body_armor(28)|leg_armor(10)|difficulty(0) ,imodbits_cloth ,[]],
 
["gandaofu", "Gandaofu", [("gandaofu",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 600 , weight(13)|abundance(100)|head_armor(0)|body_armor(29)|leg_armor(11)|difficulty(0) ,imodbits_cloth ,[],[],[fac_kingdom_sept]],

["priest_1", "priest_1", [("priest_1",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 600 , weight(13)|abundance(100)|head_armor(0)|body_armor(29)|leg_armor(11)|difficulty(0) ,imodbits_cloth ,[],[],[fac_kingdom_sept]],
 

["priest", "Priest", [("priest_2",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 700 , weight(15)|abundance(100)|head_armor(0)|body_armor(32)|leg_armor(12)|difficulty(0) ,imodbits_cloth ,[],[fac_kingdom_sept]],
 
["priest_a", "Priest", [("priest_2_1",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 700 , weight(15)|abundance(100)|head_armor(0)|body_armor(32)|leg_armor(12)|difficulty(0) ,imodbits_cloth ,[],[fac_kingdom_sept]],
 
["sorceress_coat", "Sorceress coat", [("womanbodAA",0)], itp_merchandise| itp_type_body_armor |itp_civilian |itp_covers_legs |itp_civilian,0,
 800 , weight(10)|abundance(100)|head_armor(0)|body_armor(32)|leg_armor(12)|difficulty(0) ,imodbits_cloth ,[],[fac_kingdom_undead]],
...
["surcoat", "Surcoat", [("teu_sariant_surcoat",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 825 , weight(17)|abundance(100)|head_armor(0)|body_armor(40)|leg_armor(6)|difficulty(6) ,imodbits_armor ],
...
["haubergeon_e", "Haubergeon", [("haubergeon_e",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 863 , weight(18)|abundance(100)|head_armor(0)|body_armor(41)|leg_armor(6)|difficulty(6) ,imodbits_armor ,[],[fac_kingdom_5]],
 
["haubergeon_h", "Haubergeon", [("haubergeon_h",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 863 , weight(18)|abundance(100)|head_armor(0)|body_armor(41)|leg_armor(6)|difficulty(6) ,imodbits_armor,[],[fac_kingdom_undead]],
...
["mail_shirt_a", "Mail Shirt", [("mail_shirt_blk",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1040 , weight(19)|abundance(100)|head_armor(0)|body_armor(37)|leg_armor(12)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_undead]],
...
["mail_hauberk_sexy", "Mail Hauberk Sexy", [("hauberk_a_new",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1320 , weight(19)|abundance(100)|head_armor(0)|body_armor(40)|leg_armor(12)|difficulty(7) ,imodbits_armor ],
...
["mail_with_surcoat_a", "Mail with Surcoat", [("mail_long_surcoat_new_e",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["mail_with_surcoat_b", "Mail with Surcoat", [("teu_brother_surcoat_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
["mail_with_surcoat_c", "Mail with Surcoat", [("teu_brother_surcoat_d",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
 
["mail_with_surcoat_d", "Mail with Surcoat", [("teu_mail_long_surcoat_d",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
["mail_with_surcoat_e", "Mail with Surcoat", [("teu_mail_long_surcoat_i",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
 
["mail_with_surcoat_f", "Mail with Surcoat", [("teu_mail_long_surcoat_h",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
 
["mail_with_surcoat_g", "Mail with Surcoat", [("teu_hochmeister_surcoat",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
["heresy_mail_with_surcoat", "Heresy Mail with Surcoat", [("g_tabard_b",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["heresy_mail_with_surcoat_pluse", "Heresy Mail with Surcoat", [("g_tabard_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1844 , weight(25)|abundance(100)|head_armor(0)|body_armor(48)|leg_armor(14)|difficulty(7) ,imodbits_armor,[],[fac_kingdom_undead] ],
...
["lamellar_armor", "Lamellar Armor", [("lamellar_armor_b",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 2410 , weight(25)|abundance(100)|head_armor(0)|body_armor(48)|leg_armor(13)|difficulty(7) ,imodbits_armor ],
...
["heresy_banded_armor", "Heresy Banded Armor", [("g_reinf_jerkin_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 2910 , weight(26)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(14)|difficulty(8) ,imodbits_armor ,[],[fac_kingdom_undead]],
...
["mail_hauberk_plate", "Mail Hauberk Plate", [("splate_armor2",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs,0,
 4600 , weight(24)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(14)|difficulty(8) ,imodbits_armor ],


["mail_hauberk_plate_pluse", "Mail Hauberk Plate Pluse", [("splate_armor",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 6000 , weight(28)|abundance(100)|head_armor(0)|body_armor(62)|leg_armor(16)|difficulty(10) ,imodbits_plate ],
 

["mail_and_plate", "Mail And Plate", [("mail_and_plate",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 3800 , weight(27)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(12)|difficulty(8) ,imodbits_armor ],
["light_mail_and_plate", "Light Mail And Plate", [("light_mail_and_plate",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 3600 , weight(26)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(10)|difficulty(8) ,imodbits_armor ],

["mail_and_plate_white", "White Mail And Plate", [("early_transitional_white",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4000 , weight(28)|abundance(100)|head_armor(0)|body_armor(55)|leg_armor(13)|difficulty(8) ,imodbits_armor,[],[fac_kingdom_sept]],
 
["mail_and_plate_red", "Res Mail And Plate", [("early_transitional_blue",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4000 , weight(28)|abundance(100)|head_armor(0)|body_armor(55)|leg_armor(13)|difficulty(8) ,imodbits_armor,[],[fac_kingdom_1] ],
 
["mail_and_plate_orage", "Orage Mail And Plate", [("early_transitional_orange",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4000 , weight(28)|abundance(100)|head_armor(0)|body_armor(55)|leg_armor(13)|difficulty(8) ,imodbits_armor],
 
["lamellar_mail", "Lamellar Mail", [("rus_lamellar_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs,0,
 2800 , weight(30)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(15)|difficulty(9) ,imodbits_armor ,[],[fac_kingdom_2]],
 
["iron_armor", "Iron Armor", [("rus_scale",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs,0,
 3200 , weight(34)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(16)|difficulty(9) ,imodbits_armor ,[],[fac_kingdom_2]],
 
["cold_heavy_armor", "Cold Heavy Armor", [("kuyak_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs,0,
 2500 , weight(30)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(8) ,imodbits_armor ],

["cold_heavy_armor_a", "Cold Heavy Armor", [("kuyak_b",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs,0,
 2500 , weight(30)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(8) ,imodbits_armor ],
 
 
["barbarous_of_plates", "Barbarous of Plates", [("akatosh",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 5000 , weight(24)|abundance(30)|head_armor(0)|body_armor(58)|leg_armor(17)|difficulty(8) ,imodbits_armor ],
 
["coat_of_plates", "Coat of Plates", [("coat_of_plates_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],

["coat_of_plates_red", "Coat of Plates", [("coat_of_plates_red",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_1]],
 
["coat_of_plates_green", "Coat of Plates", [("coat_of_plates_c",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_5] ],

["coat_of_plates_white", "Coat of Plates", [("teu_coat_of_plates_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_sept] ],
 
["coat_of_plates_1", "Coat of Plates", [("ryzhqiskj",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(13)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead]],
["coat_of_plates_red_1", "Coat of Plates", [("ryzhqiskj1",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4200 , weight(28)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(13)|difficulty(9) ,imodbits_armor ],
 
["heresy_coat_of_plates", "Heresy Coat of Plates", [("spak_coat_of_plates_b",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4800 , weight(29)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["heresy_coat_of_plates_a", "Heresy Coat of Plates", [("spak_coat_of_plates_d",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4800 , weight(29)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["heresy_coat_of_plates_b", "Heresy Coat of Plates", [("spak_coat_of_plates_e",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4800 , weight(29)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["heresy_coat_of_plates_c", "Heresy Coat of Plates", [("spak_coat_of_plates_f",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4800 , weight(29)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],
 
["heresy_coat_of_plates_d", "Heresy Coat of Plates", [("spak_coat_of_plates_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 4800 , weight(29)|abundance(100)|head_armor(0)|body_armor(60)|leg_armor(16)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead] ],

["black_plates_armor", "Black Plates Armor", [("124",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 5000 , weight(29)|abundance(100)|head_armor(0)|body_armor(63)|leg_armor(15)|difficulty(9) ,imodbits_armor,[],[fac_kingdom_undead]],

["bear_plate_armor", "Bear Plate Armor", [("bear_warrior",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 6200 , weight(35)|abundance(100)|head_armor(0)|body_armor(62)|leg_armor(16)|difficulty(12) ,imodbits_plate ],
 
["wolf_plate_armor", "Wolf Plate Armor", [("elite_cavalary",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 5500 , weight(28)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(15)|difficulty(10) ,imodbits_plate ],

["plate_armor_sexy", "Plate Armor", [("chainmail_skin",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 6000 , weight(25)|abundance(100)|head_armor(0)|body_armor(56)|leg_armor(16)|difficulty(7) ,imodbits_plate ],
 
["plate_armor", "Plate Armor", [("2full_plate_armor",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 7000 , weight(30)|abundance(100)|head_armor(0)|body_armor(65)|leg_armor(16)|difficulty(10) ,imodbits_plate ],
["black_armor", "Black Plate Armor", [("fix_black_armor",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 8496 , weight(30)|abundance(50)|head_armor(0)|body_armor(65)|leg_armor(18)|difficulty(10) ,imodbits_plate,[],[fac_kingdom_undead] ],
 
["dark_armor", "Dark Plate Armor", [("dark_lord_armor",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 9496 , weight(35)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(18)|difficulty(11) ,imodbits_plate,[],[fac_kingdom_undead] ],
 
["lord_armor", "Lord Plate Armor", [("dark_lord_armor2",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 9496 , weight(35)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(18)|difficulty(11) ,imodbits_plate],
 
["black_armor_undead","Black Plate Armor Undead", [("siwangkaijia",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs ,0,
 8700 , weight(32)|abundance(50)|head_armor(0)|body_armor(68)|leg_armor(20)|difficulty(14) ,imodbits_plate,[],[fac_kingdom_undead] ],
 
["red_armor_undead", "Red Plate Armor Undead", [("kongjukaijia",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs ,0,
 8700 , weight(32)|abundance(50)|head_armor(0)|body_armor(68)|leg_armor(20)|difficulty(14) ,imodbits_plate,[],[fac_kingdom_undead] ],
 
["blue_armor_undead", "Blue Plate Armor Undead", [("youlingkaijia",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs ,0,
 8700 , weight(32)|abundance(50)|head_armor(0)|body_armor(68)|leg_armor(20)|difficulty(14) ,imodbits_plate,[],[fac_kingdom_undead] ],
 
["jinwei", "Jin Wei", [("jinwei",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs|itp_unique ,0,
 7700 , weight(32)|abundance(50)|head_armor(0)|body_armor(60)|leg_armor(20)|difficulty(14) ,imodbits_plate,[],[fac_kingdom_sept] ],
 
["jinwei_a", "Jin Wei", [("jinweiA",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs|itp_unique ,0,
 7700 , weight(32)|abundance(50)|head_armor(0)|body_armor(60)|leg_armor(20)|difficulty(14) ,imodbits_plate,[],[fac_kingdom_sept] ],
 
 
 ["brigandine_heraldic", "Heraldic Brigandine", [("brigandine_heraldic",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 2000 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(7) ,imodbits_armor ,
 ...
 ["brigandine_red", "Red Brigandine", [("brigandine_b",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1830 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(7) ,imodbits_armor ],
 
 ["brigandine_black", "Black Brigandine", [("brigandine_black",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1830 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(7) ,imodbits_armor ,[],[fac_kingdom_undead]],
 
 ["brigandine_blue", "Blue Brigandine", [("brigandine_blue",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1830 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(7) ,imodbits_armor ],
 
 ["brigandine_green", "Green Brigandine", [("brigandine_green",0)], itp_merchandise| itp_type_body_armor|itp_covers_legs,0,
 1830 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(7) ,imodbits_armor ],
...
["brigandine_plate_heraldic", "Heraldic Brigandine with Plate", [("brig_plate_heraldic",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 5500 , weight(22)|abundance(50)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(7) ,imodbits_plate ,
 ...
 ["brigandine_plate_black", "Blacak Brigandine with Plate", [("brig_plate_black",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 5000 , weight(22)|abundance(50)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[],[fac_kingdom_undead]],
 
 ["brigandine_plate_green", "Green Brigandine with Plate", [("brig_plate_green",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 5000 , weight(22)|abundance(50)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[],[fac_kingdom_5]],
 
 ["brigandine_plate_red", "Red Brigandine with Plate", [("brig_plate_red",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 5000 , weight(22)|abundance(50)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[],[fac_kingdom_1]],
 
 ["brigandine_plate_blue", "Blue Brigandine with Plate", [("brig_plate_blue",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 5000 , weight(22)|abundance(50)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[]],
 #########################################################################################################################################
 ["churburg_plate_blue", "Churburg Plate Blue", [("churburg_13",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 6800 , weight(25)|abundance(50)|head_armor(0)|body_armor(67)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[]],
 ["churburg_plate_red", "Churburg Plate Red", [("churburg_13_brass",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 6800 , weight(25)|abundance(50)|head_armor(0)|body_armor(67)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[],[fac_kingdom_1]],
 ["churburg_plate_white", "Churburg Plate White", [("churburg_13_mail",0)], itp_type_body_armor|itp_merchandise|itp_covers_legs ,0,
 6800 , weight(25)|abundance(50)|head_armor(0)|body_armor(67)|leg_armor(18)|difficulty(7) ,imodbits_plate ,[]],
 #########################################################################################################################################
["heraldic_platemail_1", "Heraldic Platemail", [("platemail_heraldic_02",0)],  itp_merchandise|itp_type_body_armor|itp_covers_legs ,0,
 9000 , weight(23)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(18)|difficulty(8) ,imodbits_plate,
...
["heraldic_platemail_2", "Heraldic Platemail with Cloak", [("platemail_heraldic_03",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 9000 , weight(23)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(18)|difficulty(8) ,imodbits_plate,
 [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_platemail_harness_heraldic_02", ":agent_no", ":troop_no")])],[]],

["heraldic_plate_1", "Heraldic Plate Armour", [("platemail_heraldic",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 9000 , weight(23)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(18)|difficulty(8) ,imodbits_plate,
...
["heraldic_plate_2", "Heraldic Plate Armour", [("plate_heraldic",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 11000 , weight(23)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,
...
["steal_plate", "Steal Plate Armour", [("plate_harness_02",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[]],
 
["steal_plate_a", "Steal Plate Armour", [("knight_armor_Denmark1",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[]],
 
["steal_plate_b", "Steal Plate Armour", [("gothic_plate",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[]],

["steal_plate_c", "Steal Plate Armour", [("knight_armor_HRE1",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[]],
 
["steal_plate_white", "Steal Plate Armour White", [("plate_harness_white",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_sept]],

["steal_plate_white_a", "Steal Plate Armour White", [("platemail_heraldic_02",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_sept]],
 
["steal_plate_white_b", "Steal Plate Armour White", [("platemail_heraldic_03",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 10000 , weight(23)|abundance(50)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_sept]],
 
["steal_plate_1", "Steal Plate Armour ", [("pa",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 7000 , weight(23)|abundance(50)|head_armor(0)|body_armor(62)|leg_armor(16)|difficulty(8) ,imodbits_plate,[], []],
 #########################################################################################################################################
["women_plate", "Women Plate Armor", [("FemalePlateArmor",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 8000 , weight(20)|abundance(50)|head_armor(0)|body_armor(65)|leg_armor(16)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead] ],
["women_plate_1", "Women Plate Armor", [("FemalePlateArmor_1",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 8000 , weight(20)|abundance(50)|head_armor(0)|body_armor(65)|leg_armor(16)|difficulty(8) ,imodbits_plate,[], [] ],
["women_plate_2", "Women Plate Armor", [("FemalePlateArmor_2",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,
 8000 , weight(20)|abundance(50)|head_armor(0)|body_armor(65)|leg_armor(16)|difficulty(8) ,imodbits_plate ,[], []],

["sept_women_plate", "Sept women plate", [("shenguinv",0)],itp_merchandise|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(15)|abundance(25)|head_armor(0)|body_armor(60)|leg_armor(14)|difficulty(5) ,imodbits_plate ,[], [fac_kingdom_sept]],
 
["carved_plate", "Carved plate female", [("female_plate_falcon",0)],itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(70)|leg_armor(17)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_1", "Gold Carved plate female", [("female_plate_falcon_gold",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(70)|leg_armor(17)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_2", "Gold Carved plate female", [("female_plate_falcon_blue",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(70)|leg_armor(17)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_3", "Gold Carved plate female", [("female_plate_falcon_black",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(70)|leg_armor(17)|difficulty(6) ,imodbits_plate ,[], []],
 
["carved_plate_man", "Carved plate male", [("corprus_plate_man",0)],itp_unique|itp_type_body_armor|itp_covers_legs  ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(65)|leg_armor(15)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_man_1", "Gold Carved plate male", [("corprus_plate_man_gloden",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(65)|leg_armor(15)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_man_2", "Gold Carved plate male", [("corprus_plate_man_blue",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(65)|leg_armor(15)|difficulty(6) ,imodbits_plate ,[], []],
["carved_plate_man_3", "Gold Carved plate male", [("corprus_plate_man_black",0)], itp_unique|itp_type_body_armor|itp_covers_legs   ,0,
 12000 , weight(17)|abundance(5)|head_armor(0)|body_armor(65)|leg_armor(15)|difficulty(6) ,imodbits_plate ,[], []],
...
["sarranid_cavalry_robe", "Cavalry Robe", [("arabian_armor_a",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 950 , weight(15)|abundance(100)|head_armor(0)|body_armor(35)|leg_armor(8)|difficulty(0) ,imodbits_armor ],
["arabian_armor_b", "Sarranid Guard Armor", [("arabian_armor_b",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 2200 , weight(22)|abundance(100)|head_armor(0)|body_armor(43)|leg_armor(8)|difficulty(7) ,imodbits_armor],
...
["heraldic_mail_with_tunic_d", "Heraldic Mail", [("wenzhangzhonjia",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 3810 , weight(22)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(16)|difficulty(7) ,imodbits_armor,
...
["arming_cap", "Arming Cap", [("arming_cap_a_new",0)], itp_merchandise| itp_type_head_armor  |itp_civilian ,0, 7 , weight(1)|abundance(100)|head_armor(15)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
...
["solak_helmet", "Solak helmet ", [("bishop_mitre",0)], itp_merchandise| itp_type_head_armor  |itp_civilian ,0, 20 , weight(1)|abundance(100)|head_armor(17)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth,[],[fac_kingdom_sept] ],
["solak_helmet_a", "Solak helmet ", [("solak_helmet_A",0)], itp_merchandise| itp_type_head_armor  |itp_civilian ,0, 20 , weight(1)|abundance(100)|head_armor(17)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth,[],[fac_kingdom_sept] ],
["solak_helmet_b", "Solak helmet ", [("solak_helmet_B",0)], itp_merchandise| itp_type_head_armor  |itp_civilian ,0, 35 , weight(1)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth,[],[fac_kingdom_sept] ],
["solak_helmet_c", "Solak helmet ", [("solak_helmet_C",0)], itp_merchandise| itp_type_head_armor  |itp_civilian ,0, 50 , weight(1)|abundance(100)|head_armor(23)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth,[],[fac_kingdom_sept] ],
...
["cult_helmet", "Cult's Helmet", [("demon_hood",0)], itp_merchandise| itp_type_head_armor   ,0, 90 , weight(1.5)|abundance(100)|head_armor(23)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate,[],[fac_kingdom_undead]],
["cult_helmet_pluse", "Cult's Helmet Pluse", [("scullhead4",0)], itp_merchandise| itp_type_head_armor   ,0, 900 , weight(3.3)|abundance(100)|head_armor(50)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate,[],[fac_kingdom_undead]],
#missing...
...
400 , weight(2.0)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["kettle_hat", "Kettle Hat", [("kettle_hat_new",0)], itp_merchandise| itp_type_head_armor,0, 
410 , weight(2.1)|abundance(100)|head_armor(42)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["kettle_hat_1", "Kettle Hat", [("kettle_helm_01",0)], itp_merchandise| itp_type_head_armor,0, 
380 , weight(1.8)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
...
#["vaegir_spiked_helmet_a", "Spiked Cap", [("gnezdovo_helm_b",0)], itp_fit_to_head|itp_merchandise| itp_type_head_armor   ,0, 260 , weight(2.70)|abundance(100)|head_armor(34)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
...
["vaegir_war_helmet", "Vaegir War Helmet", [("vaeg_helmet6",0)], itp_merchandise| itp_type_head_armor   ,0, 840 , weight(3)|abundance(100)|head_armor(48)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["vaegir_war_helmet_a", "Vaegir War Helmet", [("novogrod_helm",0)], itp_fit_to_head|itp_merchandise| itp_type_head_armor   ,0, 800 , weight(3)|abundance(100)|head_armor(46)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["vaegir_war_helmet_b", "Vaegir War Helmet", [("nikolskoe_helm",0)], itp_fit_to_head|itp_merchandise| itp_type_head_armor   ,0, 820 , weight(3)|abundance(100)|head_armor(47)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],

["vaegir_mask", "Vaegir War Mask", [("vaeg_helmet9",0)], itp_fit_to_head|itp_merchandise| itp_type_head_armor |itp_covers_beard ,0, 950 , weight(3.50)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["vaegir_mask_a", "Vaegir War Mask", [("litchina_helm",0)], itp_fit_to_head|itp_merchandise| itp_type_head_armor |itp_covers_beard ,0, 900 , weight(3.50)|abundance(100)|head_armor(50)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
...
["bascinet", "Bascinet", [("bascinet_avt_new",0)], itp_merchandise|itp_type_head_armor   ,0, 420 , weight(2.0)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
...
["black_helmet", "Black Helmet", [("black_helm",0)], itp_type_head_armor|itp_merchandise,0, 400 , weight(2.0)|abundance(100)|head_armor(42)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate,[],[fac_kingdom_undead]],
["demon_black_helm", "Demon Black Helm", [("asmoday_helmet2",0)], itp_merchandise| itp_type_head_armor ,0, 450 , weight(2.2)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate,[],[fac_kingdom_undead]],
["demon_black_helm_a", "Demon Black Helm", [("sp_helm1",0)], itp_merchandise| itp_type_head_armor ,0, 450 , weight(2.2)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate,[],[fac_kingdom_undead]],
...
["great_helmet_a", "Great Helmet", [("spak_helmet_k",0)], itp_merchandise| itp_type_head_armor|itp_covers_head,0, 1010 , weight(2.8)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
["great_helmet_c", "Great Helmet", [("greathelmwhat",0)], itp_merchandise| itp_type_head_armor|itp_covers_head,0, 1010 , weight(2.8)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ,[],[fac_kingdom_undead]],
["great_helmet_d", "Great Helmet", [("grhelm_02",0)], itp_merchandise| itp_type_head_armor|itp_covers_head,0, 980 , weight(2.75)|abundance(100)|head_armor(53)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
...
["winged_great_helmet_a", "Winged Great Helmet", [("helmhorn3",0)], itp_merchandise|itp_type_head_armor|itp_covers_head,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
["sept_great_helmet", "Step Great Helmet", [("bishop_tophelm",0)], itp_merchandise|itp_type_head_armor,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate,[],[fac_kingdom_sept] ],
["sept_great_helmet_a", "Step Great Helmet", [("sugarloaf",0)], itp_merchandise|itp_type_head_armor,0, 1440 , weight(3)|abundance(100)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate,[],[fac_kingdom_sept] ],
["heresy_great_helmet", "Heresy Great Helmet", [("sub_helm",0)], itp_merchandise|itp_type_head_armor,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate,[],[fac_kingdom_undead] ],
["heresy_great_helmet_a", "Heresy Great Helmet", [("sub_helm4",0)], itp_merchandise|itp_type_head_armor,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate,[],[fac_kingdom_undead] ],
["cattle_great_helmet", "Cattle Great Helmet", [("2kettle_hat_new",0)], itp_merchandise|itp_type_head_armor,0, 1340 , weight(3)|abundance(100)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate ],
["cattle_great_helmet_a", "Cattle Great Helmet", [("helmhorn",0)], itp_merchandise|itp_type_head_armor,0, 1340 , weight(3)|abundance(100)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate ],
["cattle_great_helmet_b", "Cattle Great Helmet", [("helmhorn2",0)], itp_merchandise|itp_type_head_armor,0, 1340 , weight(3)|abundance(100)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate ],
["cattle_great_helmet_c", "Cattle Great Helmet", [("helmhorn5",0)], itp_merchandise|itp_type_head_armor,0, 1340 , weight(3)|abundance(100)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate ],

["black_plate_helmet", "Black Plate Helmet", [("twilighthelm",0)], itp_merchandise|itp_type_head_armor,0, 2100 , weight(2.8)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], [fac_kingdom_undead]],
["black_plate_helmet_a", "Black Plate Helmet", [("twilighthelm2",0)], itp_merchandise|itp_type_head_armor,0, 2100 , weight(2.8)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], [fac_kingdom_undead]],
["winged_great_helmet_undead_a", "Red Winged Great Helmet Undead", [("kongjutoukui",0)], itp_unique|itp_type_head_armor|itp_covers_head,0, 1240 , weight(3)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate,[], [fac_kingdom_undead]],
["winged_great_helmet_undead_b", "Blacak Winged Great Helmet Undead", [("siwangqishitou",0)], itp_unique|itp_type_head_armor|itp_covers_head,0, 1240 , weight(3)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate,[], [fac_kingdom_undead]],
["winged_great_helmet_undead_c", "Blue Winged Great Helmet Undead", [("youlingqishitou",0)], itp_unique|itp_type_head_armor|itp_covers_head,0, 1240 , weight(3)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate,[], [fac_kingdom_undead]],
["jinweitou", "Blue Winged Great Helmet Undead", [("jinweitou",0)], itp_merchandise|itp_type_head_armor|itp_covers_head|itp_unique,0, 1540 , weight(3)|abundance(50)|head_armor(63)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate,[], [fac_kingdom_sept]],
["jinweitou_a", "Blue Winged Great Helmet Undead", [("jinweitouA",0)], itp_merchandise|itp_type_head_armor|itp_covers_head|itp_unique,0, 1440 , weight(3)|abundance(50)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(11) ,imodbits_plate,[], [fac_kingdom_sept]],
["plate_helmet",   "Plate Helmet",   [("armet_01",0)], itp_merchandise|itp_type_head_armor,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_blue",   "Plate Helmet",   [("tournament_helmB",0)], itp_merchandise|itp_type_head_armor,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_1", "Plate Helmet", [("armet_02",0)], itp_merchandise|itp_type_head_armor,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_2", "Plate Helmet", [("armet_03",0)], itp_merchandise|itp_type_head_armor,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_3", "Plate Helmet", [("armet_04",0)], itp_merchandise|itp_type_head_armor,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_4", "Plate Helmet", [("visored_bascinet_01",0)], itp_merchandise|itp_type_head_armor,0, 2200 , weight(2.5)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_5", "Plate Helmet", [("visored_bascinet_02",0)], itp_merchandise|itp_type_head_armor,0, 2200 , weight(2.5)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["plate_helmet_6", "Plate Helmet", [("visored_bascinet_03",0)], itp_merchandise|itp_type_head_armor,0, 2200 , weight(2.5)|abundance(50)|head_armor(58)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["steel_helmet",   "Steel Helmet",  [("barbutte_01",0)], itp_merchandise|itp_type_head_armor   ,0, 730 , weight(1.7)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["steel_coif_helmet", "Steel Coif Helmet", [("barbutte_coif_01",0)], itp_merchandise|itp_type_head_armor   ,0, 1000 , weight(2)|abundance(100)|head_armor(48)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["steel_coif_helmet_1", "Steel Coif Helmet", [("bascinet_coif_02",0)], itp_merchandise|itp_type_head_armor   ,0, 800 , weight(2)|abundance(100)|head_armor(44)|body_armor(0)|leg_armor(0)|difficulty(6) ,imodbits_plate ,[], []],
["hounskull_bascinet_1", "Hounskull Bascinet", [("hounskull_bascinet_01",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_2", "Hounskull Bascinet", [("hounskull_bascinet_02",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_3", "Hounskull Bascinet", [("hounskull_bascinet_03",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_4", "Hounskull Bascinet", [("hounskull_bascinet_04",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_5", "Hounskull Bascinet", [("hounskull_bascinet_05",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_6", "Hounskull Bascinet", [("hounskull_bascinet_06",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["hounskull_bascinet_7", "Hounskull Bascinet", [("hounskull_bascinet_07",0)], itp_merchandise|itp_type_head_armor,0, 2800 , weight(2.5)|abundance(50)|head_armor(62)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ,[], []],
["sallet_1", "Sallet", [("sallet_01",0)], itp_merchandise|itp_type_head_armor,0, 1800 , weight(2)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["sallet_2", "Sallet", [("sallet_02",0)], itp_merchandise|itp_type_head_armor,0, 1900 , weight(1.9)|abundance(100)|head_armor(51)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["sallet_3", "Sallet", [("sallet_03",0)], itp_merchandise|itp_type_head_armor,0, 1500 , weight(1.7)|abundance(100)|head_armor(49)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["sallet_4", "Sallet", [("sallet_04",0)], itp_merchandise|itp_type_head_armor,0, 1800 , weight(2)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["sallet_5", "Sallet", [("sallet_05",0)], itp_merchandise|itp_type_head_armor,0, 1900 , weight(1.9)|abundance(100)|head_armor(51)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
["sallet_6", "Sallet", [("sallet_06",0)], itp_merchandise|itp_type_head_armor,0, 1500 , weight(1.7)|abundance(100)|head_armor(49)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ,[], []],
...
25 , weight(2)|difficulty(0)|spd_rtng(100) | weapon_length(55)|swing_damage(24 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
...
290 , weight(9)|difficulty(14)|spd_rtng(79) | weapon_length(85)|swing_damage(45 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],

["warhammer_a",         "Great Hammer A", [("maul_e",0)], itp_type_one_handed_wpn|itp_merchandise|itp_can_knock_down|itp_primary|itp_wooden_parry|itp_wooden_attack|itp_unbalanced, itc_scimitar|itcf_carry_spear, 
330 , weight(9)|difficulty(16)|spd_rtng(74) | weapon_length(75)|swing_damage(40 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace,[],[fac_kingdom_undead] ],
...
["military_pick_pluse", "Military Pick Pluse", [("QSJC",0)], itp_type_one_handed_wpn|itp_merchandise|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip, 
330 , weight(1.8)|difficulty(0)|spd_rtng(92) | weapon_length(80)|swing_damage(35 , pierce) | thrust_damage(0 ,  pierce),imodbits_pick ],
...
["morningstar_big",         "Morningstar", [("kuangyemubang",0)], itp_crush_through|itp_type_two_handed_wpn|itp_primary|itp_wooden_parry|itp_unbalanced|itp_unique, itc_morningstar|itcf_carry_spear, 
905 , weight(8.5)|difficulty(40)|spd_rtng(80) | weapon_length(105)|swing_damage(48 , pierce) | thrust_damage(0 ,  pierce),imodbits_mace ],
...
["Mohawkjian", "Mohawkjian Heavy Sabre", [("Mohawkjian",0),("Mohawkjian", ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 584 , weight(2.25)|difficulty(0)|spd_rtng(95) | weapon_length(96)|swing_damage(36 , cut),imodbits_sword_high,[], [fac_kingdom_undead] ],
...
["long_spiked_club",         "Long Spiked Club", [("mace_long_c",0)], itp_type_polearm|itp_can_knock_down|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff|itcf_carry_axe_back,
 264 , weight(3)|difficulty(8)|spd_rtng(96) | weapon_length(126)|swing_damage(23 , pierce) | thrust_damage(20 ,  blunt),imodbits_mace ],
["long_hafted_knobbed_mace",         "Long Hafted Knobbed Mace", [("mace_long_a",0)], itp_two_handed|itp_type_polearm| itp_can_knock_down|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_axe_back,
 290 , weight(3)|difficulty(10)|spd_rtng(95) | weapon_length(133)|swing_damage(26 , blunt) | thrust_damage(23 ,  blunt),imodbits_mace ],
["long_hafted_spiked_mace",         "Long Hafted Spiked Mace", [("mace_long_b",0)], itp_two_handed|itp_type_polearm|itp_can_knock_down|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff|itcf_carry_axe_back,
 310 , weight(3)|difficulty(10)|spd_rtng(94) | weapon_length(140)|swing_damage(28 , blunt) | thrust_damage(26 ,  blunt),imodbits_mace ],
...
["glaive_a",         "Glaive", [("glaive1",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_two_handed|itp_wooden_parry, itc_staff|itcf_carry_spear,
 400 , weight(4.5)|difficulty(0)|spd_rtng(90) | weapon_length(157)|swing_damage(42 , cut) | thrust_damage(24 ,  pierce),imodbits_polearm ],

["glaive_b",         "Glaive", [("glaive2",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_two_handed|itp_wooden_parry, itc_staff|itcf_carry_spear,
 450 , weight(4.5)|difficulty(0)|spd_rtng(90) | weapon_length(170)|swing_damage(44 , cut) | thrust_damage(26 ,  pierce),imodbits_polearm ],
 
["poleaxe",         "Poleaxe", [("pole_ax",0)], itp_bonus_against_shield|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_two_handed|itp_wooden_parry, itc_staff|itcf_carry_spear,
 390 , weight(5)|difficulty(13)|spd_rtng(77) | weapon_length(180)|swing_damage(52 , cut) | thrust_damage(15 ,  blunt),imodbits_polearm ],
["polehammer",         "Polehammer", [("pole_hammer",0)], itp_type_polearm|itp_offset_lance| itp_primary|itp_two_handed|itp_wooden_parry, itc_staff,
 320 , weight(7)|difficulty(15)|spd_rtng(50) | weapon_length(126)|swing_damage(50 , blunt) | thrust_damage(35 ,  blunt),imodbits_polearm ],
...
["shortened_spear",         "Shortened Spear", [("spear_g_1-9m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 53 , weight(2.0)|difficulty(0)|spd_rtng(102) | weapon_length(120)|swing_damage(19 , blunt) | thrust_damage(25 ,  pierce),imodbits_polearm ],
["spear",         "Spear", [("spear_h_2-15m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 85 , weight(2.25)|difficulty(0)|spd_rtng(98) | weapon_length(135)|swing_damage(20 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],

["bamboo_spear",         "Bamboo Spear", [("arabian_spear_a_3m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 80 , weight(2.0)|difficulty(0)|spd_rtng(88) | weapon_length(200)|swing_damage(15 , blunt) | thrust_damage(20 ,  pierce),imodbits_polearm ],

["war_spear",         "War Spear", [("spear_i_2-3m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 140 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(150)|swing_damage(20 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
 
["partisan",         "Partisan", [("german_hunting_spear",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 300 , weight(2.7)|difficulty(0)|spd_rtng(95) | weapon_length(155)|swing_damage(23 , blunt) | thrust_damage(30 ,  pierce),imodbits_polearm ],

["partisan_a",         "Partisan", [("partisan",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 300 , weight(2.7)|difficulty(0)|spd_rtng(95) | weapon_length(152)|swing_damage(24 , blunt) | thrust_damage(33 ,  pierce),imodbits_polearm ],
 
["partisan_sept",         "Partisan", [("jinweiqiangA",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 400 , weight(3.3)|difficulty(0)|spd_rtng(95) | weapon_length(158)|swing_damage(25 , blunt) | thrust_damage(35 ,  pierce),imodbits_polearm ,[],[fac_kingdom_sept]],

["partisan_sept_a",         "Partisan", [("jinweiqiang",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 400 , weight(3.3)|difficulty(0)|spd_rtng(95) | weapon_length(158)|swing_damage(25 , blunt) | thrust_damage(35 ,  pierce),imodbits_polearm ,[],[fac_kingdom_sept]],
...
["light_lance",         "Light Lance", [("spear_b_2-75m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear,
 180 , weight(2.5)|difficulty(0)|spd_rtng(100) | weapon_length(175)|swing_damage(16 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
["lance",         "Lance", [("spear_d_2-8m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear,
 270 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(180)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["heavy_lance",         "Heavy Lance", [("spear_f_2-9m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear,
 300 , weight(2.75)|difficulty(10)|spd_rtng(90) | weapon_length(190)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["great_lance",         "Great Lance", [("heavy_lance",0)], itp_couchable|itp_type_polearm|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 320 , weight(5)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(30 ,  pierce),imodbits_polearm ],

["great_lance_steal_blue",         "Great Lance Blue", [("corprus_falcon_heavy_lance_griffin",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 350 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(30 ,  pierce),imodbits_polearm ],
["great_lance_steal_red",         "Great Lance Red", [("corprus_falcon_heavy_lance_lion",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 350 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(30 ,  pierce),imodbits_polearm ],
["great_lance_steal_red_1",         "Great Lance Red", [("corprus_falcon_heavy_lance_cross",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 350 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(30 ,  pierce),imodbits_polearm ],
["great_lance_steal_green",         "Great Lance Green", [("corprus_falcon_heavy_lance_unicorn",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 350 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(30 ,  pierce),imodbits_polearm ],

["great_lance_steal_silver",         "Great Lance Silver", [("gothic_lance",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 400 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(32 ,  pierce),imodbits_polearm ,[],[]],
 
["great_lance_steal_gold",         "Great Lance Gold", [("lrqq",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 450 , weight(6)|difficulty(11)|spd_rtng(85) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(35 ,  pierce),imodbits_polearm ,[],[fac_kingdom_sept]],
 
["great_lance_steal_dark",         "Dark  Lance Dark", [("blackqq",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 
 1000 , weight(5)|difficulty(8)|spd_rtng(80) | weapon_length(240)|swing_damage(0 , cut) | thrust_damage(40 ,  pierce),imodbits_polearm ,[],[fac_kingdom_undead]],
 
["pike",         "Pike", [("spear_a_3m",0)], itp_type_polearm|itp_merchandise| itp_cant_use_on_horseback|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_two_handed, itc_cutting_spear|itcf_carry_spear,
...
["ashwood_pike", "Ashwood Pike", [("pike",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_two_handed|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 205 , weight(3.5)|difficulty(9)|spd_rtng(90) | weapon_length(170)|swing_damage(19 , blunt) | thrust_damage(29,  pierce),imodbits_polearm ],
["awlpike",    "Awlpike", [("awl_pike_b",0)], itp_two_handed|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 345 , weight(2.25)|difficulty(10)|spd_rtng(92) | weapon_length(165)|swing_damage(20 , blunt) | thrust_damage(33 ,  pierce),imodbits_polearm ],
["awlpike_long",  "Long Awlpike", [("awl_pike_a",0)], itp_two_handed|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_spear,
 385 , weight(2.25)|difficulty(10)|spd_rtng(89) | weapon_length(185)|swing_damage(20 , blunt) | thrust_damage(32 ,  pierce),imodbits_polearm ],
...
385, weight(2.5)|weapon_length(120)|difficulty(0)|spd_rtng(81)|abundance(100)|swing_damage(45, blunt)|thrust_damage(38, pierce), imodbits_polearm, [] ],
...
["mohawkdun_shield", "Mohawkdun Shield", [("Mohawkdun",0)], itp_merchandise|itp_type_shield, itcf_carry_round_shield,  797 , weight(4)|hit_points(700)|body_armor(17)|spd_rtng(61)|shield_width(50),imodbits_shield,[],[fac_kingdom_undead]],
["evil_shield", "Evil Shield", [("asmoday_seel",0)], itp_merchandise|itp_type_shield, itcf_carry_round_shield,  897 , weight(5)|hit_points(800)|body_armor(20)|spd_rtng(60)|shield_width(40),imodbits_shield,[],[fac_kingdom_undead] ],
["evil_dragon_shield", "Evil Draagon Shield", [("round_dragon_shield",0)], itp_merchandise|itp_type_shield, itcf_carry_round_shield,  1097 , weight(6)|hit_points(900)|body_armor(21)|spd_rtng(60)|shield_width(40),imodbits_shield,[],[fac_kingdom_undead] ],
["evil_dragon_shield_a", "Evil Draagon Shield", [("round_dragon_shield2",0)], itp_merchandise|itp_type_shield, itcf_carry_round_shield,  1097 , weight(6)|hit_points(900)|body_armor(21)|spd_rtng(60)|shield_width(40),imodbits_shield,[],[fac_kingdom_undead] ],
...
160 , weight(3)|hit_points(260)|body_armor(14)|spd_rtng(90)|shield_width(36)|shield_height(70),imodbits_shield,
 ...
 ["tab_shield_heater_c_a", "Heater Shield",   [("teu_shield" ,0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  
160 , weight(3)|hit_points(260)|body_armor(14)|spd_rtng(90)|shield_width(36)|shield_height(70),imodbits_shield,[],[fac_kingdom_sept]],
...
332 , weight(3.5)|hit_points(305)|body_armor(19)|spd_rtng(87)|shield_width(36)|shield_height(70),imodbits_shield,
 [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_1", ":agent_no", ":troop_no")])]],
["tab_shield_heater_e", "Heavy Heater Shield",   [("teu_shield" ,0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  
332 , weight(3.5)|hit_points(305)|body_armor(19)|spd_rtng(87)|shield_width(36)|shield_height(70),imodbits_shield,[],[fac_kingdom_sept]],
...
390 , weight(2.5)|hit_points(220)|body_armor(23)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield,
 [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_2", ":agent_no", ":troop_no")])]],
["tab_shield_heater_cav_dragon", "Dragon Heater Shield",   [("sh_snake" ,0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  
690 , weight(3)|hit_points(270)|body_armor(26)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield,[],[fac_kingdom_undead]],

["tab_shield_heater_gold", "Dragon Heater Shield",   [("lrd" ,0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  
690 , weight(3)|hit_points(270)|body_armor(26)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield,[],[fac_kingdom_sept]],
...
["tab_shield_heresy_a", "Heavy Board Shield",   [("kongjudun" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
670 , weight(5)|hit_points(800)|body_armor(18)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,[],[fac_kingdom_undead]],

["tab_shield_heresy_b", "Heavy Board Shield",   [("siwangdun" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
670 , weight(5)|hit_points(800)|body_armor(18)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,[],[fac_kingdom_undead]],

["tab_shield_heresy_c", "Heavy Board Shield",   [("youlingdun" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
670 , weight(5)|hit_points(800)|body_armor(18)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,[],[fac_kingdom_undead]],
 
["imperial_shield", "Imperial Shield",   [("imperial_shield" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
500 , weight(4.5)|hit_points(700)|body_armor(15)|spd_rtng(78)|shield_width(40)|shield_height(90),imodbits_shield,[],[fac_kingdom_sept]],
 
["jinweidun", "Step Board Shield",   [("jinweidun" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
670 , weight(5)|hit_points(800)|body_armor(18)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,[],[fac_kingdom_sept]],

["jinweidun_a", "Step Board Shield",   [("jinweidunA" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield,  
670 , weight(5)|hit_points(700)|body_armor(16)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,[],[fac_kingdom_sept]],
 #RANGED
...
["crossbow",         "Crossbow",         [("crossbow_a",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 
182 , weight(3)|difficulty(8)|spd_rtng(43) | shoot_speed(66) | thrust_damage(49,pierce)|max_ammo(1),imodbits_crossbow ],
["cavalry_crossbow",         "Cavalry Crossbow",  [("crossbow_a",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 
240 , weight(2.7)|difficulty(8)|spd_rtng(43) | shoot_speed(66) | thrust_damage(49,pierce)|max_ammo(1),imodbits_crossbow ],
["heavy_crossbow", "Heavy Crossbow", [("crossbow_c",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 
...
["flintlock_pistol", "Flintlock Pistol", [("flintlock_pistol",0)], itp_type_pistol |itp_primary|itp_bonus_against_shield ,itcf_shoot_pistol|itcf_reload_pistol, 1800 , weight(1.5)|difficulty(0)|spd_rtng(38) | shoot_speed(160) | thrust_damage(65 ,pierce)|max_ammo(1)|accuracy(65),imodbits_none,
 ...
 ["flintlock_pistol_1", "Flintlock Pistol Pluse", [("flintlock_pistol_1",0)], itp_type_pistol |itp_primary|itp_bonus_against_shield ,itcf_shoot_pistol|itcf_reload_pistol, 2400 , weight(1.5)|difficulty(0)|spd_rtng(38) | shoot_speed(165) | thrust_damage(75 ,pierce)|max_ammo(1)|accuracy(70),imodbits_none,
 [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,27),(position_move_y, pos1,36),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],

["flintlock_rifle", "Flintlock Rifle",[("flintlock_rifle_1",0)],itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 3200 , weight(4.5)|difficulty(0)|spd_rtng(28) | shoot_speed(170) | thrust_damage(90 ,pierce)|max_ammo(1)|accuracy(85),imodbits_none,
...
["arquebus", "Arquebus",[("arquebus",0)],itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 2500 , weight(3.5)|difficulty(0)|spd_rtng(28) | shoot_speed(170) | thrust_damage(80 ,pierce)|max_ammo(1)|accuracy(80),imodbits_none,
...
["blunderbus", "Blunderbus",[("blunderbus",0)],itp_type_musket|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 2700 , weight(3.5)|difficulty(0)|spd_rtng(28) | shoot_speed(170) | thrust_damage(80 ,pierce)|max_ammo(1)|accuracy(70),imodbits_none,
...
["matchlock", "Matchlock Rifle",[("matchlock_2",0)],itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 1200 , weight(3.5)|difficulty(0)|spd_rtng(24) | shoot_speed(160) | thrust_damage(75 ,pierce)|max_ammo(1)|accuracy(75),imodbits_none,
...
["gun_barrel", "Gun barrel",[("flintlock_rifle_1",0)],itp_unique|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 32000 , weight(0)|difficulty(0)|spd_rtng(28) | shoot_speed(20) | thrust_damage(200 ,pierce)|max_ammo(1)|accuracy(85),imodbits_none,
[(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,139),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],

["gun_tank", "Gun Tank",[("flintlock_rifle_1",0)],itp_unique|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_reload_musket|itcf_carry_crossbow_back|itcf_shoot_musket, 32000 , weight(45)|difficulty(0)|spd_rtng(28) | shoot_speed(20) | thrust_damage(400 ,pierce)|max_ammo(1)|accuracy(100),imodbits_none,
[(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,139),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],

["magic_novice_staff", "Magic Novice Staff", [("wooden_staff",0)], itp_penalty_with_shield|itp_two_handed|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 360 , weight(1.5)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(40 ,pierce)|max_ammo(5)|accuracy(70),imodbits_magic_staff, magic_attack_trigger],
["magic_novice_staff_a","Magic Novice Staff", [("wooden_staff",0)], itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_sword_back,
 36 , weight(1.5)|difficulty(0)|spd_rtng(100) | weapon_length(130)|swing_damage(18 , blunt) | thrust_damage(19 ,  blunt),imodbits_polearm ],

["magic_learn_staff", "Magic Learn Staff", [("mofazhang6",0)], itp_two_handed|itp_penalty_with_shield|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 1800 , weight(2)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(50 ,pierce)|max_ammo(5)|accuracy(80),imodbits_magic_staff, magic_attack_trigger], 
["magic_learn_staff_a","Magic Learn Staff", [("mofazhang6",0)], itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_sword_back,
 50 , weight(2)|difficulty(0)|spd_rtng(95) | weapon_length(135)|swing_damage(24 , blunt) | thrust_damage(22 ,  blunt),imodbits_polearm ],
 
["heresy_magic_master_staff", "Magic Master Staff", [("mofazhang17",0)], itp_two_handed|itp_penalty_with_shield|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 3500 , weight(2.5)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(60 ,pierce)|max_ammo(5)|accuracy(85),imodbits_magic_staff, magic_attack_trigger , [fac_kingdom_undead] ], 
["heresy_magic_master_staff_a", "Magic Master Staff", [("mofazhang17",0)], itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_sword_back,
 100 , weight(2.5)|difficulty(0)|spd_rtng(93) | weapon_length(140)|swing_damage(28 , blunt) | thrust_damage(25 ,  blunt),imodbits_polearm ,[],[fac_kingdom_undead] ],
 
["heresy_magic_expert_staff", "Magic Expert Staff", [("mofazhang31",0)], itp_two_handed|itp_penalty_with_shield|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 5000 , weight(3.2)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(70 ,pierce)|max_ammo(5)|accuracy(90),imodbits_magic_staff,magic_attack_trigger, [fac_kingdom_undead] ], 
["heresy_magic_expert_staff_a","Magic Expert Staff", [("mofazhang31",0)], itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_spear,
 202 , weight(3.2)|difficulty(0)|spd_rtng(90) | weapon_length(145)|swing_damage(30 , blunt) | thrust_damage(27 ,  blunt),imodbits_polearm ,[],[fac_kingdom_undead] ],
 
["sept_magic_master_staff", "Magic Master Staff", [("mofazhang19",0)], itp_two_handed|itp_penalty_with_shield|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 3500 , weight(2.5)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(60 ,pierce)|max_ammo(5)|accuracy(85),imodbits_magic_staff, magic_attack_trigger , [fac_kingdom_sept] ], 
["sept_magic_master_staff_a", "Magic Master Staff", [("mofazhang19",0)], itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_sword_back,
 100 , weight(2.5)|difficulty(0)|spd_rtng(93) | weapon_length(140)|swing_damage(28 , blunt) | thrust_damage(25 ,  blunt),imodbits_polearm ,[],[fac_kingdom_sept] ],
 
["sept_magic_expert_staff", "Magic Expert Staff", [("mofazhang34",0)], itp_two_handed|itp_penalty_with_shield|itp_merchandise|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 5000 , weight(3.2)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(70 ,pierce)|max_ammo(5)|accuracy(90),imodbits_magic_staff,magic_attack_trigger, [fac_kingdom_sept] ], 
["sept_magic_expert_staff_a","Magic Expert Staff", [("mofazhang34",0)],  itp_unique|itp_type_polearm| itp_primary|itp_two_handed|itp_penalty_with_shield|itp_wooden_parry, itc_guandao|itcf_carry_spear,
 202 , weight(3.2)|difficulty(0)|spd_rtng(90) | weapon_length(145)|swing_damage(30 , blunt) | thrust_damage(27 ,  blunt),imodbits_polearm ,[],[fac_kingdom_sept] ],
...
["khergit_war_helmet", "Khergit War Helmet", [("tattered_steppe_cap_a_new",0)], itp_type_head_armor | itp_merchandise   ,0, 560 , weight(2)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0) ,imodbits_cloth ],
...
["heresy_plate_boots", "Heresy Plate Boots", [("g_iron_greaves_a",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0,
 1870 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ], 
 
["steel_plate_boots", "Steel Plate Boots", [("steel_greaves",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0,
 2000 , weight(3.2)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(33)|difficulty(9) ,imodbits_plate,[]],

["sexy_plate_boots", "Steel Plate Boots", [("plate_boots_dthun",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0,
 2000 , weight(3.2)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(33)|difficulty(9) ,imodbits_plate,[]],

["sept_women_plate_boots", "Steel Plate Boots", [("shenguinvtui",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0,
 2400 , weight(2.5)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(31)|difficulty(0) ,imodbits_plate,[],[fac_kingdom_sept]],
 
["undead_women_plate_boots", "Undead Plate Boots", [("diabassa_boots",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0,
 2400 , weight(2.5)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(31)|difficulty(0) ,imodbits_plate,[],[fac_kingdom_undead]],
 
["carved_plate_boots", "Carved Plate Boots", [("female_plate_boots_falcon",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
2400 , weight(3.0)|abundance(25)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate,[]], 

["carved_plate_boots_1", "Carved Gold Plate Boots", [("female_plate_falcon_boots_gold",0)], itp_unique|itp_type_foot_armor | itp_attach_armature,0,
2400 , weight(3.0)|abundance(50)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ,[]], 

["carved_plate_boots_2", "Carved Gold Plate Boots", [("female_plate_boots_falcon_blue",0)], itp_unique|itp_type_foot_armor | itp_attach_armature,0,
2400 , weight(3.0)|abundance(50)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ,[]], 

["carved_plate_boots_3", "Carved Gold Plate Boots", [("female_plate_boots_falcon_blck",0)], itp_unique|itp_type_foot_armor | itp_attach_armature,0,
2400 , weight(3.0)|abundance(25)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate,[] ], 

["dark_warrior_boots", "Dark Warrior Boots", [("Black_Knightt",0)], itp_merchandise|itp_type_foot_armor | itp_attach_armature,0,
3000 , weight(2.2)|abundance(25)|head_armor(0)|body_armor(0)|leg_armor(40)|difficulty(7) ,imodbits_plate,[],[fac_kingdom_undead] ], 

["plate_boots_undead_a", "Plate Boots Undead", [("kongjuchangxue",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
 1870 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ], 
 
["plate_boots_undead_b", "Plate Boots Undead", [("siwangchangxue",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
 1870 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ], 
 
["plate_boots_undead_c", "Plate Boots Undead", [("youlingchangxue",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
 1870 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ], 
 
["jinweitui", "Plate Boots Undead", [("jinweitui",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
 2200 , weight(4.2)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(38)|difficulty(10) ,imodbits_plate ], 

["jinweitui_a", "Plate Boots Undead", [("jinweituiA",0)], itp_unique| itp_type_foot_armor | itp_attach_armature,0,
 1870 , weight(3.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(9) ,imodbits_plate ], 

["toumingshou","toumingshous", [("toumingshou",0)], itp_type_hand_armor|itp_unique|itp_civilian,0, 0, weight(0.0)|abundance(0)|body_armor(0)|difficulty(0),imodbits_cloth],
["toumingtou", "toumingtou", [("toumingtou",0)], itp_type_head_armor|itp_unique|itp_covers_head|itp_covers_beard|itp_covers_hair|itp_civilian ,0, 0 , weight(0)|abundance(0)|head_armor(0)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["toumingshen","toumingshen", [("toumingshen",0)], itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique|itp_civilian, 0, 0,weight(0)|body_armor(0)|leg_armor(0),imodbits_none],
["toumingtui", "toumingtui", [("toumingtui",0)], itp_type_foot_armor|itp_attach_armature|itp_unique|itp_civilian,0,0 , weight(0)|abundance(0)|head_armor(0)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],

["beauty_amulet_a", "Beauty amulet", [("angela_helm_band_a",0),("angela_helm_band_a",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 500 , weight(0.5)|abundance(40)|head_armor(25)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["beauty_amulet_b", "Beauty amulet", [("angela_helm_band_a",0),("angela_helm_band_a",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 800 , weight(0.5)|abundance(40)|head_armor(35)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["beauty_amulet_c", "Beauty amulet", [("angela_helm_band_a",0),("angela_helm_band_a",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 1100 , weight(0.5)|abundance(40)|head_armor(40)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["beauty_amulet_d", "Beauty amulet", [("angela_helm_band_a",0),("angela_helm_band_a",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 1400 , weight(0.5)|abundance(40)|head_armor(45)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["beauty_amulet_e", "Beauty amulet", [("angela_helm_band_a",0),("angela_helm_band_a",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 1700 , weight(0.5)|abundance(40)|head_armor(50)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["beauty_amulet_f", "Beauty amulet", [("angela_helm_band",0),("angela_helm_band",imodbits_horse_good)], itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian ,0, 1700 , weight(0.5)|abundance(40)|head_armor(50)|body_armor(0)|leg_armor(0),imodbits_cloth ],
["angel_armor_a", "Monster Armor", [("ts",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique    ,0, 0 , weight(30)|abundance(100)|head_armor(45)|body_armor(55)|leg_armor(35)|difficulty(0) ,imodbits_plate],
["angel_armor_b", "Monster Armor", [("tts",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique    ,0, 0 , weight(30)|abundance(100)|head_armor(45)|body_armor(55)|leg_armor(35)|difficulty(0) ,imodbits_plate],
["angel_armor_c", "Monster Armor", [("tt",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique    ,0, 0 , weight(30)|abundance(100)|head_armor(45)|body_armor(55)|leg_armor(35)|difficulty(0) ,imodbits_plate],

["behemoth_armor", "Behemoth Armor", [("kuangyeduyan",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique    ,0, 0 , weight(0)|abundance(0)|head_armor(70)|body_armor(90)|leg_armor(50)|difficulty(0) ,imodbits_plate],
["mohawk_armor", "Mohawk Armor", [("Mohawk",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique    ,0, 0 , weight(0)|abundance(0)|head_armor(60)|body_armor(60)|leg_armor(50)|difficulty(0) ,imodbits_plate],

["dark_plate_helmet","Dark Plate Helmet",[("yalunhelmet",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_1","Dark Plate Helmet",[("lancelothelmet",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_2","Dark Plate Helmet",[("akatoshhelmet",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_3","Dark Plate Helmet",[("gorieushelmetebony",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2800 , weight(2.2)|abundance(50)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_10","Dark Plate Helmet",[("Black_Knighth",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 3800 , weight(1.8)|abundance(25)|head_armor(70)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_4","Dark Plate Helmet",[("gaidenhelmet",0)], itp_unique|itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_5","Dark Plate Helmet",[("toukui",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_6","Dark Plate Helmet",[("dragonhelmet",0)], itp_unique|itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_7","Dark Plate Helmet",[("fahanhelmet",0)], itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_8","Dark Plate Helmet",[("gorieushelmetred",0)], itp_unique|itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_plate_helmet_9","Dark Plate Helmet",[("gorieushelmet",0)], itp_unique|itp_merchandise|itp_type_head_armor|itp_fit_to_head|itp_covers_head,0, 2400 , weight(2.3)|abundance(50)|head_armor(57)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate,[],[fac_kingdom_undead]],
["dark_steal_plate", "Dark Steal Plate", [("yalun",0)], itp_unique|itp_merchandise|itp_type_body_armor|itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_1", "Dark Steal Plate", [("wolfkinght",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_2", "Dark Steal Plate", [("dragon",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(25)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_3", "Dark Steal Plate", [("gorieusebony",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,15000 , weight(24)|abundance(25)|head_armor(0)|body_armor(75)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_10", "Dark Steal Plate", [("Black_Knight",0)], itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,20000 , weight(20)|abundance(25)|head_armor(0)|body_armor(80)|leg_armor(25)|difficulty(7) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_4", "Dark Steal Plate", [("wangjia",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_5", "Dark Steal Plate", [("gaiden",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_6", "Dark Steal Plate", [("akatosh",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_7", "Dark Steal Plate", [("gorieusred",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_8", "Dark Steal Plate", [("gorieus",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_steal_plate_9", "Dark Steal Plate", [("fahan",0)], itp_unique|itp_merchandise|itp_type_body_armor  |itp_covers_legs ,0,10000 , weight(26)|abundance(50)|head_armor(0)|body_armor(70)|leg_armor(20)|difficulty(8) ,imodbits_plate,[], [fac_kingdom_undead]],

["dark_devils_armor", "Dark Devils Armor", [("glowing_armor",0)], itp_type_body_armor|itp_covers_legs|itp_unique ,0,100000 , weight(20)|abundance(50)|head_armor(0)|body_armor(100)|leg_armor(30)|difficulty(0) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_devils_helmet", "Dark Devils Helmet", [("glowing_helmet",0)], itp_type_head_armor|itp_covers_head|itp_unique,0, 9800 , weight(2.0)|abundance(100)|head_armor(85)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate,[], [fac_kingdom_undead]],
["dark_devils_boots", "Dark Devils Boots", [("demonic_boots",0)], itp_type_foot_armor | itp_attach_armature|itp_unique,0,8770 , weight(2)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(55)|difficulty(0) ,imodbits_plate ,[], [fac_kingdom_undead]], 
["dark_devils_gauntlets","Dark Devils Gauntlets", [("demonic_gauntlets_L",0),("demonic_gauntlets_L",imodbit_reinforced)], itp_type_hand_armor|itp_unique,0, 1040, weight(1.0)|abundance(100)|body_armor(15)|difficulty(0),imodbits_plate,[], [fac_kingdom_undead]],

["sacred_brave_armor", "sacred Brave Armor", [("lierishizikai",0)], itp_type_body_armor|itp_covers_legs|itp_unique ,0,100000 , weight(20)|abundance(50)|head_armor(0)|body_armor(100)|leg_armor(30)|difficulty(0) ,imodbits_plate,[], [fac_kingdom_sept]],
["sacred_brave_helmet", "sacred Brave Helmet", [("lieritoukui",0)], itp_type_head_armor|itp_covers_head|itp_unique,0, 9800 , weight(2.0)|abundance(100)|head_armor(85)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate,[], [fac_kingdom_sept]],
["sacred_brave_boots", "sacred Brave Boots", [("lierihutui",0)], itp_type_foot_armor | itp_attach_armature|itp_unique,0,8770 , weight(2)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(55)|difficulty(0) ,imodbits_plate ,[], [fac_kingdom_sept]], 
["sacred_brave_gauntlets","sacred Brave Gauntlets", [("toumingshou",0)], itp_type_hand_armor|itp_unique,0, 1040, weight(1.0)|abundance(100)|body_armor(15)|difficulty(0),imodbits_plate,[], [fac_kingdom_sept]],

["undead_body", "Undead Body", [("undead_body",0)], itp_unique| itp_type_body_armor |itp_covers_legs ,0,47 , weight(0)|abundance(100)|head_armor(0)|body_armor(11)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["undead_body_skeleton", "Undead Body Skeleton", [("barf_skeleton",0)], itp_unique| itp_type_body_armor |itp_covers_legs ,0,47 , weight(0)|abundance(100)|head_armor(0)|body_armor(11)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["undead_body_skeleton_a", "Undead Body Skeleton", [("barf_skeleton_armor",0)], itp_unique| itp_type_body_armor |itp_covers_legs ,0,47 , weight(0)|abundance(100)|head_armor(0)|body_armor(28)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["undead_body_skeleton_b", "Undead Body Skeleton", [("barf_skeleton_armor_full",0)], itp_unique| itp_type_body_armor |itp_covers_legs ,0,47 , weight(0)|abundance(100)|head_armor(0)|body_armor(28)|leg_armor(20)|difficulty(0) ,imodbits_cloth ],
["undead_body_skeleton_c", "Undead Body Skeleton", [("barf_skeleton_greaves",0)], itp_unique| itp_type_body_armor |itp_covers_legs ,0,47 , weight(0)|abundance(100)|head_armor(0)|body_armor(11)|leg_armor(20)|difficulty(0) ,imodbits_cloth ],
["combat_maid_armor", "Combat Maid Armor", [("saber_armor",0)], itp_type_body_armor|itp_covers_legs|itp_unique,0,4200 , weight(20)|abundance(0)|head_armor(0)|body_armor(50)|leg_armor(15)|difficulty(7) ,imodbits_plate ],
["combat_maid_boots", "Combat Maid Boots", [("saber_boots",0)], itp_unique|itp_type_foot_armor|itp_attach_armature,0,2200 , weight(3.0)|abundance(25)|head_armor(0)|body_armor(0)|leg_armor(35)|difficulty(5) ,imodbits_plate], 
["combat_maid_hand","Combat Maid Hand", [("saber_hand_L",0)], itp_unique|itp_type_hand_armor,0, 1500, weight(0.8)|abundance(0)|body_armor(6)|difficulty(0),imodbits_armor],


["saber_crown", "Saber_Crown", [("saber_crown",0)], itp_unique|itp_type_head_armor|itp_doesnt_cover_hair|itp_civilian,0, 100000 , weight(1)|abundance(0)|head_armor(100)|body_armor(0)|leg_armor(0) ,imodbits_cloth],

["critical_weapon_start", "Critical Strike mediieval", [("FF",0),("FF", ixmesh_carry)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(115)|swing_damage(38 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ],

["critical_morningstar", "Critical Strike Morningstar", [("QSDC",0)], itp_crush_through|itp_type_two_handed_wpn|itp_merchandise|itp_primary|itp_wooden_parry|itp_unbalanced|itp_bonus_against_shield, itc_morningstar|itcf_carry_mace_left_hip, 
6000 , weight(5)|difficulty(14)|spd_rtng(80) | weapon_length(100)|swing_damage(40 , pierce) | thrust_damage(0 ,  pierce),imodbits_mace,[],[fac_kingdom_undead] ],

["critical_strike_medieval", "Critical Strike mediieval", [("FF",0),("FF", ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_bonus_against_shield, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(115)|swing_damage(38 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ,[],[fac_kingdom_undead] ],

["critical_strike_medieval_1", "Stone in the sword", [("FD",0)], itp_unique|itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back,
 6000 , weight(5)|difficulty(12)|spd_rtng(85) | weapon_length(130)|swing_damage(44 , cut) | thrust_damage(34 ,  pierce),imodbits_sword ],
 
["critical_weapon_end", "Critical Strike mediieval", [("FF",0),("FF", ixmesh_carry)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(115)|swing_damage(38 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ],
 
["vampire_weapon_start", "Devout sour mediieval", [("kongjumojian",0)], itp_unique|itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(125)|swing_damage(42 , cut) | thrust_damage(31 ,  pierce),imodbits_sword ],
 
["devour_soul_medieval", "Devout sour mediieval", [("kongjumojian",0)], itp_unique|itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(125)|swing_damage(42 , cut) | thrust_damage(31 ,  pierce),imodbits_sword ],
 
["vampire_weapon_end", "Devout sour mediieval", [("kongjumojian",0)], itp_unique|itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(125)|swing_damage(42 , cut) | thrust_damage(31 ,  pierce),imodbits_sword ],
 
["infuriate_weapon_start",         "Great Long Axe", [("long_axe_c",0)], itp_unique|itp_type_polearm| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee|itp_unbalanced|itp_merchandise, itc_staff|itcf_carry_axe_back,
 6000 , weight(5.5)|difficulty(10)|spd_rtng(91) | weapon_length(127)|swing_damage(54 , cut) | thrust_damage(19 ,  blunt),imodbits_axe ],
 
["infuriate_long_axe_c",         "Great Long Axe", [("long_axe_c",0)], itp_unique|itp_type_polearm| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee|itp_unbalanced|itp_merchandise, itc_staff|itcf_carry_axe_back,
 6000 , weight(5.5)|difficulty(10)|spd_rtng(91) | weapon_length(127)|swing_damage(54 , cut) | thrust_damage(19 ,  blunt),imodbits_axe ],
 
["infuriate_axe",         "Infuriate axe", [("spak_IceAxe",0)], itp_unique|itp_crush_through|itp_type_one_handed_wpn|itp_type_two_handed_wpn|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_unbalanced|itp_can_knock_down, itc_nodachi,
 6000 , weight(1.0)|difficulty(20)|spd_rtng(89) | weapon_length(200)|swing_damage(80 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ,[],[fac_kingdom_undead] ],
 
["infuriate_weapon_end",         "Great Long Axe", [("long_axe_c",0)], itp_unique|itp_type_polearm| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee|itp_unbalanced|itp_merchandise, itc_staff|itcf_carry_axe_back,
 6000 , weight(5.5)|difficulty(10)|spd_rtng(91) | weapon_length(127)|swing_damage(54 , cut) | thrust_damage(19 ,  blunt),imodbits_axe ],
 
["weakness_medieval", "Weakness  mediieval", [("FF",0),("FF", ixmesh_carry)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(115)|swing_damage(45 , cut) | thrust_damage(38 ,  pierce),imodbits_sword ],
 
["bewitch_medieval", "Bewitch mediieval", [("FC",0),("FC", ixmesh_carry)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2)|difficulty(6)|spd_rtng(120) | weapon_length(105)|swing_damage(20 , cut) | thrust_damage(20 ,  pierce),imodbits_sword ],
 
["bloodthirsty_medieval", "Bloodthirsty mediieval", [("FF",0),("FF", ixmesh_carry)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 6000 , weight(2.5)|difficulty(8)|spd_rtng(90) | weapon_length(115)|swing_damage(45 , cut) | thrust_damage(38 ,  pierce),imodbits_sword ],

["angel_sword_medieval_a", "Angel Sword Medieval Sword", [("tianshijian1",0)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 800 , weight(3)|difficulty(20)|spd_rtng(96) | weapon_length(130)|swing_damage(40 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ],
 
["angel_sword_medieval_b", "Angel Sword Medieval Sword", [("antianshijian1",0)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 800 , weight(3)|difficulty(20)|spd_rtng(96) | weapon_length(130)|swing_damage(40 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ],
 
["angel_sword_medieval_c", "Angel Sword Medieval Sword", [("xuetianshijian1",0)], itp_unique|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 800 , weight(3)|difficulty(20)|spd_rtng(96) | weapon_length(130)|swing_damage(40 , cut) | thrust_damage(32 ,  pierce),imodbits_sword ],
 
["angel_sword_shield_a", "Angel Sword shield",   [("tianshijian2" ,0)], itp_unique|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,  
800 , weight(3.5)|hit_points(400)|body_armor(60)|spd_rtng(96)|shield_width(30)|shield_height(100),imodbits_shield,[]],

["angel_sword_shield_b", "Angel Sword shield",   [("antianshijian2" ,0)], itp_unique|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,  
800 , weight(3.5)|hit_points(400)|body_armor(60)|spd_rtng(96)|shield_width(30)|shield_height(100),imodbits_shield,[]],

["angel_sword_shield_c", "Angel Sword shield",   [("xuetianshijian2" ,0)], itp_unique|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,  
800 , weight(3.5)|hit_points(400)|body_armor(60)|spd_rtng(96)|shield_width(30)|shield_height(100),imodbits_shield,[]],
...
["touming_shield", "Steel Shield", [("toumingshen",0)], itp_merchandise|itp_type_shield|itp_unique, itcf_carry_round_shield,  1697 , weight(0)|hit_points(700)|body_armor(17)|spd_rtng(61)|shield_width(40),imodbits_shield ],
...
["undead_dragon_staff", "Magic Novice Staff", [("wooden_staff",0)], itp_penalty_with_shield|itp_two_handed|itp_unique|itp_type_pistol|itp_primary|itp_next_item_as_melee|itp_is_magic_staff|itp_bonus_against_shield ,itcf_reload_pistol|itcf_shoot_pistol|itcf_carry_spear,
 360 , weight(0)|difficulty(0)|spd_rtng(50) | shoot_speed(85) | thrust_damage(30 ,pierce)|max_ammo(5)|accuracy(100),imodbits_magic_staff, magic_attack_trigger],
["undead_dragon_shield", "Undead Dragon Shield", [("toumingshen",0)], itp_unique|itp_type_shield, itcf_carry_round_shield,  697 , weight(0)|hit_points(1000)|body_armor(30)|spd_rtng(100)|shield_width(50),imodbits_shield ],
["undead_dragon_weapon", "Undead Dragon Weapon", [("toumingshen",0)], itp_unique|itp_type_two_handed_wpn| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_can_knock_down, itc_greatsword|itcf_carry_sword_back|itcf_show_holster_when_drawn,
 524 , weight(0)|difficulty(0)|spd_rtng(94) | weapon_length(80)|swing_damage(50 , cut) | thrust_damage(40 ,  pierce),imodbits_sword_high ],

["undead_dragon_armor", "Undead Dragon Armo", [("bone_dragon",0)], itp_civilian|itp_type_body_armor|itp_covers_legs|itp_covers_head|itp_unique ,0,100000 , weight(0)|abundance(0)|head_armor(100)|body_armor(100)|leg_armor(100)|difficulty(0) ,imodbits_plate,[], [fac_kingdom_undead]],

["darkness_combat_maid_dress", "Darkness Combat Maid Dress", [("zhandounvpuBody",0)], itp_unique|itp_type_body_armor|itp_covers_legs|itp_civilian ,0, 50000 , weight(5)|abundance(0)|head_armor(0)|body_armor(50)|leg_armor(40)|difficulty(0) ,imodbits_cloth, [],[fac_kingdom_undead]],
["darkness_combat_maid_helmet", "Darkness Combat Maid Helmet", [("zhandounvpuHelmetA",0)],itp_unique|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,10000, weight(0.1)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth, [],[fac_kingdom_undead]],
["darkness_combat_maid_helmet_a", "Darkness Combat Maid Helmet", [("zhandounvpuHelmetB",0)],itp_unique|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,10000, weight(0.1)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth, [],[fac_kingdom_undead]],
["darkness_combat_maid_helmet_b", "Darkness Combat Maid Helmet", [("zhandounvpuHelmetC",0)],itp_unique|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,10000, weight(0.1)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth, [],[fac_kingdom_undead]],
