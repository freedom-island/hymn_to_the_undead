...
skills = [
  ...
  ("inventory_management","Inventory Management",sf_base_att_int,15,"Increases inventory capacity by +6 per skill level. (Leader skill)"), 
  ...
  ("tracking","Tracking",sf_base_att_int|sf_inactive,10,"Tracks become more informative. (Party skill)"),
  ...
  ("looting","Looting",sf_base_att_agi|sf_effects_party,15,"This skill increases the amount of loot obtained by 10%% per skill level. (Party skill)"), 
  ...
  ("shield","Shield",sf_base_att_agi,15,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)"),
  ...
  ("power_magic","Power magic Skill",sf_base_att_int,15,"Each point to this skill increases magic damage increases by 10% per."), 
  #("reserved_14","Reserved Skill 14",sf_base_att_str|sf_inactive,10,"This is a reserved skill."), 
  ("reserved_10","Reserved Skill 10",sf_base_att_str|sf_inactive,10,"This is a reserved skill."), 
