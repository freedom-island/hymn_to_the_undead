   ...
   [
      ...
      (try_for_range, ":center_no", centers_begin, centers_end),
        (try_begin),
          ...
          (store_add, ":multiplier", 50, ":prosperity"), #multiplier changes between 20..120
  ...
  (0.1,
   [
	   ...
	   (try_for_parties, ":bandit_camp"),
         ...
         (store_faction_of_party,":bandit_faction",":bandit_camp"),
         (store_relation, ":cur_relation", "fac_player_supporters_faction", ":bandit_faction"),
...
##    ]),
  ...
  (14,
   [
    ...
    (try_for_range, ":j_stack", 0, ":num_prisoner_stacks"),
      (party_prisoner_stack_get_troop_id,":stack_troop","p_main_party",":j_stack"),
      (troop_get_type,":type",":stack_troop"),
      (neg|is_between,":type",tf_undead,tf_undead_end),
      (party_prisoner_stack_get_size, ":stack_size","p_main_party",":j_stack"),
      (val_add, ":num_prisoner_men", ":stack_size"),
    (try_end),
    (val_div, ":num_prisoner_men", 3),
    (try_begin),
      (eq, ":num_prisoner_men", 0),
      (val_add, ":num_prisoner_men", 1),
    (try_end),
    ...
    (store_add, ":consumption_amount", ":num_men",":num_prisoner_men"),
    (party_get_skill_level, ":skill", "p_main_party", "skl_inventory_management"),
    (store_mul, ":skill", ":skill", 3),
    (store_sub, ":food_consumption_reduced", 100, ":skill"),
    (val_mul, ":consumption_amount", ":food_consumption_reduced"),
  ...
  (72,
   [
     ...
     (try_for_range, ":village_no", villages_begin, villages_end),
       ...
       (call_script, "script_update_believer_troops_in_village", ":village_no"),
   ...
   [
     ...
     (try_begin),
       ...
       (try_for_range_backwards, ":i_stack", 0, ":num_stacks"),
         ...
         (assign,":is_run",1),
         (try_begin),
            (eq, ":player_faction_culture","fac_culture_undead"),
            (eq,":faction_no","fac_kingdom_undead"),
            (assign,":is_run",0),
         (else_try),
            (eq, ":player_faction_culture","fac_culture_sept"),
            (eq,":faction_no","fac_kingdom_sept"),
            (assign,":is_run",0),
         (try_end),
         (eq,":is_run",1),
         ##
 ...
 # reserved for future use. For backward compatibility, we need to use these triggers instead of creating new ones.
  ...
  (1,
   [
     ...
     (store_add, ":fac_kingdom_undead_plus_one", "fac_kingdom_undead", 1),

     (try_for_range, ":faction_1", "fac_kingdom_1", ":fac_kingdom_undead_plus_one"),
       (try_for_range, ":faction_2", "fac_kingdom_1", ":fac_kingdom_undead_plus_one"),
  ...
  (24,
   []),
    ...
    (try_for_parties, ":party_no"),
      ...
      (try_begin),
        ...
        (str_store_string, s1, "str_party_strength"),
        (party_set_extra_text, ":party_no", "str_s0_s1"),
      (else_try),
        (call_script, "script_party_calculate_strength", ":party_no", 0), 
        (str_store_string, s0, "str_party_strength"),
    ...
    (1,
   [
     (check_quest_active, "qst_deal_with_sea_raiders_army"),
     (quest_slot_eq,"qst_deal_with_sea_raiders_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_sea_raiders_army"),
        (gt,":num_destroyed","$global_num_sea_raiders_army_destroyed"),
        (quest_set_slot, "qst_deal_with_sea_raiders_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_sea_raiders_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_sea_raiders_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_sea_raiders_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_sea_raiders_army"),
         (call_script, "script_end_quest", "qst_deal_with_sea_raiders_army"),
     (try_end),
    ]),
    ...
    (1,
   [
     (check_quest_active, "qst_deal_with_desert_bandits_army"),
     (quest_slot_eq,"qst_deal_with_desert_bandits_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_desert_bandits_army"),
        (gt,":num_destroyed","$global_num_desert_bandits_army_destroyed"),
        (quest_set_slot, "qst_deal_with_desert_bandits_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_desert_bandits_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_desert_bandits_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_desert_bandits_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_desert_bandits_army"),
         (call_script, "script_end_quest", "qst_deal_with_desert_bandits_army"),
     (try_end),
    ]),
    ...
    (1,
   [
     (check_quest_active, "qst_deal_with_forest_bandits_army"),
     (quest_slot_eq,"qst_deal_with_forest_bandits_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_forest_bandits_army"),
        (gt,":num_destroyed","$global_num_forest_bandits_army_destroyed"),
        (quest_set_slot, "qst_deal_with_forest_bandits_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_forest_bandits_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_forest_bandits_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_forest_bandits_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_forest_bandits_army"),
         (call_script, "script_end_quest", "qst_deal_with_forest_bandits_army"),
     (try_end),
    ]),
    
     (1,
   [
     (check_quest_active, "qst_deal_with_steppe_bandits_army"),
     (quest_slot_eq,"qst_deal_with_steppe_bandits_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_steppe_bandits_army"),
        (gt,":num_destroyed","$global_num_steppe_bandits_army_destroyed"),
        (quest_set_slot, "qst_deal_with_steppe_bandits_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_steppe_bandits_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_steppe_bandits_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_steppe_bandits_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_steppe_bandits_army"),
         (call_script, "script_end_quest", "qst_deal_with_steppe_bandits_army"),
     (try_end),
    ]),
     ...
     (1,
   [
     (check_quest_active, "qst_deal_with_taiga_bandits_army"),
     (quest_slot_eq,"qst_deal_with_taiga_bandits_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_taiga_bandits_army"),
        (gt,":num_destroyed","$global_num_taiga_bandits_army_destroyed"),
        (quest_set_slot, "qst_deal_with_taiga_bandits_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_taiga_bandits_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_taiga_bandits_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_taiga_bandits_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_taiga_bandits_army"),
         (call_script, "script_end_quest", "qst_deal_with_taiga_bandits_army"),
     (try_end),
    ]),
   ...
   (1,
   [
     (check_quest_active, "qst_deal_with_mountain_bandits_army"),
     (quest_slot_eq,"qst_deal_with_mountain_bandits_army", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_mountain_bandits_army"),
        (gt,":num_destroyed","$global_num_mountain_bandits_army_destroyed"),
        (quest_set_slot, "qst_deal_with_mountain_bandits_army", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_with_mountain_bandits_army"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_mountain_bandits_army"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_with_mountain_bandits_army", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_with_mountain_bandits_army"),
         (call_script, "script_end_quest", "qst_deal_with_mountain_bandits_army"),
     (try_end),
    ]),
   ...
   (1,
   [
     (check_quest_active, "qst_deal_skolderbrotva_team"),
     (quest_slot_eq,"qst_deal_skolderbrotva_team", slot_quest_current_state,0),
     
     (try_begin),
        (store_num_parties_destroyed_by_player, ":num_destroyed", "pt_skolderbrotva_team"),
        (gt,":num_destroyed","$global_num_skolderbrotva_team_destroyed"),
        (quest_set_slot, "qst_deal_skolderbrotva_team", slot_quest_current_state, 1),
        (call_script, "script_succeed_quest", "qst_deal_skolderbrotva_team"),
     (else_try),
         (store_num_parties_of_template, ":num_parties", "pt_skolderbrotva_team"),
         (lt,":num_parties",1),
         (quest_set_slot, "qst_deal_skolderbrotva_team", slot_quest_current_state, 2),
         (call_script, "script_cancel_quest", "qst_deal_skolderbrotva_team"),
         (call_script, "script_end_quest", "qst_deal_skolderbrotva_team"),
     (try_end),
    ]),
  ...
  (24,
   [
     ...
     (neq,":faction","fac_sea_raider"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_sea_raider_army_next_renew_day"),
     (assign,"$hire_expiry",0),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
  ...
  (24,
   [
     ...
     (neq,":faction","fac_desert_bandit"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_desert_bandit_army_next_renew_day"),
     (assign,"$hire_expiry",1),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
   ...
   [
     ...
     (neq,":faction","fac_forest_bandits"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_forest_bandits_army_next_renew_day"),
     (assign,"$hire_expiry",2),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
   ...
   [
     ...
     (neq,":faction","fac_steppe_bandit"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_steppe_bandit_army_next_renew_day"),
     (assign,"$hire_expiry",3),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
   ...
   [
     ...
     (neq,":faction","fac_taiga_bandit"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_taiga_bandit_army_next_renew_day"),
     (assign,"$hire_expiry",4),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
   ...
   [
     ...
     (neq,":faction","fac_mountain_bandits"),
     (eq,":faction","fac_player_supporters_faction"),
     (store_current_day, ":cur_day"),
     (gt, ":cur_day", "$hire_mountain_bandit_army_next_renew_day"),
     (assign,"$hire_expiry",5),
     (jump_to_menu,"mnu_expiry_of_employment_contract"),
    ]),
    
    
     # exchange troops between lord's party and town/castle  writer by Rubik 
  (6,
    [
      (try_for_range, ":troop_no", heroes_begin, heroes_end),
        (troop_slot_eq, ":troop_no", slot_troop_occupation, slto_kingdom_hero),
        ...
        (party_get_num_companions, ":center_size_begin", ":cur_center"),

        ## transfer all members from center to hero_party
        (party_get_num_companion_stacks, ":num_stacks", ":cur_center"),
        (try_for_range_backwards, ":stack_no", 0, ":num_stacks"),
          (party_stack_get_troop_id, ":stack_troop", ":cur_center",":stack_no"),
          (party_stack_get_size, ":stack_size",":cur_center",":stack_no"),
          (party_add_members, ":hero_party", ":stack_troop", ":stack_size"),
          (party_stack_get_num_wounded, ":num_wounded", ":cur_center", ":stack_no"),
          (party_wound_members, ":hero_party", ":stack_troop", ":num_wounded"),
          (party_remove_members, ":cur_center", ":stack_troop", ":stack_size"),
        (try_end),
        ...
        (party_get_num_companion_stacks, ":party_stacks", ":hero_party"),
        (try_for_range, ":party_cur_stack", 0, ":party_stacks"),
          (party_stack_get_troop_id, ":party_cur_troop", ":hero_party", ":party_cur_stack"),
          (gt, ":party_cur_troop", -1),
          (neg|troop_is_hero, ":party_cur_troop"),
          (troop_is_guarantee_horse, ":party_cur_troop"),
          (party_stack_get_size, ":cavalry_stack_size", ":hero_party", ":party_cur_stack"),
          (val_add, ":num_cavalry", ":cavalry_stack_size"),
        (try_end),
        (store_sub, ":num_non_cavalry", ":total_size", ":num_cavalry"),
        (store_sub, ":num_cavalry_for_center", ":num_cavalry", ":party_size_begin"),
        (val_max, ":num_cavalry_for_center", 0),
        (store_sub, ":num_non_cavalry_for_center", ":center_size_begin", ":num_cavalry_for_center"),
        ...
        # make sure center_size_end = center_size_begin
        (party_get_num_companions, ":center_size_end", ":cur_center"),
        (store_sub, ":num_troop_to_move", ":center_size_begin", ":center_size_end"),
        ...
        (try_for_range_backwards, ":stack_no", 0, ":num_stacks"),
          ...
          (neg|troop_is_hero, ":stack_troop"),
          (party_stack_get_size, ":stack_size",":hero_party",":stack_no"),
          (gt, ":num_troop_to_move", 0),
          (assign, ":size_to_move", ":num_troop_to_move"),
          (val_min, ":size_to_move", ":stack_size"),
          (party_add_members, ":cur_center", ":stack_troop", ":size_to_move"),
          (party_stack_get_num_wounded, ":num_wounded", ":hero_party", ":stack_no"),
          (val_min, ":num_wounded", ":size_to_move"),
          (party_wound_members, ":cur_center", ":stack_troop", ":num_wounded"),
          (party_remove_members_wounded_first, ":hero_party", ":stack_troop", ":size_to_move"),
          (val_sub, ":num_troop_to_move", ":size_to_move"),
        (try_end),
      (try_end),
    ]),
...
(24,
    ...
    # exchange villages between lords by the bound_center 领主交换村子，以求同领主的村子和城堡/城镇为隶属关系 rubik  
    (24,
        [
          (try_for_range, ":village_no", villages_begin, villages_end),
   ...
   # (12*6,
   # [
      #(store_random_in_range,":center_village",villages_begin,villages_end),
        #  (party_get_slot, ":state",":center_village", slot_village_state),
         # (try_begin),
            #(eq,":state",svs_normal),
            #(party_get_slot, ":prosperity", ":center_village", slot_town_prosperity),
           # (call_script, "script_village_set_state",  ":center_village", svs_blast_disease),  
            #(str_store_party_name_link,s66,":center_village"),
           # (display_message,"@An outbreak of plague {s66} turned it into a living hell",0xFF9932CC),
            
           # (set_spawn_radius, 1),
           # (spawn_around_party,":center_village","pt_living_dead_team"),
           # (assign,":party_no",reg(0)),
           # (party_add_members,":party_no","trp_disease_zombie",50),
           # (party_add_members,":party_no","trp_disease_zombie_b",10),
           # (party_add_members,":party_no","trp_plague_devil",1),
           # (party_add_members,":party_no","trp_disease_zombie",":prosperity"),
    ...
    #(12*16,
    #[
     # (store_random_in_range,":center_castle",castles_begin,castles_end),
          #(str_store_party_name_link,s66,":center_castle"),
          #(party_get_num_companions,":num_men",":center_castle"),
          #(gt,":num_men",50),
         #(call_script, "script_change_center_prosperity", ":center_castle", -100),

          #(set_spawn_radius, 1),
          #(spawn_around_party,":center_castle","pt_living_dead_team"),
          #(assign,":party_no",reg(0)),
          #(party_set_slot, ":party_no", slot_party_type, spt_kingdom_hero_party),
          #(party_add_members,":party_no","trp_plague_devil",5),
        
          
          #(call_script,"script_party_companion_change_to_undead_jion_other_party",":center_castle",":party_no",2),
          #(call_script,"script_party_prisoner_change_to_undead_jion_other_party",":center_castle",":party_no",2),

         # (display_message,"@The castle plague broke out in the {s66}",0xFF9932CC), 
         # (play_sound,"snd_wuya"),
    #]),
    ...
    #(12*32,
    #[
      #(store_random_in_range,":center_town",towns_begin,towns_end),
          #(party_get_slot, ":prosperity", ":center_town", slot_town_prosperity),
          #(call_script, "script_change_center_prosperity", ":center_town", -100),
          #(str_store_party_name_link,s66,":center_town"),
        
          #(set_spawn_radius, 1),
          #(spawn_around_party,":center_town","pt_living_dead_team"),
          #(assign,":party_no",reg(0)),
          #(party_set_slot, ":party_no", slot_party_type, spt_kingdom_hero_party),
         
          
          #(assign,":prosperity",30),
          #(party_add_members,":party_no","trp_disease_zombie",150),
          #(party_add_members,":party_no","trp_disease_zombie_b",50),
          #(party_add_members,":party_no","trp_plague_devil",5),
          #(party_add_members,":party_no","trp_disease_zombie",":prosperity"),
          
          
          #(call_script,"script_party_companion_change_to_undead_jion_other_party",":center_town",":party_no",2),
          #(call_script,"script_party_prisoner_change_to_undead_jion_other_party",":center_town",":party_no",2),
          #(display_message,"@The plague broke out in the {s66} town",0xFF9932CC), 
          #(play_sound,"snd_wuya"),
    ...
    [
      (try_for_parties, ":party_no"),
        ...
        (eq, ":template_id", "pt_living_dead_team"),
         ##阵营 判断
        (store_faction_of_party, ":faction", ":party_no"),
        (eq,":faction",fac_living_dead),
        ##
        (try_for_parties, ":party_no_2"),
          ...
          (eq, ":template_id_2", ":template_id"),
           ##阵营 判断
          (store_faction_of_party, ":faction", ":party_no_2"),
          (eq,":faction",fac_living_dead),
          ##
    ...
    ##########################################邪教影响部队、邪教传教队 、活死人 部队转换处理代码-开始#############################################
    (5,
    [
      (try_for_parties, ":party_no"),
        (party_get_template_id, ":party_id", ":party_no"),
        (eq|this_or_next, ":party_id", "pt_living_dead_team"),
        (eq, ":party_id", "pt_living_dead_army"),
        (call_script,"script_party_companion_change_to_undead_jion_other_party",":party_no",":party_no",1),
        (call_script,"script_party_prisoner_change_to_undead_jion_other_party",":party_no",":party_no",1),    
     (try_end),
    ]),
    ...
    [
      (try_for_parties, ":party_no"),
        (party_get_template_id, ":party_id", ":party_no"),
        (is_between,":party_id","pt_heresy_missionary_steppe","pt_deserters"),
        (call_script,"script_party_companion_change_to_undead_jion_other_party",":party_no",":party_no",1),
        (call_script,"script_party_prisoner_change_to_undead_jion_other_party",":party_no",":party_no",1),    
     (try_end),
    ]),
  ...
  ##########################################特殊俘虏处理代码-开始#############################################
    ...
    [
      (try_for_parties, ":party_no"),
        (try_for_range, ":cur_troop","trp_npc_traveling_businessmen","trp_secret_armorer"),
            (party_count_prisoners_of_type, ":amount", ":party_no", ":cur_troop"),
            (try_begin),
                (gt,":amount",0),
                (party_remove_prisoners,":party_no",":cur_troop",":amount"),      ## 移除囚犯
            (try_end),
        (try_end),
      (try_end),
    ]),
