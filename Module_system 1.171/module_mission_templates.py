...
common_battle_tab_press = (
  ...
  [
    (try_begin),
      ...
      (call_script, "script_agents_resurrection_jion_party"),
      (finish_mission,0),
    (else_try),
...
common_battle_init_banner = (
  ...
  [
    ...
    (call_script, "script_agent_save_item",":agent_no"),
    
    (call_script, "script_battle_agent_spawn",":agent_no",0),
    (assign,"$g_battle_in_storm_a_city",0),
    
    (assign,"$g_battle_fly_z_height_limit",fly_z_height_limit),
    (try_begin),
        (eq,"$g_battle_in_storm_a_city",1),
        (assign,"$g_battle_fly_z_height_limit",fly_z_height_limit_city),
    (try_end),
   
  ])
common_battle_besiege_city_init_banner = (
ti_on_agent_spawn, 0, 0, [],
  [
    (store_trigger_param_1, ":agent_no"),
    (agent_get_troop_id, ":troop_no", ":agent_no"),
    ...
    (call_script, "script_battle_agent_spawn",":agent_no",1),
    (assign,"$g_battle_in_storm_a_city",1),
...
init_the_key_t = (
  ...
  0,0,2,[
  (eq,"$g_allow_flight_with_flying_AI",1),
  (key_clicked,key_t),
  (get_player_agent_no, ":player_agent"),
...
init_the_key_t_one = (
  ...
  (get_player_agent_no, ":player_agent"),
  (agent_is_alive, ":player_agent"),
  (agent_slot_ge,":player_agent",slot_agent_have_a_horse_of_agent,1),#坐骑模式 
  ],
  [
        (set_fixed_point_multiplier, 100),
        
        (get_player_agent_no, ":player_agent"), 
        (agent_get_slot,":horse_of_agent",":player_agent",slot_agent_have_a_horse_of_agent),#坐骑模式 
        (gt,":horse_of_agent",0),
        (agent_is_alive,":horse_of_agent"),
        (agent_get_troop_id,":troop_id",":horse_of_agent"),
        (eq,":troop_id","trp_undead_dragon"),
       
        (init_position,pos10),
        (agent_get_position, pos10, ":horse_of_agent"),  
        (position_move_z,pos10,20),        
        (agent_set_slot,":horse_of_agent",slot_agent_fly,1),#飞行 
        (agent_set_no_dynamics, ":horse_of_agent", 1),
        (agent_set_position,":horse_of_agent",pos10),
        (display_message,"@player horse of agent fly is on"),   
    ]
)   


common_player_fly_horse_of_agent = (0.0, 0.000000, 0.000000,
    [
      (eq,"$g_allow_flight_with_flying_AI",1),
      ...
      (agent_slot_ge,":horse_of_agent",slot_agent_fly,1),#非飞行 
    ...
    (try_begin),
        (gt,":y_move",0),
        (lt,":y_move",fly_y_move_min),
        (assign,":y_move",fly_y_move_min),
    (try_end),
   ...
   (else_try), 
    ...
    (try_begin),
        (gt,":y_move",0),
        (call_script,"script_cf_agent_go_forward_be_hindered_from_other_agent",":horse_of_agent",1),
        (assign,":be_block",1),
    (else_try),
        (lt,":y_move",0),
        (call_script,"script_cf_agent_go_back_be_hindered_from_other_agent",":horse_of_agent",1),
        (assign,":be_block",1),
    (else_try),
        (gt,":x_move",0),
        (call_script,"script_cf_agent_go_right_be_hindered_from_other_agent",":horse_of_agent",1),
        (assign,":be_block",1),
    (else_try),
        (lt,":x_move",0),
        (call_script,"script_cf_agent_go_left_be_hindered_from_other_agent",":horse_of_agent",1),
        (assign,":be_block",1),
    (try_end),
    (eq,":be_block",0),
    ##
    ...
    (try_begin),
        (ge,":pos_z","$g_battle_fly_z_height_limit"),
        (gt,":z_move",0),
        (assign,":z_move",0),
    (try_end),
    ##
    ...
    (try_begin),#接触地面退出飞行
        (le,":ground_level",10),      
        (agent_set_slot,":horse_of_agent",slot_agent_fly,0),#退出飞行 
        (agent_set_no_dynamics, ":var_0", 0),
        (display_message,"@hores of player fly is off"),
    (else_try),
        #防止飞出地图
        ...
        (assign,":cast_ray_value",200),
        (init_position,pos6),
        (try_begin),   
            (cast_ray, ":hit_position_register", pos6, pos5,":cast_ray_value"),
            (gt,":hit_position_register",0),
        (else_try),
            (agent_set_position,":var_0",pos5),
        (try_end), 
        
        #(agent_is_in_line_of_sight,":horse_of_agent",pos6),
        #(agent_set_position,":var_0",pos5),
    (try_end),    
])
...
init_the_key_o = (
  ...
  (key_clicked,key_o),
  (display_message,"@key o"),
  (get_player_agent_no, ":player_agent"),

  (neg|agent_slot_ge,":player_agent",slot_agent_have_a_horse_of_agent,1),
  (neg|agent_slot_ge,":player_agent",slot_agent_fly,1),#非飞行 
  ...
  [
    (try_begin),
       (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
       (call_script,"script_player_magic_summon_the_undead_dragon"),
    (else_try),
        #(faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"), 
    (try_end),
  ]
)
...
init_the_key_n = (
  ...
  [
    ...
    (spawn_scene_prop, "spr_abrams_chassis"),
    (assign,":abrams_chassis",reg0),
    ...
    (set_spawn_position, pos1),
    (spawn_scene_prop, "spr_abrams_turret"),
    (assign,":abrams_turret",reg0),
    ...
    (position_move_z, pos1, ":move_z"),
    (set_spawn_position, pos1),
    (spawn_scene_prop, "spr_abrams_gun"),
    (assign,":abrams_gun",reg0),
    (scene_prop_set_slot, ":abrams_chassis", scene_prop_slot_turret, ":abrams_turret"),
    (scene_prop_set_slot, ":abrams_chassis", scene_prop_slot_gun, ":abrams_gun"),
...
common_player_agent_have_a_horse_of_agent = ( 
    0.0,0,0,
    [
       (get_player_agent_no, ":player_agent"),
       (agent_is_alive,":player_agent"),
       (neg|agent_slot_ge,":player_agent",slot_agent_fly,1),#非飞行 
       (agent_slot_ge,":player_agent",slot_agent_have_a_horse_of_agent,1), 
       
       (agent_get_slot, ":a_horse_of_agent", ":player_agent", slot_agent_have_a_horse_of_agent),
       (ge,":a_horse_of_agent",1),
       (agent_is_human,":a_horse_of_agent"),

       (assign,":run",0),
       (try_begin),
          (agent_is_alive,":a_horse_of_agent"),
          (assign,":run",1),
       (else_try),
          (agent_set_slot, ":player_agent", slot_agent_have_a_horse_of_agent, -1),
    ...
    [
       ...
       (try_begin),
           (game_key_is_down|this_or_next,gk_move_forward),
           (game_key_is_down|this_or_next,gk_move_backward),
           (game_key_is_down|this_or_next,gk_move_left),
           (game_key_is_down,gk_move_right),
           ...
           (init_position,pos60), 
           (agent_get_position, pos60, ":a_horse_of_agent"),   
           (position_move_y,pos60,":y_move"),
           (position_move_x,pos60,":x_move"),
           (agent_set_scripted_destination,":a_horse_of_agent",pos60,1,0),
       (try_end),
        
       (init_position,pos60), 
       (agent_get_bone_position, pos60, ":a_horse_of_agent", hb_head, 1), #编号9为头部骨骼
       (init_position,pos62), 
       (agent_get_position, pos62, ":a_horse_of_agent"),        #循环agent :var_32当前人体位置坐标获取为pos62
       (position_get_x, ":var_34", pos62),
       (position_get_y, ":var_35", pos62),
       (position_get_z, ":var_36", pos62),
       (position_get_x, ":var_37", pos60),
       (position_get_y, ":var_38", pos60),
       (position_get_z, ":var_39", pos60),
       (store_sub, ":var_40", ":var_37", ":var_34"),            #用pos60，62的xyz坐标作差
       (store_sub, ":var_41", ":var_38", ":var_35"),
       (store_sub, ":var_42", ":var_39", ":var_36"),
       (val_mul, ":var_40", 18),                             #以上xyz差值乘1.8即为实际的头部骨骼坐标与位置坐标的xyz各差值
       (val_mul, ":var_41", 18),
       (val_mul, ":var_42", 18),
       (val_div, ":var_40", 10),                             #以上xyz差值乘1.8即为实际的头部骨骼坐标与位置坐标的xyz各差值
       (val_div, ":var_41", 10),
       (val_div, ":var_42", 10),
       (store_add, ":var_43", ":var_40", ":var_34"),               #人体位置xyz坐标加上实际的1.8倍人susanoo实际的头部骨骼坐标与位置坐标的xyz各差值得到1.8倍倍骨骼大小的人体头部骨骼坐标xyz值
       (store_add, ":var_44", ":var_41", ":var_35"),
       (store_add, ":var_45", ":var_42", ":var_36"),
       (init_position,pos63), 
       (position_set_x, pos63, ":var_43"),
       (position_set_y, pos63, ":var_44"),
       (position_set_z, pos63, ":var_45"),               #将实际1.8倍骨骼大小的人的头部骨骼坐标设为pos63
       (init_position,pos61), 
       (agent_get_position, pos61, ":player_agent"), 
       (position_move_z,pos61,50),
       (position_copy_rotation,pos63,pos61),
       (agent_set_position,":player_agent",pos63),
 
    ]
)


common_agent_have_a_horse_of_agent = ( 
    0.0,0,0,
    [
      (assign,":run",0),
     (eq,":run",1),
    ...
    [
       (try_for_agents, ":cur_agent"),
           (agent_is_alive,":cur_agent"),
           (agent_is_human,":cur_agent"),
           (neg|agent_slot_ge,":cur_agent",slot_agent_fly,1),#非飞行 
           (agent_get_slot, ":a_horse_of_agent", ":cur_agent", slot_agent_have_a_horse_of_agent),
           (gt,":a_horse_of_agent",0),
           (agent_is_human,":a_horse_of_agent"),
           ...
           (position_set_z, pos63, ":var_45"),               #将实际1.8倍骨骼大小的人的头部骨骼坐标设为pos63
           (init_position,pos61), 
           (agent_get_position, pos61, ":cur_agent"), 
           (position_move_z,pos61,50),
           (position_copy_rotation,pos63,pos61),
           (agent_set_position,":cur_agent",pos63),
      (try_end),
...
#仿骑砍二让小兵让路，防止玩家被堵
common_agent_be_moved_by_player_agent = (0.1, 0.000000, 0.000000,
[

        (eq, "$g_agent_avoidance_AI",1), 
        
        (neg|main_hero_fallen),
        (get_player_agent_no, ":player_agent"),
        (agent_get_speed, pos10, ":player_agent"),
        (position_get_y, "$g_player_agent_speed_y", pos10),
        (this_or_next|game_key_is_down, gk_move_forward),
        (gt, "$g_player_agent_speed_y", 0),
        (call_script,"script_cf_agent_is_no_fly",":player_agent"), 
],
[
        ...
        (try_for_agents, ":agent", pos10, 100),
            ...
            (lt, ":horse", 0),
            (init_position,pos11),
            (agent_get_speed, pos11, ":agent"),
            (position_get_y, ":speed_y", pos11),
            (le, ":speed_y", "$g_player_agent_speed_y"),
            (init_position,pos11),
            (agent_get_position, pos11, ":agent"),
            (position_transform_position_to_local, pos12, pos10, pos11),
            (position_get_y, ":pos_y", pos12),
            (ge, ":pos_y", 1),
            (position_get_x, ":pos_x", pos12),
            
            #玩家是否处在友方后面 0不在 1在
            (assign,":player_is_behind",0),
            (try_begin),
                (position_is_behind_position, pos10, pos11),
                (assign,":player_is_behind",1),
            (try_end),
            ...
            (position_move_x, pos11, ":x_move", 0),
...
common_player_fly = (0.0, 0.000000, 0.000000,
    [
      ...
      (try_end),
      #不满足条件强制设定,agent为非飞行单位,主要是针对骑马agent从高空落下没有死的情况
      (try_begin),
        (lt,":agent_can_fly",1),
        (agent_set_slot,":player_agent",slot_agent_fly,0),
      (try_end),
      (eq,":agent_can_fly",1),
    ],
    [
    ...
    (try_begin),
        ...
        (try_begin),
            (gt,":y_move",0),
            (lt,":y_move",fly_y_horse_move_min),
            (assign,":y_move",fly_y_horse_move_min),
        (try_end),
   ...
   (else_try), 
    ...
    (init_position,pos6),
    (copy_position ,pos6,pos5),
    (assign,":cast_ray_value",150),
    (try_begin),
        (gt,":horse",-1),
        (position_move_z, pos6, 300),
        (position_move_y, pos6, 300),
        (assign,":cast_ray_value",300),
    (else_try),
        (position_move_z, pos6, 150),
        (position_move_y, pos6, 100),
    (try_end),
...
[
   #设置pos单位量尺为cm  
    ...
    (try_for_agents, ":agent_no"),
        ...
        (neg|agent_slot_ge, ":agent_no", slot_agent_have_a_horse_of_agent, 1),
        ...
        (try_begin),
           ...
           (assign,":agent_can_fly",1),
        (else_try),
           (is_between|this_or_next,":troop_id","trp_angel_a","trp_necromancer_chanter"),
           (eq,":troop_id","trp_undead_dragon"),
           (assign,":agent_can_fly",1),
        (try_end),
        #不满足条件强制设定,agent为非飞行单位,主要是针对骑马agent从高空落下没有死的情况
        (try_begin),
          (lt,":agent_can_fly",1),
          (agent_set_slot,":agent_no",slot_agent_fly,0),
        (try_end),
        (eq,":agent_can_fly",1),
     ...
     ##强制设定目标
       ...
       (try_begin),
        ...
        (try_begin),#开始飞行
            ...
            (position_get_z,":z_value",pos20),
            (lt,":z_value","$g_battle_fly_z_height_limit"),
            
            (try_begin),
              (gt,":horse",-1),
              (assign,":var_0",":horse"),
              (position_move_z,pos20,20), 
              (assign,":distance_target_judgment",3000),
            (else_try),
              (assign,":var_0",":agent_no"),
              (position_move_z,pos20,20),
        ...
        (else_try),#起飞飞行
          ...
          (assign,":targert_terrain",0),
          (try_begin),
             (gt,":target_agent",-1),
             (agent_is_alive,":target_agent"),
             (neg|agent_slot_ge,":target_agent",slot_agent_fly,1),#目标非飞行
             (init_position,pos30),
             (agent_get_position, pos30, ":target_agent"),
             (position_get_distance_to_terrain ,":targert_terrain", pos30, ":target_agent"),            
          (try_end),
          
          (assign,":z_height",1000),
          (val_add,":z_height",":targert_terrain"),
          (val_min,":z_height","$g_battle_fly_z_height_limit"),
          (try_begin),
             (le, ":ground_level",":z_height"), 
        ...
        (else_try),#正常飞行
         ...
         (try_begin),
            ...
            (init_position,pos21),
            (init_position,pos22),
            (copy_position,pos22,pos20),
            (agent_get_position, pos21, ":target_agent"),
            (position_set_z,pos21,0),
            (position_set_z,pos22,0),
            (get_distance_between_positions,":distance_target",pos22,pos21), 
            #对应非飞行单位根据距离下降，进入一定范围后才下降
            (try_begin),
                (gt,":horse",0),
                (gt,":distance_target",1000),
                (assign,":z_move",0),
            (else_try),
                (gt,":distance_target",1000),
                (assign,":z_move",0),
         ...
         (else_try),#判断前方障碍点
            (init_position,pos21),
            (cast_ray, ":hit_position_register", pos21, pos20,200),
            (gt,":hit_position_register",0), 
            #限制飞行高度
            (position_get_z,":pos_z",pos19),
            (try_begin),
                (lt,":pos_z","$g_battle_fly_z_height_limit"),
                (position_move_z,pos19,10), 
            (try_end),  
            (position_rotate_z,pos19,5),         
...
common_agent_use_siege_weapon = (0, 0, 0,[],
[  
]
)
##攻城武器部分
...
common_agent_rider_lead_charge_ai =  (0.5, 0, 0,
[
 (eq, "$g_cavalry_returns_to_charge_AI", 1),  
],
[
    (set_fixed_point_multiplier, 100),
...
common_riding_and_shooting_ai =  (  0.5, 0, 0, 
[
    (eq, "$g_mounted_shooting_AI", 1),  
],
      [ 
        #君悦大佬骑射AI代码
        #https://bbs.mountblade.com.cn/thread-1907322-1-1.html
...
#骑砍的射击系统及射击ai代码 https://bbs.mountblade.com.cn/thread-2039741-1-1.html 君悦  
#要启用就把slot_agent_archer_stae的值赋为2
shoot_ai = (
 0,0,0,[],
  [
     (eq,0,0),
...
[
   ...
   (try_for_range, ":cur_instance", 0, ":num_instances_of_scene_prop"),
       ...
       (scene_prop_get_slot, ":use_agent", ":cur_instance_id", scene_prop_slot_use_agent),
       (gt,":use_agent",0),
       (agent_is_alive,":use_agent"),
       (scene_prop_get_slot, ":animation_speed", ":cur_instance_id", scene_prop_slot_animation_speed),
       (neq,":animation_speed",0),
       (val_abs,":animation_speed"),
       (prop_instance_get_position, pos50, ":cur_instance_id"),
       
       #150*150+350*350 = 14500000 根号14500000 = 380 380+50 = 430
       (try_for_agents,":agents_no",pos50,430),
            (gt,":agents_no",-1),
            (neq,":agents_no",":use_agent"),
            (agent_is_alive,":agents_no"),
            (agent_is_human,":agents_no"),
            (agent_get_horse,":horse_agent",":agents_no"),
            (assign,":target_agent",":agents_no"),
            (try_begin),
                (gt,":horse_agent",-1),
                (assign,":target_agent",":horse_agent"),
            (try_end),
            (agent_get_position,pos51,":target_agent"),
            (position_transform_position_to_local,pos52,pos50,pos51),
            (position_get_y,":relative_y",pos52),
            (position_get_x,":relative_x",pos52),
            (is_between,":relative_y",-430,430),
            #(is_between,":relative_y",-350,350),
            ...
            (position_move_y,pos53,":relative_y"),
            (position_move_x,pos53,":relative_x_temp"),
            (position_copy_rotation,pos53,pos51),
            (agent_set_position,":target_agent",pos53),
            
            (agent_get_troop_id,":troop_id",":target_agent"),
            (troop_get_type, ":troop_type", ":troop_id"),
            (neq,":troop_type",tf_dragon),
            (neq,":troop_type",tf_undead_giant_pluse),
            ...
            (agent_get_team,":user_agent_team",":use_agent"),
            (agent_get_team,":agents_no_team",":agents_no"),
            (teams_are_enemies,":user_agent_team",":agents_no_team"),
            
            (try_begin),
                (agent_is_human,":target_agent"),
                (val_mul,":animation_speed",5),
                (agent_deliver_damage_to_agent, ":use_agent", ":target_agent",":animation_speed",0),
            (else_try),
                (agent_start_running_away,":target_agent"),
                (val_mul,":animation_speed",5),
                (agent_deliver_damage_to_agent, ":use_agent", ":target_agent",":animation_speed",0),
            (try_end),
        (try_end),
...
init_my_ti_on_agent_hit = (
    ...
    [
        ...
        (item_get_type,":item_type",":item_id"),
        (gt,":item_type",0),
        (agent_is_alive,":dealer_agent_id"),
        (agent_is_alive,":inflicted_agent_id"),
        (agent_is_human,":dealer_agent_id"),
        (agent_is_human,":inflicted_agent_id"),
        (agent_get_troop_id,":inflicted_troop_id",":inflicted_agent_id"),
        (troop_get_type,":inflicted_type",":inflicted_troop_id"),
        (agent_get_troop_id,":dealer_troop_id",":dealer_agent_id"),
        #(troop_get_type,":dealer_type",":dealer_troop_id"),
        (store_random_in_range,":random",0,100),
        #(agent_get_party_id,":dealer_agent_party",":dealer_agent_id"),  ##获取进攻者的队伍ID	
        #(agent_get_party_id,":inflicted_agent_party",":inflicted_agent_id"),  ##获取被攻者的队伍ID	
        (get_player_agent_no,":player_agent_id"),
        
        #武器type通用效果
        (try_begin),#长杆反骑兵武器
            (eq,":item_type",itp_type_polearm),
            (agent_get_horse,":horse",":inflicted_agent_id"),
            (gt,":horse",-1),
            (agent_get_horse,":horse",":dealer_agent_id"),
            (le,":horse",-1),
            (assign,":damage_old",":damage"),
            (val_mul,":damage",135),
            (val_div,":damage",100),
            (try_begin),
                (eq,":player_agent_id",":dealer_agent_id"),
                (store_sub,reg30,":damage",":damage_old"),
                (display_message,"@Add type polearm damage {reg30} tip",0xFF33DDFF),
            (try_end),
        (try_end),
        
        
        (try_begin),#远程燃烧 bow
            (eq|this_or_next, ":missile_item", "itm_fuel_bolts"),
            (eq|this_or_next, ":missile_item", "itm_fuel_arrows"),
            (eq, ":missile_item", "itm_hight_fire_arrows"),
            (store_add,":slot",slot_agent_fuel_abdomen,":bone"),
            (agent_get_slot,":num",":inflicted_agent_id",":slot"),
            (val_add,":num",10),
            (agent_set_slot, ":inflicted_agent_id", ":slot",":num"),
            (agent_get_bone_position, pos57, ":inflicted_agent_id", ":bone", 1),
            (particle_system_burst,"psys_fuel_arrows_fire",pos57,10),
        (try_end),
        
        (try_begin),
            (eq, ":missile_item", "itm_hight_fire_arrows"),
            (call_script,"script_cf_attack_agent_play_sound",":inflicted_agent_id",0,0),
        (try_end),
        
        (try_begin),
            (eq,":item_type",itp_type_pistol),
            (store_skill_level, ":power_magic_skill", "skl_power_magic", ":dealer_troop_id"),
            (gt,":power_magic_skill",0),
            
            (try_begin),
                (is_between,":inflicted_type",tf_undead,tf_undead_end),
                (val_mul,":damage",130),
                (val_div,":damage",100),
            (try_end),
            
            (store_mul,":power_magic_damage",":power_magic_skill",":damage"),
            (val_div,":power_magic_damage",10),
            (val_add,":damage",":power_magic_damage"),
            (try_begin),
                (eq,":player_agent_id",":dealer_agent_id"),
                (assign,reg30,":power_magic_damage"),
                (display_message,"@Add power magic damage {reg30} tip",0xFF33DDFF),
            (try_end),
        (try_end),
               ...
               #其他武器单效果，其实应该分开
               (try_begin),#暴击武器
                    (is_between,":item_id","itm_critical_weapon_start","itm_critical_weapon_end"),  
                     (le,":random",25),
                     (val_mul,":damage",2),
                     (assign,reg30,":damage"),
                      ...
                      (try_begin),
                          (eq,":dealer_agent_id",":player_agent_id"),
                          (display_message,"@Add strike {reg30} tip",0xFF33DDFF),
                      (try_end),
                (else_try),#吸血武器
                     (is_between,":item_id","itm_vampire_weapon_start","itm_vampire_weapon_end"),        
                     (le,":random",30),
                     (assign,":vampire",":damage"),
                     (val_div,":vampire",4),
                     (assign,reg30,":vampire"),
                     (store_agent_hit_points,":cur_hp",":dealer_agent_id",1),
                     (val_add,":cur_hp",":vampire"),
                     (agent_set_hit_points,":dealer_agent_id",":cur_hp",1),
                        
                     (try_begin),
                            (eq,":dealer_agent_id",":player_agent_id"),
                            (display_message,"@Add health {reg30} tip",0xFF33DDFF),
                     (try_end),
                (else_try),#狂暴武器
                    (is_between,":item_id","itm_infuriate_weapon_start","itm_infuriate_weapon_end"),         
                    (store_agent_hit_points,":relative_hp",":dealer_agent_id",0),
                    (le,":relative_hp",50),
                    (store_div,":infuriate",":damage",2),
                    (val_add,":damage",":infuriate"),
                    (assign,reg30,":damage"),
                     
                    (try_begin),
                        (eq,":dealer_agent_id",":player_agent_id"),
                        (display_message,"@Add damage {reg30} tip",0xFF33DDFF),
                    (try_end),
                (else_try),#审判之刃
                  (eq,":item_id","itm_angel_sword_medieval_c"), 
                  #普通复仇效果
                  (agent_get_kill_count,":count",":inflicted_agent_id"),
                  (store_mul,":harm",":count",10),
                  (val_min,":harm",50),
                  (val_add,":harm",50),
                  (store_mul,":value",":harm",1),
                  (val_add,":damage",":harm"),
                  (assign,reg30,":harm"),
                  #(try_begin),
                      #(eq,":dealer_agent_id",":player_agent_id"),
                      #(display_message,"@fire harm {reg30} tip",0xFF33DDFF),
                  #(try_end),
            
                  #复仇之焰效果
                  (le,":random",35),
                  (agent_get_slot, ":magic_value",":dealer_agent_id", slot_agent_magic_value),
                  (gt,":magic_value",0),
                  (val_sub,":magic_value",5),
                  (agent_set_slot,":dealer_agent_id",slot_agent_magic_value, ":magic_value"),
                  (agent_get_position,pos10,":inflicted_agent_id"),	
                  (agent_get_position,pos11,":dealer_agent_id"),
                  (particle_system_burst,"psys_red_fire_big",pos10,":value"),
                  (agent_play_sound,":dealer_agent_id","snd_red_fire"),
                  (agent_get_team, ":team",":inflicted_agent_id"),	

                  (try_for_agents,":agent"),
                       (agent_is_human,":agent"),
                       (agent_is_alive,":agent"),
                       (neq,":agent",":inflicted_agent_id"),
                       (neq,":agent",":dealer_agent_id"),
                       (agent_get_team, ":team_1",":agent"),	
                       (eq,":team",":team_1"),
                       (agent_get_position,pos10,":agent"),	
                       (neg|position_is_behind_position,pos11,pos10),             
                       (get_distance_between_positions,":dist",pos10,pos11),
                       (le,":dist",200),                
                       (agent_deliver_damage_to_agent,":dealer_agent_id",":agent",":harm",0),	 
                 (try_end), 
            (try_end),
        
        (try_begin),#诅咒提高伤害
           (agent_slot_eq,":inflicted_agent_id",slot_agent_curse,1),
           (val_mul,":damage",130),
           (val_div,":damage",100),
        (try_end),
        
        (try_begin),#祝福降低伤害
           (agent_slot_eq,":inflicted_agent_id",slot_agent_blessing,1),
           (assign,":damage_old",":damage"),
           (val_mul,":damage",70),
           (val_div,":damage",100),
           
           (try_begin),#祝福降低伤害
                 (eq,":inflicted_agent_id",":player_agent_id"),
                 (store_sub,reg30,":damage_old",":damage"),
                 (display_message,"@bless sub damage {reg30}",color_code_hot),
           (try_end),
        (try_end),
        ...
        (try_begin),#铁骨降低伤害
            ...
            (store_skill_level, ":cur_skill", "skl_ironflesh", ":troop_id"),
            (val_mul,":cur_skill",2),
            (store_sub,":skill",100,":cur_skill"),
            (val_mul,":damage",":skill"),
            (val_div,":damage",100),
            
           (try_begin),#铁骨降低伤害
                 (eq,":inflicted_agent_id",":player_agent_id"),
                 (store_sub,reg30,":damage_old",":damage"),
                 (display_message,"@inflicted sub damage {reg30}",0xFFFF0000),
           (try_end),
        (try_end),
        
        
        (try_begin),
            (eq,":inflicted_type",tf_undead_skeleton),#troop_id是骷髅单位
            (eq|this_or_next,":item_type",itp_type_bow),
            (eq|this_or_next,":item_type",itp_type_crossbow),
            (eq|this_or_next,":item_type",itp_type_pistol),
            (eq|this_or_next,":item_type",itp_type_musket),
            (eq,":item_type",itp_type_thrown),
            (val_div,":damage",2),
            #(assign,reg30,":damage"),
            #(str_store_item_name,s10,":item_id"),
            #(display_message,"@test damage {reg30} from {s10}",0xFF33DDFF),
        (try_end),
        
        (get_player_agent_no,":player_agent"), 
        
       (try_begin),
           (agent_get_slot,":agent_driving_vehicle",":inflicted_agent_id",slot_agent_driving_vehicle),
           (gt,":agent_driving_vehicle"),
           (assign,":damage",0),
       (try_end),
        ...
        (try_begin),
            ...
            (assign,reg30,":damage"),
            (str_store_agent_name,s10,":dealer_agent_id"),
            (display_message,"@player inflicted damage {reg30} to {s10}",0xFFFF0000),
        (try_end),
...
init_agent_attachments_horse = (
    1,0,0,[],[]
)

#玩家回旋踢
check_agent_round_kick = (
0,0,0,
[
     ...
     (agent_get_animation,":cur_anim",":player_no"),
     (eq|this_or_next,":cur_anim","anim_round_kick_right_leg"),
     (eq,":cur_anim","anim_round_kick_left_leg"),
],
[

])

init_player_agent_round_kick = (
0,3,0,
[
     (assign,":player_set_animation",0),
     (get_player_agent_no,":player_no"),
     (agent_is_alive,":player_no"),
     (agent_get_horse, ":horse_no", ":player_no"),
     (le, ":horse_no", -1),#无马,
    ...
    #(try_begin),
        #(key_clicked, key_p),
        #(agent_set_animation,":player_no","anim_round_kick_right_leg"),
        #(assign,":player_set_animation",1),
    #(try_end),
    
    (eq,":player_set_animation",1),
    (display_message,"@player agent round kick wait 5s",0xFF33DDFF),
],   
[
    (display_message,"@player agent round kick is ok",0xFF33DDFF), 
    
])
#弓箭武技-效果伤害
check_common_agent_martial_arts_bow = (
0.1,0,0,[],
[
    (set_fixed_point_multiplier,1000),
    (try_for_agents,":agent_no"),
        (agent_is_human,":agent_no"),
        (agent_is_alive,":agent_no"),
        (agent_get_animation,":cur_anim",":agent_no"),
        (agent_get_animation,":cur_anim_up",":agent_no",1),
        
        (eq|this_or_next,":cur_anim","anim_release_bow_arts"),
        (eq|this_or_next,":cur_anim_up","anim_release_bow_arts"),
        (eq|this_or_next,":cur_anim","anim_release_bow_arts_one"),
        (eq|this_or_next,":cur_anim_up","anim_release_bow_arts_one"),
        (eq|this_or_next,":cur_anim","anim_release_bow_arts_two"),
        (eq,":cur_anim_up","anim_release_bow_arts_two"),
        
        (init_position,pos46),
        (init_position,pos47),
        (agent_get_look_position, pos46, ":agent_no"), # checks agents aim
        (agent_get_position, pos47, ":agent_no"),
        (agent_get_bone_position, pos47, ":agent_no",8,1),#胸部
        (position_copy_rotation,pos47,pos46),
       ...
       (try_end),
        ...
        (try_begin),
            (agent_slot_ge,":agent_no",slot_agent_is_martial_arts_bow,1),
            (eq|this_or_next,":cur_anim","anim_release_bow_arts"),
            (eq,":cur_anim_up","anim_release_bow_arts"),
            (assign, ":missile_speed", 100000), # converts missile speed to something useable by add_missile
            (store_random_in_range,":range_x",-10,10),
            (store_random_in_range,":range_z",-10,10),
            (position_move_x,pos47,":range_x"),
            (position_move_z,pos47,":range_z"),
            ...
            (add_missile, ":agent_no", pos47, ":missile_speed", ":wielded_item", itp_type_bow, "itm_hight_fire_arrows", itp_type_arrows), # finally commits the left hand throw
            (call_script,"script_agent_slot_sub",":agent_no",slot_agent_is_martial_arts_bow,1),
            (agent_play_sound,":agent_no","snd_arrow_of_fire_1"),
        (else_try),   
            (agent_slot_ge,":agent_no",slot_agent_is_martial_arts_bow,1),
            (eq|this_or_next,":cur_anim","anim_release_bow_arts_one"),
            (eq,":cur_anim_up","anim_release_bow_arts_one"),
            (assign, ":missile_speed", 100000), # converts missile speed to something useable by add_missile
            (copy_position,pos48,pos47),
            (copy_position,pos49,pos47),
            (add_missile, ":agent_no", pos47, ":missile_speed", ":wielded_item", itp_type_bow, "itm_hight_fire_arrows", itp_type_arrows), 
            (try_for_range,":num",0,6),
                (position_rotate_z,pos48,10),
                (position_move_x,pos48,5),
                (add_missile, ":agent_no", pos48, ":missile_speed", ":wielded_item", itp_type_bow, "itm_hight_fire_arrows", itp_type_arrows),
            (try_end),
            (try_for_range,":num",0,6),
                (position_rotate_z,pos49,-10),
                (position_move_x,pos49,-5),
                (add_missile, ":agent_no", pos49, ":missile_speed", ":wielded_item", itp_type_bow, "itm_hight_fire_arrows", itp_type_arrows),
            (try_end),
            (assign,":num",0),#防止报错无任何意义
            (agent_set_slot,":agent_no",slot_agent_is_martial_arts_bow,":num"),
            (agent_play_sound,":agent_no","snd_arrow_of_fire_1"),
        (else_try),  
            (eq|this_or_next,":cur_anim","anim_release_bow_arts_two"),
            (eq,":cur_anim_up","anim_release_bow_arts_two"),
            (assign, ":missile_speed", 50000), 
            (store_random_in_range,":range_x",-30,30),
            (store_random_in_range,":range_z",-30,30),
            (position_move_x,pos47,":range_x"),
            (position_move_z,pos47,":range_z"),
            (add_missile, ":agent_no", pos47, ":missile_speed", ":wielded_item", itp_type_bow, "itm_explosive_arrows", itp_type_arrows),
            (agent_play_sound,":agent_no","snd_arrow_of_fire_2"),
        (try_end),    
    (try_end),
],
)
#agent近战武技攻击-特效-伤害
check_common_agent_martial_arts_attack = (
0.0,0,0,
[  
],
[
    (try_for_agents,":agent"),
        ...
        (agent_get_animation,":cur_anim_down",":agent",0),
        (agent_get_animation,":cur_anim_up",":agent",1),
        
        (assign,":cur_anim",-1),
        (try_begin),
            (is_between,":cur_anim_down","anim_martial_arts_start","anim_martial_arts_end"),
            (assign,":cur_anim",":cur_anim_down"),
        (else_try),
            (is_between,":cur_anim_up","anim_martial_arts_start","anim_martial_arts_end"),
            (assign,":cur_anim",":cur_anim_up"),
        (try_end),
        ...
        (try_begin),#盾牌武技
            (is_between,":cur_anim","anim_shield_bash","anim_martial_arts_end"),
            (store_skill_level, ":shield", "skl_shield", ":troop_id"),
            (try_begin),
                (eq,":cur_anim","anim_shield_plus_dash"),
                (store_skill_level, ":athletics", "skl_athletics", ":troop_id"),
                (store_mul,":harm",":shield",3),
                (val_add,":harm",":athletics"),
                (assign,":impact_level",2),
            (else_try),
                (eq,":cur_anim","anim_chao_ren_quan"),
                (store_mul,":harm",":shield",4),
                (assign,":impact_level",2),
            (else_try),
                (store_mul,":harm",":shield",2),
                (assign,":impact_level",1),
            (try_end),
        (else_try),#翻滚武技
            (is_between,":cur_anim","anim_defensive_spinning_slash","anim_one_hand_attack_1"),
            (store_skill_level, ":power_strike", "skl_power_strike", ":troop_id"),
            (store_skill_level, ":athletics", "skl_athletics", ":troop_id"),
            (val_add,":power_strike",":athletics"),
            (store_mul,":harm",":power_strike",2),
            (assign,":impact_level",2),
        (else_try),#腿武技
            (is_between,":cur_anim","anim_kick_leftleg_y","anim_defensive_spinning_slash"),
            (store_skill_level, ":power_strike", "skl_power_strike", ":troop_id"),
            (store_skill_level, ":athletics", "skl_athletics", ":troop_id"),
            (val_add,":power_strike",":athletics"),
            (store_mul,":harm",":power_strike",1),
            (assign,":impact_level",1),
            (try_begin),
              (eq,":cur_anim","anim_roll_kick_forward"),
              (assign,":impact_level",2),
            (try_end),
        (else_try),#跳远武技
            (is_between,":cur_anim","anim_tiaozhang","anim_shield_bash"),
            (store_skill_level, ":power_strike", "skl_power_strike", ":troop_id"),
            (store_skill_level, ":athletics", "skl_athletics", ":troop_id"),
            (store_mul,":power_strike",":power_strike",3),
            (store_mul,":athletics",":athletics",1),
            (store_add,":harm",":athletics",":power_strike"),
            (assign,":impact_level",4),
       (else_try),#步伐武技
            (is_between,":cur_anim","anim_one_hand_attack_1","anim_attacks_twohanded_overswing_y"),
            (store_skill_level, ":power_strike", "skl_power_strike", ":troop_id"),
            (store_mul,":harm_1",":power_strike",3),
            (store_skill_level, ":athletics", "skl_athletics", ":troop_id"),
            (store_mul,":harm_2",":athletics",1),
            (store_add,":harm",":harm_1",":harm_2"),
        ...
        (assign,":harm_add_weapon",0),
        (try_begin),
            (neg|is_between,":cur_anim","anim_kick_leftleg_y","anim_defensive_spinning_slash"),
            (store_skill_level, ":weapon_master", "skl_weapon_master", ":troop_id"),
            (store_mul,":harm_add_weapon",":harm",":weapon_master"),
            (val_div,":harm_add_weapon",5),
        (try_end),
        
        (store_skill_level, ":power_magic", "skl_power_magic", ":troop_id"),
        (store_mul,":harm_add_magic",":harm",":power_magic"),
        (val_div,":harm_add_magic",5),
        (val_add,":harm",":harm_add_magic"),
        (val_add,":harm",":harm_add_weapon"),
     
        #接触计算
        (try_begin),#盾牌
            (is_between,":cur_anim","anim_shield_bash","anim_martial_arts_end"),
            (agent_get_bone_position, pos1, ":agent", hb_item_l, 1),
            (agent_get_wielded_item, ":weapon_no", ":agent", 1),
            (item_get_type,":type",":weapon_no"),
            (item_get_weapon_length, ":weapon_length", ":weapon_no"),
            (val_mul,":weapon_length",2),
            (val_add,":weapon_length",50),
            (assign, ":weapon_length_one", ":weapon_length"),
            (copy_position,pos10,pos1),
            (position_move_y, pos1, ":weapon_length"),
        (else_try),#腿武技-右
            (is_between,":cur_anim","anim_kick_rightleg_y","anim_kick_leftleg_y"),
            (agent_get_bone_position, pos1, ":agent", hb_foot_r, 1),
            (assign, ":weapon_length",100),
            (assign, ":weapon_length_one", ":weapon_length"),
            (copy_position,pos10,pos1),
        (else_try),#腿武技-左
            (is_between,":cur_anim","anim_kick_leftleg_y","anim_defensive_spinning_slash"),
            (agent_get_bone_position, pos1, ":agent", hb_foot_l, 1),
            (assign, ":weapon_length",100),
            (assign, ":weapon_length_one", ":weapon_length"),
            (copy_position,pos10,pos1),
        (else_try),
        ...
        (try_begin),
            (is_between,":cur_anim","anim_shield_bash","anim_martial_arts_end"),
            (position_move_y, pos10,20),
            (particle_system_burst,"psys_torch_fire_big",pos10,1),
        (else_try),
            (is_between,":cur_anim","anim_kick_rightleg_y","anim_defensive_spinning_slash"),
            #(particle_system_burst,"psys_torch_fire_big",pos10,1),
            (val_mul,":weapon_length",10),
            (val_div,":weapon_length",100),
            (try_for_range,":move_y",0,":weapon_length"),
                (position_move_y, pos10, ":move_y"),      
                (particle_system_burst,"psys_torch_fire_small",pos10,1),
            (try_end),
        (else_try),
            (eq,":type",itp_type_one_handed_wpn),
            (val_mul,":weapon_length",16),
            (val_div,":weapon_length",100),
            (try_for_range,":move_y",0,":weapon_length"),
                (position_move_y, pos10, ":move_y"),
                (position_rotate_y,pos10,45),        
                (particle_system_burst,"psys_torch_fire_small",pos10,1),
            (try_end),
        (else_try),
            (val_mul,":weapon_length",14),
            (val_div,":weapon_length",100),
            (try_for_range,":move_y",0,":weapon_length"),
                (position_move_y, pos10, ":move_y"),
                (position_rotate_y,pos10,45),        
        ...
        (try_for_agents,":enemies",pos3,":weapon_length_one"),#get target
            (gt,":num",0),
            (agent_is_alive,":enemies"),
            (agent_get_team,":enemies_team",":enemies"),
            (teams_are_enemies,":enemies_team",":agent_team"),
            #(call_script,"script_cf_agent_be_strike_down",":enemies"),
            (agent_get_troop_id,":troop_enemies",":enemies"),
            #(neg|troop_is_hero,":troop_enemies"),
            (troop_get_type,":type_enemies",":troop_enemies"),
        
            (try_begin),
                (eq|this_or_next,":type_enemies",tf_undead_giant_pluse),
                (eq,":type_enemies",tf_dragon),
            
                (assign,":impact_level",0),
            (else_try),
                (eq|this_or_next,":type_enemies",tf_undead_giant),
                (eq|this_or_next,":type_enemies",tf_woman_super),
                (eq,":type_enemies",tf_man_super),
            
            (gt,":impact_level",1),
                (val_sub,":impact_level",1),
            (try_end),
            ...
            (eq, reg1, 1),
            (agent_deliver_damage_to_agent, ":agent", ":enemies",0),
...
#玩家武技攻击
init_player_agent_martial_arts_strike = (
0,3,0,
[    
     (assign,":player_set_animation",0),
     (get_player_agent_no,":player_no"),
     (agent_is_alive,":player_no"),
     (agent_get_animation,":animation",":player_no",0),
     #特殊动作
     (neg|is_between,":animation","anim_twohanded","anim_martial_arts_end"),
     (neg|agent_slot_ge,":player_no",slot_agent_have_a_horse_of_agent,1),#非特殊坐骑
     ...
     (try_begin),#按键Z使用武技
         (key_is_down|this_or_next, key_z),
         (key_clicked, key_z),
         (try_begin), #弓箭武技
            (call_script, "script_cf_agent_use_blow",":player_no"),
            (assign,":val_use",15),
            (assign,":bow_anim","anim_ready_bow_arts_one"),
            (try_begin),
               (game_key_is_down, gk_defend),
               (assign,":val_use",45),
               (assign,":bow_anim","anim_ready_bow_arts_two"),
            (try_end),
            (call_script, "script_cf_player_use_g_magic_cnt",":val_use"),
            (agent_set_animation,":player_no",":bow_anim",":up_ani"),
            (assign,":player_set_animation",1),
            (agent_play_sound,":player_no","snd_magic_draw_bow"),
            (agent_set_slot,":player_no",slot_agent_is_martial_arts_bow,1),
         (else_try),
             #步伐剑技
             (assign,":cur_anim",-1),
             (assign,":cur_sound","snd_fire_strike_6"),
             (try_begin),
                (call_script, "script_cf_agent_get_right_wielded_item_no_range",":player_no"),
                (game_key_is_down, gk_attack),
                (call_script, "script_cf_player_use_g_magic_cnt",20),
                (assign,":cur_anim","anim_one_hand_attack_1"),
                (assign,":cur_sound","snd_fire_strike_8"),
             #(else_try),
                #(lt, ":horse_no", 0),#无马,
                #(call_script, "script_cf_agent_wielded_shield",":player_no"),
                #(game_key_is_down, gk_defend),
                #魔力消耗
                #(call_script, "script_cf_player_use_g_magic_cnt",10),
                #(assign,":cur_anim","anim_shield_plus_dash"),
                #(assign,":cur_sound","snd_fire_strike_6"),
             (else_try),
                (lt, ":horse_no", 0),#无马,
                (call_script, "script_cf_agent_get_right_wielded_item_no_range",":player_no"),
                (call_script, "script_cf_player_use_g_magic_cnt",10),
                (assign,":cur_anim","anim_defensive_spinning_slash"),
                (try_begin),
                    (game_key_is_down|this_or_next, gk_move_backward),
                    (game_key_clicked, gk_move_backward),
                    (assign,":cur_anim","anim_backward_spinning_slash"),
                (try_end),
                (assign,":cur_sound","snd_fire_strike_8"),
             (try_end),
          
             (gt,":cur_anim",-1),
             (agent_set_animation,":player_no",":cur_anim",":up_ani"),
             (agent_play_sound,":player_no",":cur_sound"),
             (assign,":player_set_animation",1),
         (try_end),
     (else_try),#按键E使用武技
         (key_is_down|this_or_next, key_e),
         (key_clicked, key_e),
         (try_begin), #跳技
            #(le, ":horse_no", -1),#无马,
            ...
            (try_begin),#盾牌跳技
                ...
                (game_key_is_down, gk_defend),
                #魔力消耗
                (call_script, "script_cf_player_use_g_magic_cnt",6),
                (assign,":cur_anim","anim_chao_ren_quan"),
                (agent_play_sound,":player_no","snd_fire_strike_6"),
            (else_try),#近战跳技
                (call_script, "script_cf_agent_get_right_wielded_item_no_range",":player_no"),
                (game_key_is_down, gk_attack),
                #魔力消耗
                (call_script, "script_cf_player_use_g_magic_cnt",10),
                (agent_play_sound,":player_no","snd_fire_strike_2"),
                # Possible values at attacking: invalid = -1, ranged/thrust = 0, right swing = 1, left swing = 2, overswing = 3.
                (agent_get_action_dir, ":action_dir_attacker", ":player_no"),
                (try_begin),
                    (eq,":action_dir_attacker",0),
                    (assign,":cur_anim","anim_jump_thrust"),
                (else_try),
                    (assign,":cur_anim","anim_tiaozhang"),
                (try_end),
                (agent_play_sound,":player_no","snd_fire_strike_2"),
            (else_try),
                (call_script, "script_cf_player_use_g_magic_cnt",6),
                (assign,":cur_anim","anim_roll_kick_forward"),
                (agent_play_sound,":player_no","snd_fire_kick"),    
            (try_end),   
            
            (gt,":cur_anim",-1),
            (agent_set_animation,":player_no",":cur_anim"),
            (assign,":player_set_animation",1),
            (try_begin),
                (gt, ":horse_no", -1),#马,
                (agent_start_running_away,":horse_no"), 
                (agent_stop_running_away,":horse_no"), 
            (try_end),
        ...
        (else_try),#盾牌武技
            ...
            (game_key_is_down, gk_defend),
            #魔力消耗
            (call_script, "script_cf_player_use_g_magic_cnt",3),
            (agent_set_animation,":player_no","anim_shield_bash",":up_ani"),
            (agent_play_sound,":player_no","snd_fire_strike_6"),
            (assign,":player_set_animation",1),
         (else_try),#近战武技
            (call_script, "script_cf_agent_get_right_wielded_item_no_range",":player_no"),
            (game_key_is_down, gk_attack),
            #魔力消耗
            (call_script, "script_cf_player_use_g_magic_cnt",5),
            # Possible values at attacking: invalid = -1, ranged/thrust = 0, right swing = 1, left swing = 2, overswing = 3.
            (agent_get_action_dir, ":action_dir_attacker", ":player_no"),
            (try_begin),
                (eq,":action_dir_attacker",0),
                (agent_set_animation,":player_no","anim_attacks_thrust_onehanded_y5x",":up_ani"),
                (agent_play_sound,":player_no","snd_fire_strike_4"),
            (else_try),
                (eq,":action_dir_attacker",1),
                (agent_set_animation,":player_no","anim_slashright_twohanded_y",":up_ani"),
                (agent_play_sound,":player_no","snd_fire_strike_5"),
            (else_try),
                (eq,":action_dir_attacker",2),
                (agent_set_animation,":player_no","anim_attacks_single_lefttoright_y",":up_ani"),
                (agent_play_sound,":player_no","snd_fire_strike_5"),
            (else_try),
                (agent_set_animation,":player_no","anim_attacks_twohanded_overswing_y",":up_ani"),
                (agent_play_sound,":player_no","snd_fire_strike_5"),
            (try_end),
            (assign,":player_set_animation",1),
         (else_try),
            ...
            (call_script, "script_cf_player_use_g_magic_cnt",5),
            (game_key_is_down, gk_defend),
            (agent_set_animation,":player_no","anim_ready_bow_arts",":up_ani"),
            (assign,":player_set_animation",1),
            (agent_play_sound,":player_no","snd_magic_draw_bow"),
            (agent_set_slot,":player_no",slot_agent_is_martial_arts_bow,3),
         (else_try),
            (le, ":horse_no", -1),#无马,
            #腿技
            #魔力消耗
            (call_script, "script_cf_player_use_g_magic_cnt",3),
            (init_position,pos44),
            (agent_get_speed, pos44, ":player_no"),
            (position_get_x,":speed_x",pos44),
            (try_begin),
                (ge,":speed_x",0),
                (agent_set_animation,":player_no","anim_kick_rightleg_y"),
            (else_try),
                (agent_set_animation,":player_no","anim_kick_leftleg_y"),
            (try_end),
    ...
    (eq,":player_set_animation",1),
    (display_message,"@player wait martial arts strike",color_code_blue),

      
],   
[
    (display_message,"@player martial arts strike is ok",color_code_blue),
])

#玩家翻滚
init_player_agent_roll_over = (
0,3,0,
[
     (assign,":player_set_animation",0),
     (get_player_agent_no,":player_no"),
     ...
     (key_is_down|this_or_next, key_caps_lock),
     (key_clicked|this_or_next, key_caps_lock),
     (key_is_down|this_or_next, key_left_control),
     (key_clicked, key_left_control),

     (try_begin),#前
        (game_key_is_down|this_or_next, gk_move_forward),
        (game_key_clicked, gk_move_forward),
        (agent_set_animation,":player_no","anim_fangun_forward"),
        (agent_play_sound, ":player_no","snd_fangun"),
        (assign,":player_set_animation",1),
    (try_end),
    ...
    (try_begin),#后    
        (game_key_is_down|this_or_next, gk_move_backward),
        (game_key_clicked, gk_move_backward),
        (agent_set_animation,":player_no","anim_fangun_backward"),
        (agent_play_sound, ":player_no","snd_fangun"),
        (assign,":player_set_animation",1), 
    (try_end),
    ...
    (try_begin),#左
        ...
        (agent_set_animation,":player_no","anim_fangun_left"),
        (play_sound, "snd_fangun"),
        (assign,":player_set_animation",1),
    (try_end),
    
    (try_begin),#右
        (game_key_is_down|this_or_next, gk_move_right),
        (game_key_clicked, gk_move_right),
        (agent_set_animation,":player_no","anim_fangun_right"),
        (play_sound, "snd_fangun"),
        (assign,":player_set_animation",1),
    (try_end),
    
    (eq,":player_set_animation",1),
    (display_message,"@player roll over wait 5s",color_code_blue),
    (reset_mission_timer_a),
], 
[  
    (display_message,"@player roll over is ok",color_code_blue),
    
])
init_weep_weapon_hit_check = (
0.1,0,0,
[
 (eq, "$g_strike_allowed", 1),  
],
[
 ...
 (try_for_agents,":agent"),
    ...
    (eq|this_or_next,":type",tf_undead_giant_pluse),
    (eq,":type",tf_dragon),
   ...
   (try_for_range,":index",0,":num"),#get target
        ...
        (try_begin),
            ...
            (eq|this_or_next,":type_enemies",tf_man_super),
            (eq|this_or_next,":type_enemies",tf_woman_super),
            (eq,":type_enemies",tf_undead_giant),
            (assign,":return",1),
        (try_end),
        ...
        (call_script,"script_cf_attack_agent_play_sound",":enemies",":value",":behind"),
   (try_end),
 (try_end),
...
init_the_key_y_skills = (
     #强击魔法 (0, 0, 3 _3秒检测一次，(key_clicked, key_y) ,即点击y键时触发，     
  0,0,1,[
  (key_clicked,key_y),
  ...
  (gt,":weapon_no",-1),
       ...
       [
        (try_begin),
          ...
          (display_message,"@key y skill is on"),
        (else_try),
          (assign,"$key_y_skill",0),
          (display_message,"@key y skill is off"),
       ]
)  


init_the_key_j_skills = (
     #复活尸体 人类治疗 (0, 0, 3 _3秒检测一次，(key_clicked, key_x) ,即点击r键时触发，     
  0,0,1,[(key_clicked,key_j)],
        [
        (try_begin),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
            (call_script,"script_player_magic_resurrect_the_corpse"),
        (else_try),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"),
            (call_script,"script_player_magic_sacred_healing"),
        (try_begin),
       ]
)


init_the_key_k_skills = (
     #复活亡灵 和 人类
  0,0,1,[(key_clicked,key_k)],
         [
        (try_begin),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
            (call_script,"script_player_magic_raise_the_undead"),
        (else_try),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"),
            (call_script,"script_player_magic_resurrect_friendly_troops"),
        (try_begin),
       ]
)


init_the_key_u_skills = ( 
  0,0,1,[(key_clicked,key_u)],
         [
        (try_begin),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
            (call_script,"script_player_magic_night_of_the_dead"),
        (else_try),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"),
            (call_script,"script_player_magic_divine_blessing"),
        (try_begin),
       ]
)


init_the_key_h_skills = (
  0,0,1,[(key_clicked,key_h)],
         [
        (try_begin),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
            (call_script,"script_player_magic_demon_is_possessed"),
        (else_try),
            (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"),
            (call_script,"script_player_magic_sacred_brave_is_possessed"),
        (try_begin),   
       ]
)
...
agent_buff_check = (
  ...
  (try_begin),
     (eq,"$key_y_skill",1),
     (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_undead"),
     (agent_get_bone_position,pos56,":player_agent",hb_item_r,1),
     (agent_get_wielded_item, ":weapon_no", ":player_agent", 0),
     (item_get_weapon_length, ":weapon_length", ":weapon_no"),
     (position_move_y, pos56, ":weapon_length"),
     (particle_system_burst,"psys_torch_fire_purple",pos56,10),
  (else_try),
     (eq,"$key_y_skill",1),
     (faction_slot_eq,"fac_player_supporters_faction",slot_faction_culture,"fac_culture_sept"),
     (agent_get_bone_position,pos56,":player_agent",hb_item_r,1),
     ...
     (item_get_weapon_length, ":weapon_length", ":weapon_no"),
     (position_move_y, pos56, ":weapon_length"),
     (particle_system_burst,"psys_torch_hot_light",pos56,10),
  (try_end),
  ...
  (try_for_agents,":agent_no"),
    ...
    (try_begin),
        (this_or_next|agent_slot_eq, ":agent_no", slot_agent_curse,1),
        (agent_slot_eq, ":agent_no", slot_agent_night_of_dead,1),
        (agent_get_bone_position, pos56, ":agent_no", hb_head, 1),#获得头部位置
        (position_move_y,pos56,50),
        (particle_system_burst,"psys_torch_fire_purple",pos56,5),
    (try_end),
    
    (try_begin),
        (agent_slot_eq, ":agent_no", slot_agent_blessing,1),
        (agent_get_bone_position, pos56, ":agent_no", hb_head, 1),#获得头部位置
        (position_move_y,pos56,50),
        (particle_system_burst,"psys_torch_hot_light",pos56,5),
    (try_end),
...
time_task_1s = (
  ...
  (val_add,"$g_player_e_magic",1),
  (val_clamp,"$g_player_e_magic",0,180),
  (val_add,"$g_player_j_magic",1),
  (val_clamp,"$g_player_j_magic",0,180),
  (val_add,"$g_player_k_magic",1),
  (val_clamp,"$g_player_k_magic",0,180),
  (val_add,"$g_player_y_magic",1),
  (val_clamp,"$g_player_y_magic",0,180),
  (val_add,"$g_player_u_magic",1),
  (val_clamp,"$g_player_u_magic",0,180),
  (val_add,"$g_player_h_magic",1),
  (val_clamp,"$g_player_h_magic",0,180),
  (val_add,"$g_player_o_magic",1),
  (val_clamp,"$g_player_o_magic",0,180),
  ...
  (set_fixed_point_multiplier,1000),#cm
     ...
     (try_for_agents, ":agent_no"),
         ...
         (agent_is_human, ":agent_no"),  ##是人
         (agent_is_alive, ":agent_no"),  ##存活的
         #(neg|troop_is_hero,":troop_id"), #troop_id不是英雄
         (neg|agent_is_wounded,":agent_no"),##非击晕的
         (neg|agent_is_routed,":agent_no"),##非逃跑的
         (agent_get_team,":agent_team",":agent_no"),
         (agent_get_division, ":agent_division", ":agent_no"),
         (team_get_movement_order, ":movement_order", ":agent_team", ":agent_division"),
         ...
         (try_begin),
           (agent_slot_ge,":agent_no",slot_agent_magic_wait_cnt,1),
           (agent_get_slot, ":wait_cnt", ":agent_no", slot_agent_magic_wait_cnt),
           (val_sub,":wait_cnt",1),
           (agent_set_slot,":agent_no",slot_agent_magic_wait_cnt, ":wait_cnt"),
         (try_end),  
         
         (try_begin),
            (eq,":troop_id","trp_angel_a"),
            (agent_slot_ge,":agent_no",slot_agent_magic_value,1),
            (agent_slot_eq,":agent_no",slot_agent_magic_wait_cnt,0),
            (agent_get_slot, ":magic_value", ":agent_no", slot_agent_magic_value),
            (assign,":level_limit",40),
            (try_begin),
                (gt,":level_limit",":magic_value"),
                (assign,":level_limit",":magic_value"),
            (try_end),
            (call_script,"script_agent_judge_surround_agent_is_dead_and_ally_undead",":agent_no",3000,":level_limit"),
            (gt,reg10,0),
            (gt,reg11,0),
            (agent_get_troop_id,":troop_id_one",reg11),
            ###########开始复活################
            (agent_set_animation, ":agent_no", "anim_cheer",1),
            (agent_play_sound,":agent_no","snd_resurrection_magic_undead"),  
            (call_script,"script_agent_resurrection_agent_is_ally_and_undead",":agent_no",reg11),
            
            (store_character_level,":level",":troop_id_one"),
            (store_div,":uint",":level",5), 
            (val_sub,":magic_value",":uint"),
            (agent_set_slot, ":agent_no", slot_agent_magic_value, ":magic_value"),
            
            (agent_get_slot, ":wait_time", ":agent_no", slot_agent_magic_wait_time),
            (agent_set_slot,":agent_no",slot_agent_magic_wait_cnt,":wait_time"),
         (else_try),
           (eq,":troop_id","trp_angel_b"),
            (agent_slot_ge,":agent_no",slot_agent_magic_value,1),
            (agent_slot_eq,":agent_no",slot_agent_magic_wait_cnt,0),
            (agent_get_slot, ":magic_value", ":agent_no", slot_agent_magic_value),
            (assign,":level_limit",40),
            (try_begin),
                ...
                (assign,":level_limit",":magic_value"),
            (try_end),
            (call_script,"script_agent_judge_surround_agent_is_dead_and_ally_live",":agent_no",3000,":level_limit"),
            (gt,reg10,0),
            (gt,reg11,0),
            (agent_get_troop_id,":troop_id_one",reg11),
            ###########开始复活################
            (agent_set_animation, ":agent_no", "anim_cheer",1),
            (agent_play_sound,":agent_no","snd_resurrection_magic_live"),  
            (call_script,"script_agent_resurrection_agent_is_ally_and_live",":agent_no",reg11),
            ...
            (agent_set_slot,":agent_no",slot_agent_magic_wait_cnt,":wait_time"),
         (else_try),
            (is_between,":troop_id","trp_necromancer_noob","trp_sept_follower"),
            (agent_slot_ge,":agent_no",slot_agent_magic_value,1),
            (agent_slot_eq,":agent_no",slot_agent_magic_wait_cnt,0),
            (agent_get_slot, ":magic_value", ":agent_no", slot_agent_magic_value),
            (assign,":level_limit",40),
            (try_begin),
                ...
                (assign,":level_limit",":magic_value"),
            (try_end),
            (call_script,"script_agent_judge_surround_agent_is_deade",":agent_no",3000,":level_limit"),
            (gt,reg10,0),
            (gt,reg11,0),
            (agent_get_troop_id,":troop_id_one",reg11),
             ...
             ###########开始使用尸体################
            (agent_set_animation, ":agent_no", "anim_cheer",1),
            (agent_play_sound,":agent_no","snd_undead_magic"),  
            (call_script,"script_agent_resurrection_agent_is_corpse",":agent_no",reg11),
        ...
        (try_begin),
            ...
            (store_agent_hit_points,":cur_hp_1",":agent_no",1),
            (val_sub,":cur_hp",":harm"),
            ...
            (try_begin),
                (le,":cur_hp_1",":harm"),
                (agent_deliver_damage_to_agent, ":agent_no", ":agent_no",100000,0),
                (str_store_agent_name,s20,":agent_no"),
                
                (assign,":color_code",color_code_good),
                (try_begin),
                    (agent_is_ally,":agent_no"),
                    (assign,":color_code",color_code_bad),
                (try_end),
                (display_message,"@agent {s20} dead is be fuel harm",":color_code"),
            (try_end),
    ...
    #场景道具隐身
    (try_for_prop_instances, ":sprop_instance","spr_war_machinery_huopao_gear"),
        ...
        (prop_instance_get_position,pos50,":sprop_instance"), 
        (position_set_z_to_ground_level,pos50),
        (position_move_z,pos50,-10000),
        (try_begin),
            (le,":ctrl_agent",0),
            (scene_prop_set_visibility, ":sprop_instance", 0),#隐身处理
            (prop_instance_set_position, ":sprop_instance", pos50),
            #(scene_prop_fade_out, ":sprop_instance", 100),
        (else_try),
            (neg|agent_is_alive, ":ctrl_agent"),
            (scene_prop_set_visibility, ":sprop_instance", 0),#隐身处理
            (prop_instance_set_position, ":sprop_instance", pos50),
            #(scene_prop_fade_out, ":sprop_instance", 100),
        (else_try),
            (agent_is_wounded, ":ctrl_agent"),   
            (scene_prop_set_visibility, ":sprop_instance", 0),#隐身处理
            (prop_instance_set_position, ":sprop_instance", pos50),
            #(scene_prop_fade_out, ":sprop_instance", 100),
        (else_try),
            (agent_is_routed, ":ctrl_agent"),
            (scene_prop_set_visibility, ":sprop_instance", 0),#隐身处理
            (prop_instance_set_position, ":sprop_instance", pos50),
            #(scene_prop_fade_out, ":sprop_instance", 100),
        (try_end),   
...
time_task_01s = (
  ...
  (try_for_agents,":cur_agents"),
      (agent_is_alive,":cur_agents"),
      (agent_is_human,":cur_agents"),
      (agent_get_troop_id,":troop_id",":cur_agents"),
      (eq,":troop_id","trp_undead_dragon"),
      #(neg|agent_slot_ge,":cur_agents",slot_agent_fly,1),
      (agent_get_slot, ":magic_value",":cur_agents", slot_agent_magic_value),
      (gt,":magic_value",0),
      (agent_ai_get_look_target,":target_agent",":cur_agents"),
      (gt,":target_agent",-1),
      (agent_is_alive,":target_agent"),
      (agent_is_human,":target_agent"),
      (init_position,pos34),
      (agent_get_position, pos34, ":target_agent"),
      (init_position,pos35),
      (agent_get_position, pos35, ":cur_agents"),
      (position_is_behind_position,pos35,pos34),
      (get_distance_between_positions,":distance",pos34,pos35),
      (le,":distance",2000),
      (init_position,pos36),
      (agent_get_look_position, pos36, ":cur_agents"),
      (position_move_z,pos35,200),
      (position_copy_rotation,pos35,pos36),
      (agent_is_in_line_of_sight,":target_agent",pos35),
      (add_missile,":cur_agents",pos35,30000,"itm_undead_dragon_staff",0,"itm_magic_undead_dragon",0),
      (val_sub,":magic_value",1),
      (agent_set_slot,":cur_agents",slot_agent_magic_value, ":magic_value"),
  (try_end),
  ...
  (try_for_agents, ":agent_no"),
         (agent_get_troop_id,":troop_id",":agent_no"),
         (eq|this_or_next,":troop_id","trp_darkness_valkyries"),
         (eq,":troop_id","trp_nord_valkyries"),
         (agent_is_human, ":agent_no"),  ##是人
         (agent_is_alive, ":agent_no"),  ##存活的
         (neg|agent_is_wounded,":agent_no"),##非击晕的
         ...
         (try_end),  
          ...
          #计算武技时间和翻滚时间
         (try_begin),
            (agent_slot_ge,":agent_no",slot_agent_roll_wait_cnt,1),
            (agent_get_slot, ":roll_wait_cnt", ":agent_no", slot_agent_roll_wait_cnt),
            (val_sub,":roll_wait_cnt",1),
            (agent_set_slot,":agent_no",slot_agent_roll_wait_cnt, ":roll_wait_cnt"),
         (try_end),  

         (agent_get_team,":agent_team",":agent_no"),
         (agent_get_division, ":agent_division", ":agent_no"),
         (team_get_movement_order, ":movement_order", ":agent_team", ":agent_division"),
         (call_script,"script_cf_agent_get_right_wielded_item_no_range",":agent_no"),
         (neg|agent_slot_ge,":agent_no",slot_agent_have_a_horse_of_agent,1),#非特殊坐骑
         (agent_get_animation,":animation",":agent_no",0),
         (neg|is_between,":animation","anim_twohanded","anim_martial_arts_end"),
         (agent_ai_get_move_target,":target_agent",":agent_no"),
         (try_begin),
            (lt,":target_agent",1),
         ...
         (try_begin),
            ...
            (agent_is_alive,":target_agent"),
            (agent_is_human,":target_agent"),
            (neg|agent_is_routed,":target_agent"),##非逃跑的
            (call_script,"script_get_the_direct_distance_between_two_agents",":agent_no",":target_agent"),
            (assign,":distance",reg60),
         (try_end),
         ...
         (try_begin),
            (gt, ":horse_no", 0),#马,
            (assign,":up_ani",1),
            (val_sub,":distance",100),
         (try_end),
         
         ##使用翻滚
         (try_begin),##翻滚躲避武技
            (lt, ":horse_no", 0),#无马
            (neg|agent_slot_ge,":agent_no",slot_agent_roll_wait_cnt,1),
            (call_script,"script_cf_agent_whether_be_has_been_locked_by_martial_arts",":agent_no",200,1),
            (position_get_x,":get_x",pos61),
            (try_begin),
               (ge,":get_x",0),
               (agent_set_animation,":agent_no","anim_fangun_right"),
            (else_try),
               (lt,":get_x",0),
               (agent_set_animation,":agent_no","anim_fangun_left"),
            (else_try),
               (lt,":get_x",0),
               (agent_set_animation,":agent_no","anim_fangun_backward"),
            (try_end),
             
            (agent_play_sound,":agent_no", "snd_fangun"),
            (agent_get_slot,":roll_wait_cnt",":agent_no",slot_agent_roll_wait_time),
            (agent_set_slot,":agent_no",slot_agent_roll_wait_cnt,":roll_wait_cnt"),
         (else_try),##翻滚
            (lt, ":horse_no", 0),#无马
            (neg|agent_slot_ge,":agent_no",slot_agent_roll_wait_cnt,1),
            ...
            (eq,":attack_action",0),
            (init_position,pos5),
            (agent_get_speed,pos5,":agent_no"),
            (position_get_y,":speed_y",pos5),
            (position_get_x,":speed_x",pos5),
            (neq|this_or_next,":speed_y",0),
            (neq,":speed_x",0),
            
            (assign,":select_roll",0),
            (try_begin),
                (ge,":distance",200),
                (gt,":speed_y",0),
                (assign,":select_roll",1),
            (else_try),
                (lt,":speed_y",0),
                (le,":distance",100),
                (assign,":select_roll",2),
            (else_try),
                (gt,":speed_x",0),
                (assign,":select_roll",3),
            (else_try),
                (lt,":speed_x",0),
                (assign,":select_roll",4),
            (try_end),
            ...
            (else_try),
                ...
                (agent_set_animation,":agent_no","anim_fangun_left"),
            (else_try),
                (agent_set_animation,":agent_no","anim_fangun_forward"),
            (try_end),
         ...
         (else_try),
            (ge,":target_agent",1),
            (agent_slot_eq, ":target_agent", slot_agent_is_running_away, 0),#非逃跑
            (call_script,"script_cf_agent_whether_the_target_unit_has_been_locked_by_martial_arts",":target_agent",0),
            (call_script,"script_cf_target_agent_behind_agent",":agent_no",":target_agent",0),
            #(call_script,"script_cf_target_agent_be_looked_agent",":agent_no",":target_agent",1),
            #(call_script,"script_cf_agent_be_strike_down",":target_agent"),
            (le,":distance",300),
            ##先判断agent的情况
            (neg|eq,":movement_order",mordr_retreat),
            (neg|agent_is_routed,":agent_no"),##非逃跑的
            ##使用武技
            (neg|agent_slot_ge,":agent_no",slot_agent_magic_wait_cnt,1),
            (agent_get_slot, ":magic_value", ":agent_no", slot_agent_magic_value),
            (agent_get_slot, ":magic_wait_time", ":agent_no", slot_agent_magic_wait_time),
            (gt,":magic_value",0),
            (assign,":magic_consume",0),
            (assign,":wait_cnt",0),
            (call_script,"script_cf_agent_go_forward_be_hindered_from_other_friend_agent",":agent_no",0),
            
            (init_position,pos30),
            (agent_get_speed, pos30, ":agent_no"),
            (position_get_y,":y_speed",pos30),
            
            (assign,":anim_select",-1),
            ...
            (try_begin),#前进的时候
                ...
                (try_begin),
                    ...
                    (try_begin),
                        (eq,":attack_action",1),
                        (assign,":magic_consume",5),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",0),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (else_try),
                        (eq|this_or_next,":defend_action",1),
                        (eq,":defend_action",2),
                        (call_script, "script_cf_agent_wielded_shield",":agent_no"),
                        (assign,":magic_consume",3),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",1),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (try_end),
                (else_try),
                    ...
                    (eq,":attack_action",1),
                    (try_begin),
                        (assign,":magic_consume",20),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",5),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (else_try),
                        (lt, ":horse_no", 0),#无马
                        (assign,":magic_consume",10),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",4),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (try_end),
                (else_try),
                    (lt, ":horse_no", 0),#无马
                    ...
                    (try_begin),
                        ...
                        (assign,":magic_consume",10),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",2),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (else_try),
                        (eq|this_or_next,":defend_action",1),
                        (eq,":defend_action",2),
                        (assign,":magic_consume",6),
                        (ge,":magic_value",":magic_consume"),
                        (assign,":anim_select",3),
                        (assign,":wait_cnt",":magic_wait_time"),
                    (try_end),
                (try_end),
            (else_try),#后退的时候
            ...
            (ge,":anim_select",0),
            (agent_set_slot,":agent_no",slot_agent_magic_wait_cnt,":wait_cnt"),
            (val_sub,":magic_value",":magic_consume"),
            (agent_set_slot,":agent_no",slot_agent_magic_value,":magic_value"),
            #设定目标target_agent被瞄武技锁定 直接保存target_agent 的ID
            (agent_set_slot,":target_agent",slot_locked_in_a_martial_arts_lock,":agent_no"),
            
            (try_begin),
                (eq,":anim_select",1),#盾牌武技
                (agent_set_animation,":agent_no","anim_shield_bash",":up_ani"),
                (agent_play_sound,":agent_no","snd_fire_strike_6"),
            (else_try),
                (eq,":anim_select",2),#跳近战武技
                (agent_get_action_dir, ":action_dir_attacker", ":agent_no"),
                (try_begin),
                    (eq,":action_dir_attacker",0),
                    (assign,":cur_anim","anim_jump_thrust"),
                (else_try),
                    (assign,":cur_anim","anim_tiaozhang"),
                (try_end),
                (agent_set_animation,":agent_no",":cur_anim"),
                (agent_play_sound,":agent_no","snd_fire_strike_2"),
            (else_try),
                (eq,":anim_select",3),#跳盾牌武技
                (agent_set_animation,":agent_no","anim_chao_ren_quan"),
                (agent_play_sound,":agent_no","snd_fire_strike_6"),
            (else_try),
                (eq,":anim_select",4),#转身砍前
                (agent_set_animation,":agent_no","anim_defensive_spinning_slash"),
                (agent_play_sound,":agent_no","snd_fire_strike_8"),
            (else_try),
                (eq,":anim_select",5),#横扫千军
                (agent_set_animation,":agent_no","anim_one_hand_attack_1",":up_ani"),
                (agent_play_sound,":agent_no","snd_fire_strike_8"),
            (else_try),
                (eq,":anim_select",6),##转身砍后
                (agent_set_animation,":agent_no","anim_backward_spinning_slash"),
                (agent_play_sound,":agent_no","snd_fire_strike_8"),
            (else_try),#近战武技
                 # Possible values at attacking: invalid = -1, ranged/thrust = 0, right swing = 1, left swing = 2, overswing = 3.
                (agent_get_action_dir, ":action_dir_attacker", ":agent_no"),
                (try_begin),
                    (eq,":action_dir_attacker",0),
                    (agent_set_animation,":agent_no","anim_attacks_thrust_onehanded_y5x",":up_ani"),
                    (agent_play_sound,":agent_no","snd_fire_strike_4"),
                (else_try),
                    (eq,":action_dir_attacker",1),
                    (agent_set_animation,":agent_no","anim_slashright_twohanded_y",":up_ani"),
                    (agent_play_sound,":agent_no","snd_fire_strike_5"),
                (else_try),
                    (eq,":action_dir_attacker",2),
                    (agent_set_animation,":agent_no","anim_attacks_single_lefttoright_y",":up_ani"),
                    (agent_play_sound,":agent_no","snd_fire_strike_5"),
                (else_try),
                    (agent_set_animation,":agent_no","anim_attacks_twohanded_overswing_y",":up_ani"),
                    (agent_play_sound,":agent_no","snd_fire_strike_5"),
                (try_end),
            (try_end),
        (try_end),
    ...
    #清除agent被武技锁定 slot_locked_in_a_martial_arts_lock
    (try_for_agents, ":agent_no"),
         (agent_is_human, ":agent_no"),  ##是人
         (agent_is_alive, ":agent_no"),  ##存活的
         (neg|agent_is_wounded,":agent_no"),##非击晕的
         (agent_slot_ge,":agent_no",slot_locked_in_a_martial_arts_lock,1),
         (agent_set_slot,":agent_no",slot_locked_in_a_martial_arts_lock,0),
    (try_end),
...
handling_a_horse_without_a_rider = (
  30,0,0,
  [],
  [ 
     
    (display_message,"@handling a horse without a rider"),
    (get_player_agent_no, ":player_agent"),
    (agent_get_horse, ":horse", ":player_agent"),
    (try_begin),
        (gt,":horse",0),
        (agent_set_slot,":horse",slot_agent_is_horse_belong_player_agent,1),
    (try_end),
    
    (init_position,pos6),
    (agent_get_position, pos6, ":player_agent"),  
    (try_for_agents,":agent_horse"),
        (agent_is_alive,":agent_horse"),
        (neg|agent_is_human,":agent_horse"),
        (neg|agent_slot_eq,":agent_horse",slot_agent_is_horse_belong_player_agent,1),
        (agent_get_rider,":rider_agent_no",":agent_horse"),
        (lt,":rider_agent_no",0),
        (neg|agent_is_in_line_of_sight,":agent_horse",pos6),
...
#-----------------------------------------------------------------
  ...
  (
   ...
   [
     ...
     (call_script,"script_cf_user_defined_on_agent_killed_or_wounded",":dead_agent_no",":killer_agent_no",":is_wounded"),
   ]),
  ...
  (
    ...
    (0, 0, 0, [],
      ...
      init_the_key_t_one,
      common_siege_weapon,
      common_agent_use_siege_weapon,
      common_agent_rider_lead_charge_ai,
      common_agent_be_moved_by_player_agent,
      init_the_key_o,
      init_the_key_n,
      common_player_agent_have_a_horse_of_agent,
      common_agent_have_a_horse_of_agent,
      common_player_fly,
      common_player_fly_horse_of_agent,
      common_agent_flying_ai,
      init_player_agent_roll_over,
      init_player_agent_martial_arts_strike,
      init_player_agent_round_kick,
      check_agent_round_kick,
    ...
    [
      ...
      (ti_on_agent_killed_or_wounded, 0, 0, [],
       [
        ...
        (call_script,"script_                         ",":dead_agent_no",":killer_agent_no",":is_wounded"),
...
#INVASION MODE END
  ...
  (
    "test_lead_charge",mtf_battle_mode|mtf_synch_inventory,charge,
    "You lead your men to battle.",
    [
 ...
 (
    "duel_with_anyone",mtf_arena_fight|mtf_commit_casualties,-1,
    "You enter a melee fight in the arena.",
    [    
	  (0, mtef_visitor_source|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
	  (16, mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),
  ...
  (
    "crime_caught_fight",mtf_battle_mode,-1,
    "You must fight your way out!",
    [
   ...
   (
    "player_becaome_bandits_at_night",mtf_battle_mode|mtf_synch_inventory,charge,
    "Default town visit",
    [
     (0,mtef_team_0|mtef_use_exact_number,af_override_horse, aif_start_alarmed, 1,[]),
     (11,mtef_visitor_source|mtef_team_1,af_override_horse, aif_start_alarmed,1,[]),
    ...
    [
      ...
      (1, 4, ti_once,
       ...
       [
         (try_begin),
           (main_hero_fallen),
           (jump_to_menu, "mnu_town_player_become_bandits_failed"),
         (else_try),
           (jump_to_menu, "mnu_town_player_become_bandits_succeeded"),
         (try_end),
         (finish_mission),
         ]),
      ],
...
#-----------------------------------------------------------------
  ...
  (
    "lair_bandits_center",0,-1,
    "Default town visit",
    [
     (0,mtef_team_0|mtef_use_exact_number,af_override_weapons, 0, 1,[]),
     (1,mtef_visitor_source|mtef_team_0,af_override_horse, 0,1,[]),
     (2,mtef_visitor_source|mtef_team_0,af_override_horse, 0,1,[]),
     (3,mtef_visitor_source|mtef_team_0,af_override_horse, 0,1,[]),
     (4,mtef_visitor_source|mtef_team_0,af_override_horse, 0,1,[]),
    ...
    [
     ...
     (
    "back_alley_kill_local_merchant_1",mtf_battle_mode,-1,
    "You enter the back alley",
    [
      (0,mtef_visitor_source|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
    ...
    [
      ...
      (0, 0, ti_once, [
          ...
          (try_for_agents, ":agent_no"),
            (agent_get_troop_id, ":troop_id", ":agent_no"),
            (try_begin),
              (eq, ":troop_id", "trp_rich_local_merchant"),
              (store_agent_hit_points, ":merchant_hp", ":agent_no"),
              (assign, ":merchant_agent", ":agent_no"),
            (else_try),
              (eq, ":troop_id", "trp_player"),
          ...
          (is_between, ":merchant_hp", 1, 30),
          (gt, ":player_hp", 50),
          (start_mission_conversation, "trp_rich_local_merchant"),
          ], []),
      
      (1, 4, ti_once, [(assign, ":not_alive", 0),
                       (try_begin),
                         (call_script, "script_cf_troop_agent_is_alive", "trp_rich_local_merchant"),
                       (else_try),
                         (assign, ":not_alive", 1),
                       (try_end),
                       (this_or_next|main_hero_fallen),
       ...
       [
           (try_begin),
             (main_hero_fallen),
             (call_script, "script_fail_quest", "qst_kill_local_merchant_1"),
             (quest_set_slot, "qst_kill_local_merchant_1", slot_quest_current_state, 1),
           ...
           (else_try),
             ...
             (call_script, "script_succeed_quest", "qst_kill_local_merchant_1"),
            (quest_set_slot, "qst_kill_local_merchant_1", slot_quest_current_state, 2),
           (try_end),
           (finish_mission),
           ]),
    ],
