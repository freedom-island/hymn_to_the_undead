...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "Welcome, adventurer, to Mount and Blade: Legend of adventure. Before beginning the game you must create your character. Remember that in the traditional medieval society depicted in the game, war and politics are usually dominated by male members of the nobility. That does not however mean that you should not choose to play a female character, or one who is not of noble birth. Male nobles may have a somewhat easier start, but women and commoners can attain all of the same goals -- and in fact may have a much more interesting if more challenging early game.",
    "none",
    [
    
    (assign,"$my_debug",0),
    (assign,"$game_mod",0),
    (assign,"$sacrifice_act_ok",0),
    (assign,"$g_magic_cnt",0),
    (assign,"$g_mount_magic_cnt",0),
    (assign,"$g_necromancer_act_cnt",0),
    (assign, "$cheat_mode", 0),
    (assign,"$g_missionary_work",1),
    (assign,"$g_test_tank",0),
    
    

    (assign, "$g_NPC_clash_stop",1),
    (assign, "$g_mounted_shooting_AI", 1),  
    (assign, "$g_cavalry_returns_to_charge_AI", 1),  
    (assign, "$g_allow_flight_with_flying_AI", 1),  
    (assign, "$g_strike_allowed", 1),  
    (assign, "$g_agent_avoidance_AI", 1),  
    ...
    [
     ...
     (eq,"$my_debug",1),
       ...
       [
        ...
        #(assign, "$cheat_mode", 1),
        (call_script,"script_change_player_relation_with_faction","fac_heresy_missionary",100), 
        (call_script,"script_change_player_relation_with_faction","fac_forest_bandits",100), 
        (call_script,"script_change_player_relation_with_faction","fac_mountain_bandits",100), 
        (call_script,"script_change_player_relation_with_faction","fac_desert_bandit",100), 
        (call_script,"script_change_player_relation_with_faction","fac_taiga_bandit",100), 
        (call_script,"script_change_player_relation_with_faction","fac_steppe_bandit",100), 
        (call_script,"script_change_player_relation_with_faction","fac_sea_raider",100), 
        (call_script,"script_change_player_relation_with_faction","fac_living_dead",100),
        ...
        (assign,"$g_magic_cnt",1000),
        (assign,"$g_mount_magic_cnt",1000),
        (assign,"$g_necromancer_act_cnt",100000),
        ...
        (troop_raise_attribute, "trp_player",ca_intelligence,40),
        (troop_raise_attribute, "trp_player",ca_charisma,100),
        (troop_raise_skill, "trp_player",skl_surgery,10),
        (troop_raise_skill, "trp_player",skl_power_magic,10),
        ...
        #(troop_add_item, "trp_player","itm_plague_sword_gun"),
        #(troop_add_item, "trp_player","itm_critical_strike_medieval"),
        #(troop_add_item, "trp_player","itm_tab_shield_heresy_a"),
        (troop_add_item, "trp_player","itm_plate_horse_2"),
        (troop_add_item, "trp_player","itm_steel_gauntlets"),
        #(troop_add_items, "trp_player","itm_bread",10),
        #(troop_add_item, "trp_player","itm_dark_plate_helmet"),
        #(troop_add_item, "trp_player","itm_dark_steal_plate"),
        #(troop_add_item, "trp_player","itm_gauntlets"),
        (troop_add_item, "trp_player","itm_magic_step"),
         (troop_add_item, "trp_player","itm_magic_undead"),
        (troop_add_item, "trp_player","itm_sept_magic_expert_staff"),
        (troop_add_item, "trp_player","itm_sept_women_plate_boots"),
        (troop_add_item, "trp_player","itm_sept_women_plate"),
        (troop_add_item, "trp_player","itm_beauty_amulet_f"),
        
        (troop_add_item, "trp_player","itm_griffin"),
        (troop_add_item, "trp_player","itm_war_bow"),
        (troop_add_item, "trp_player","itm_fuel_arrows"),
        (troop_add_item, "trp_player","itm_sniper_crossbow"),
        (troop_add_item, "trp_player","itm_fuel_bolts"),
        (troop_add_item, "trp_player","itm_golden_dragon"),
        
        (troop_set_slot, "trp_player", slot_troop_renown,200),
        (call_script, "script_change_player_honor", 40),
        (call_script, "script_troop_add_gold","trp_player",500000),
        
        (party_add_members, "p_main_party", "trp_sarranid_gunner_master", 3),
        #(party_add_members, "p_main_party", "trp_sept_sergeant_pluse_a", 30),
        #(party_add_members, "p_main_party", "trp_sept_sharpshooter_pluse", 30),
        #(party_add_members, "p_main_party", "trp_undead_ogre", 5),
         #(party_add_members, "p_main_party", "trp_undead_ogre_pluse", 200),
        #(party_add_members, "p_main_party", "trp_dark_sorceress", 5),
         #(party_add_members, "p_main_party", "trp_rhodok_sergeant", 20),
         #(party_add_members, "p_main_party", "trp_undead_horse", 10),
        
        #(party_add_prisoners, "p_main_party", "trp_undead_guard_c", 5),
        #(party_add_prisoners, "p_main_party", "trp_skeleton_horse", 5),
         #(party_add_prisoners, "p_main_party", "trp_sept_knight", 5),
         #(party_add_prisoners, "p_main_party", "trp_sept_god_officer_pluse", 5),
         #(party_add_prisoners, "p_main_party", "trp_swadian_sergeant", 5),
         #(party_add_prisoners, "p_main_party", "trp_swadian_man_at_arms", 5),
         #(party_add_prisoners, "p_main_party","trp_vaegir_marksman_pluse", 5),
         #(party_add_prisoners, "p_main_party","trp_swadian_recruit", 30),
        
        #(party_add_prisoners, "p_main_party", "trp_undead_guard", 20),
       #(party_add_members, "p_main_party", "trp_sept_friar", 10),
       #(party_add_members, "p_main_party", "trp_sept_deacon", 10),
       #(party_add_members, "p_main_party", "trp_sept_priest", 10),
       #(party_add_members, "p_main_party", "trp_sept_god_officer", 10),
       #(party_add_members, "p_main_party", "trp_sept_god_officer_pluse", 10),
       
       #(assign,":player_faction_culture","fac_culture_sept"),
       ...
       (assign,":player_faction_culture","fac_culture_undead"),
     ...
     ("undead_game_mod",[],"Undead  mod...",
       [
             (assign,"$game_mod",1),
             (assign,"$sacrifice_act_ok",1),
             (assign,"$g_necromancer_act_cnt",0),
             (jump_to_menu, "mnu_start_undead_1"),
            
       ]
     ),
     
    ("sept_game_mod",
    [    (eq,"$my_debug",1),],"sept  mod...",
       [
            (assign,"$game_mod",2),
            #(assign,"$sacrifice_act_ok",1),
            #(assign,"$g_necromancer_act_cnt",0),
     ...
     ("bandit_game_mod",[
      (eq,"$my_debug",1),],"Undead  mod...",
       [
             (assign,"$game_mod",2),
             (jump_to_menu, "mnu_start_bandit_1"),      
       ]
     ),
     
     ("civilian_game_mod",[],"Civilian mod...",
...
#NPC companion changes end
  ...
  ("start_undead_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
      ("start_male",[],"Male",
       [
         ...
         (jump_to_menu,"mnu_start_undead_2"),
        ]
       ),
  ...
  ("start_bandit_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "Select your character's gender.",
    "none",
    [],
    [
      ("start_male",[],"Male",
       [
         (troop_set_type,"trp_player", 0),
         (assign,"$character_gender",tf_male),
         (jump_to_menu,"mnu_start_bandit_2"),
        ]
       ),
   ...
   ("start_undead_2",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "You grew up in a cult of undead cults formed by undead mages, and now you are sent to Kaladia to preach the teachings of the undead cults while you are being chosen by the undead cults. However, the undead and evil gods were regarded by the people of the Kaladiya continent as heretics. At the beginning you will have a hard time on this continent, but the bandits may be objects of cooperation",
    "none",
    [],
    [
       ("son_of_the_undead_god",[],"Son of the undead god mod ...",
        [
           (assign,"$character_undead",4),
           (jump_to_menu, "mnu_start_undead_3"),
        ]
        ),
        

       ("undead_royal_mod",[],"Undead royal mod ...",
        [
           (assign,"$character_undead",0),
           (jump_to_menu, "mnu_start_undead_3"),
        ]
        ),
        
        ("undead_bishop_mod",[],"Undead bishop mod ...",
        [
           (assign,"$character_undead",1),
           (jump_to_menu, "mnu_start_undead_3"),
        ]
        ),
        
        ("undead_missionary_mod",[],"Undead missionary mod ...",
        [
           (assign,"$character_undead",2),
           (jump_to_menu, "mnu_start_undead_3"),
        ]
        ),
        
        ("undead_believer_mod",[],"Undead believer mod ...",
        [
           (assign,"$character_undead",3),
           (jump_to_menu, "mnu_start_undead_3"),
        ]
        ),
  ...
  ("start_bandit_2",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "You grew up with the galadian gangsters, and you'll start out as one. Please choose your body parts.",
    "none",
    [],
    [

       ("sea_raider_mod",[],"Sea raider mod ...",
        [
           (assign,"$character_bandit",0),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
        
        ("steppe_bandit_mod",[],"Steppe bandit mod ...",
        [
           (assign,"$character_bandit",1),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
        
        ("taiga_bandit_mod",[],"Taiga bandit mod ...",
        [
           (assign,"$character_bandit",2),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
        
        ("forest_bandit_mod",[],"Forest bandit mod ...",
        [
           (assign,"$character_bandit",3),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
        
        ("mountain_bandit_mod",[],"Mountain bandit mod ...",
        [
           (assign,"$character_bandit",4),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
        
        ("desert_bandit_mod",[],"Desert bandit mod ...",
        [
           (assign,"$character_bandit",5),
           (jump_to_menu, "mnu_start_bandit_3"),
        ]
        ),
  ...
  ("start_bandit_3",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "Now you're starting your bandit life",
    "none",
    [],
    [
       ("continue",[],"Continue ...",
        [
           ...
           (try_begin),
                ...
                (troop_add_item, "trp_player","itm_byrnie"),
                (troop_add_item, "trp_player","itm_nordic_helmet"),
                (troop_add_item, "trp_player","itm_throwing_axes"),
                (troop_add_item, "trp_player","itm_sword_viking_1"),
                (troop_add_item, "trp_player","itm_leather_boots"),
                (troop_add_item, "trp_player","itm_nordic_shield"),
                (troop_add_item, "trp_player","itm_spear"),
           ...
           (else_try),
                ...
                (troop_raise_proficiency, "trp_player",wpt_archery,70),
                
                (troop_add_item, "trp_player","itm_khergit_armor"),
                (troop_add_item, "trp_player","itm_steppe_cap"),
                (troop_add_item, "trp_player","itm_javelin"),
                (troop_add_item, "trp_player","itm_sword_khergit_1"),
                (troop_add_item, "trp_player","itm_nomad_boots"),
                (troop_add_item, "trp_player","itm_hunting_bow"),
                (troop_add_item, "trp_player","itm_arrows"),
                (troop_add_item, "trp_player","itm_steppe_horse"),
                
                (troop_add_item, "trp_player","itm_dried_meat"),
                (call_script, "script_troop_add_gold","trp_player",100),
           (else_try),
                (eq,"$character_bandit",2),##雪地强盗
                ...
                (troop_add_item, "trp_player","itm_nomad_armor"),
                (troop_add_item, "trp_player","itm_woolen_hood"),
                (troop_add_item, "trp_player","itm_hatchet"),
                (troop_add_item, "trp_player","itm_axe"),
                (troop_add_item, "trp_player","itm_hide_boots"),
                (troop_add_item, "trp_player","itm_hunting_bow"),
                (troop_add_item, "trp_player","itm_arrows"),
           ...
           (else_try),
                ...
                (troop_add_item, "trp_player","itm_green_tunic"),
                (troop_add_item, "trp_player","itm_black_hood"),
                (troop_add_item, "trp_player","itm_hatchet"),
                (troop_add_item, "trp_player","itm_axe"),
           ...
           (else_try),
                ...
                (troop_add_item, "trp_player","itm_green_tunic"),
                (troop_add_item, "trp_player","itm_head_wrappings"),
                (troop_add_item, "trp_player","itm_falchion"),
                (troop_add_item, "trp_player","itm_shortened_voulge"),
                (troop_add_item, "trp_player","itm_hunter_boots"),
                (troop_add_item, "trp_player","itm_fur_covered_shield"),
                (troop_add_item, "trp_player","itm_spear"),
                (troop_add_item, "trp_player","itm_hunting_crossbow"),
                (troop_add_item, "trp_player","itm_bolts"),
             ...
             (else_try),##沙漠强盗
                ...
                (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,30),
                (troop_raise_proficiency, "trp_player",wpt_polearm,30),
                (troop_raise_proficiency, "trp_player",wpt_throwing,70),
                (troop_raise_proficiency, "trp_player",wpt_crossbow,30),
                (troop_raise_proficiency, "trp_player",wpt_archery,40),
                
                (troop_add_item, "trp_player","itm_sarranid_cloth_robe"),
                (troop_add_item, "trp_player","itm_turban"),
                (troop_add_item, "trp_player","itm_javelin"),
                (troop_add_item, "trp_player","itm_scimitar"),
                (troop_add_item, "trp_player","itm_sarranid_boots_a"),
                (troop_add_item, "trp_player","itm_hunting_bow"),
                (troop_add_item, "trp_player","itm_arrows"),
                (troop_add_item, "trp_player","itm_arabian_horse_a"),
  ...
  ("start_undead_3",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "You grew up in a cult of undead cults formed by undead mages, and now you are sent to Kaladia to preach the teachings of the undead cults while you are being chosen by the undead cults. However, the undead and evil gods were regarded by the people of the Kaladiya continent as heretics. At the beginning you will have a hard time on this continent, but the bandits may be objects of cooperation",
    "none",
    [],
    [
       ("continue",[],"Continue ...",
        [
           ...
           (try_begin),
                ...
                (troop_raise_skill, "trp_player","skl_prisoner_management",5),
                (troop_raise_skill, "trp_player","skl_power_magic",6),
                ...
                (party_add_members, "p_main_party", "trp_undead_dragon", 2),
                (party_add_members, "p_main_party", "trp_undead_ogre", 4),
                (party_add_members, "p_main_party", "trp_angel_a", 4),
                (party_add_members, "p_main_party", "trp_necromancer_master", 4),
                (party_add_members, "p_main_party", "trp_necromancer", 8),
                (party_add_members, "p_main_party", "trp_undead_knight_b", 4),
                (party_add_members, "p_main_party", "trp_undead_knight_pluse", 8),
                (party_add_members, "p_main_party", "trp_undead_knight", 16),
                (party_add_members, "p_main_party", "trp_undead_believer", 40),
                (party_add_members, "p_main_party", "trp_undead_guard_c", 20),
                (party_add_members, "p_main_party", "trp_undead_shoot_c", 20),
                (party_add_members, "p_main_party", "trp_undead_shoot_c", 10),
                
                (troop_add_item, "trp_player","itm_heresy_magic_expert_staff"),
                (troop_add_item, "trp_player","itm_magic_undead"),
                (troop_add_item, "trp_player","itm_tab_shield_heater_cav_dragon"),
                (troop_add_item, "trp_player","itm_bone_dragon"),
                (troop_add_item, "trp_player","itm_saber_crown"),
                (troop_add_item, "trp_player","itm_critical_strike_medieval"),
                (troop_add_item, "trp_player","itm_plate_horse_5"),
                (try_begin),
                 (eq,"$character_gender",0),
                 (troop_add_item, "trp_player","itm_dark_plate_helmet_10"),
                 (troop_add_item, "trp_player","itm_dark_warrior_boots"),
                 (troop_add_item, "trp_player","itm_dark_steel_mittens"),
                 (troop_add_item, "trp_player","itm_dark_steal_plate_10"),
               (else_try),
                 (troop_add_item, "trp_player","itm_beauty_amulet_e"),
                 (troop_add_item, "trp_player","itm_carved_plate_boots_3"),   
                 (troop_add_item, "trp_player","itm_carved_gauntlets_3"),
                 (troop_add_item, "trp_player","itm_carved_plate_3"),
               (try_end),
               
                (troop_add_items, "trp_player","itm_wine",4),
                (troop_add_items, "trp_player","itm_ale",4),
                (troop_add_items, "trp_player","itm_bread",4),
                (troop_add_items, "trp_player","itm_dried_meat",4),
                (troop_add_items, "trp_player","itm_sausages",4),
                (troop_add_items, "trp_player","itm_honey",4),
                (troop_add_items, "trp_player","itm_cabbages",4),
                (troop_add_items, "trp_player","itm_grain",4),
                (call_script, "script_troop_add_gold","trp_player",50000),
              #####################################################
              (else_try),
                (eq,"$character_undead",0),
                (troop_raise_attribute, "trp_player",ca_strength,4),
                (troop_raise_attribute, "trp_player",ca_charisma,3),
                (troop_raise_attribute, "trp_player",ca_agility,6),
                ...
                (troop_raise_skill, "trp_player","skl_power_magic",4),
                (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,50),
                (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,50),
                ...
                (party_add_members, "p_main_party", "trp_undead_knight_b", 4),
                (party_add_members, "p_main_party", "trp_undead_horse", 10),
                (party_add_members, "p_main_party", "trp_undead_knight", 10),
                (party_add_members, "p_main_party", "trp_undead_shoot_d", 10),
                (party_add_members, "p_main_party", "trp_undead_shoot_c", 10),
                (party_add_members, "p_main_party", "trp_undead_believer", 20),
                (party_add_members, "p_main_party", "trp_undead_guard", 20),
                (party_add_members, "p_main_party", "trp_undead_guard_c", 10),
                (party_add_members, "p_main_party", "trp_undead_guard_a", 10),
                (party_add_members, "p_main_party", "trp_undead_shoot_b", 10),
                ...
                (try_begin),
                 ...
                 (troop_add_item, "trp_player","itm_dark_plate_helmet"),
                 (troop_add_item, "trp_player","itm_dark_steal_plate"),
                 (troop_add_item, "trp_player","itm_heresy_plate_boots"),
                 (troop_add_item, "trp_player","itm_black_steel_mittens_a"),
               (else_try),
                (troop_add_item, "trp_player","itm_charger_3_1"),
                (troop_add_item, "trp_player","itm_beauty_amulet_e"),
                (troop_add_item, "trp_player","itm_heresy_plate_boots"),
                (troop_add_item, "trp_player","itm_black_steel_mittens_a"),
                (troop_add_item, "trp_player","itm_women_plate"),
               (try_end),
               
                (troop_add_items, "trp_player","itm_wine",1),
                (troop_add_items, "trp_player","itm_ale",2),
                (troop_add_items, "trp_player","itm_bread",2),
                (troop_add_items, "trp_player","itm_dried_meat",2),
                (troop_add_items, "trp_player","itm_sausages",2),
                (troop_add_items, "trp_player","itm_honey",2),
                (troop_add_items, "trp_player","itm_cabbages",2),
                (troop_add_items, "trp_player","itm_grain",2),
                (call_script, "script_troop_add_gold","trp_player",10000),
               
           (else_try),
                (eq,"$character_undead",1),
                #(add_xp_to_troop,16161,"trp_player"),
                (troop_raise_attribute, "trp_player",ca_strength,3),
                (troop_raise_attribute, "trp_player",ca_charisma,2),
                (troop_raise_attribute, "trp_player",ca_agility,6),
                (troop_raise_attribute, "trp_player",ca_intelligence,6),
                ...
                (party_add_members, "p_main_party", "trp_undead_believer", 10),
                (party_add_members, "p_main_party", "trp_undead_guard", 10),
                (party_add_members, "p_main_party", "trp_undead_guard_c", 6),
                (party_add_members, "p_main_party", "trp_undead_guard_b", 6),
                (party_add_members, "p_main_party", "trp_undead_guard_a", 6),
                (party_add_members, "p_main_party", "trp_undead_guard_a", 6),
                (party_add_members, "p_main_party", "trp_undead_shoot_b", 6),
                
                (troop_add_item, "trp_player","itm_hunter"),
                (troop_add_item, "trp_player","itm_black_helmet"),
                (troop_add_item, "trp_player","itm_brigandine_black"),
                (troop_add_item, "trp_player","itm_black_greaves"),
                (troop_add_item, "trp_player","itm_mail_mittens"),
                (troop_add_item, "trp_player","itm_morningstar"),
                (troop_add_item, "trp_player","itm_tab_shield_kite_cav_a"),
                (troop_add_item, "trp_player","itm_heresy_magic_master_staff"),
                (troop_add_item, "trp_player","itm_magic_undead"),

                (troop_add_items, "trp_player","itm_wine",1),
                (troop_add_items, "trp_player","itm_ale",1),
                (troop_add_items, "trp_player","itm_bread",1),
                (troop_add_items, "trp_player","itm_dried_meat",1),
                (troop_add_items, "trp_player","itm_sausages",1),
                (troop_add_items, "trp_player","itm_honey",1),
                (troop_add_items, "trp_player","itm_cabbages",2),
                (troop_add_items, "trp_player","itm_grain",2),
                (call_script, "script_troop_add_gold","trp_player",5000),

           (else_try),
                (eq,"$character_undead",2),
                (troop_raise_attribute, "trp_player",ca_strength,2),
                ...
                (troop_raise_skill, "trp_player","skl_power_magic",3),
                (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,40),
                (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,40),
                (troop_raise_proficiency, "trp_player",wpt_polearm,40),
                (troop_raise_proficiency, "trp_player",wpt_crossbow,40),
                ...
                (party_add_members, "p_main_party", "trp_undead_believer", 5),
                (party_add_members, "p_main_party", "trp_undead_guard", 5),
                
                (troop_add_item, "trp_player","itm_saddle_horse"),
                (troop_add_item, "trp_player","itm_robe"),
                (troop_add_item, "trp_player","itm_nomad_boots"),
                (troop_add_item, "trp_player","itm_black_hood"),
                (troop_add_item, "trp_player","itm_magic_learn_staff"),
                (troop_add_item, "trp_player","itm_magic_undead"),
           ...
           (else_try),
                ...
                (troop_raise_skill, "trp_player","skl_inventory_management",1),
                (troop_raise_skill, "trp_player","skl_prisoner_management",1),
                (troop_raise_skill, "trp_player","skl_power_magic",2),
                (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,30),
                (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,30),
                (troop_raise_proficiency, "trp_player",wpt_polearm,30),
                (troop_raise_proficiency, "trp_player",wpt_crossbow,30),
                ...
                (troop_add_item, "trp_player","itm_nomad_boots"),
                (troop_add_item, "trp_player","itm_black_hood"),
                (troop_add_item, "trp_player","itm_magic_novice_staff"),
                (troop_add_item, "trp_player","itm_magic_undead"),
   ...
   (
    ...
    ("start_Kingdom_undead",[],"Born in Kingdom Undead.",[
      (assign,"$Born_type",cb_Kingdom_undead),
      (str_store_string,s9,"@You were born of Kingdom Undead,Life is change,chaos,filth and suffering Death is peace, order, everlasting beauty"),
	(jump_to_menu,"mnu_start_character_1"),
    ]),
    
    #("start_Swadia",[],"Born in Swadia.",[
      #(assign,"$Born_type",cb_Swadia),
      #(str_store_string,s9,"@You were born of Swadia,Fertile land, golden wheat fields on the plains, where stories of knights are told."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
    #("start_Vaegirs",[],"Born in Vaegirs.",[
      #(assign,"$Born_type",cb_Vaegirs),
      #(str_store_string,s9,"@You were born of Vaegirs,The forests of the snowy plains are sinister and cold, but they hold great wealth, iron ore and fur the hidden treasures of this frigid place.Only a strong hunter can survive in this land."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
    #("start_Khanate",[],"Born in Khanate.",[
      #(assign,"$Born_type",cb_Khanate),
      #(str_store_string,s9,"@You were born of Khanate,Endless meadows, herds of cattle and sheep,nomadic people riding on their own between the sky and the earth,but tribes fighting each other for pasture and water, All the men on the grass are doomed to become soldiers."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
   #("start_Nords",[],"Born in Nords.",[
      #(assign,"$Born_type",cb_Nords),
      #(str_store_string,s9,"@You were born of Nords,The bottomless sea, the windswept shores, the fishing boats braving the storm,these are the seeds of the Nord spirit. Like their forebears, nords can be adventurous warriors or bloodthirsty raiders."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
    #("start_Rhodoks",[],"Born in Rhodoks.",[
      #(assign,"$Born_type",cb_Rhodoks),
      #(str_store_string,s9,"@You were born of Rhodoks,It was protected by a natural wall of lofty mountains,the orchards were full of fruit trees, the markets were full of goods,caravans carried raw silk and velvet, and poets and writers sang about this place of abundance.But the lack of arable land forced many to leave their homes and rely on caravan escorts and mercenaries for a living."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
    #("start_Sarranid",[],"Born in Sarranid.",[
      #(assign,"$Born_type",cb_Sarranid),
      #(str_store_string,s9,"@You were born of Sarranid,The sand and gravel plains of the desert and the dune fields destroyed by volcanic outcrops all glowed under the heat,and endless caravans in search of wealth brought goods and goods from the distant lands of the East to Kaladia. Tales abound of salander's people getting rich overnight through trade."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
    
    #("start_Zendar",[],"Born in Zendar.",[
      #(assign,"$Born_type",cb_Zendar),
      #(str_store_string,s9,"@You were born of Zendar,The slave trade and ransom broking were the foundation of the city,where being a slave leader was as glorious as being a knight."),
	#(jump_to_menu,"mnu_start_character_1"),
    #]),
 ...
 education. You learned mainly how to defend yourself on the streets, with or without a weapon in hand."),
    ...
    ("start_forester",
    [
      (neq,"$Born_type",cb_Khanate),
      (neq,"$Born_type",cb_Sarranid),
    ],"A hunter.",[
...
##        ]),
 ...
 (
    ...
    [
      ("begin_adventuring",[],"Become an adventurer and ride to your destiny.",[
           ...
           (troop_raise_attribute, "trp_player",ca_charisma,1),
             ...
             #############################Born_type##########################################
           (try_begin),
             (eq,"$Born_type",cb_Kingdom_undead),
             (troop_raise_skill, "trp_player","skl_power_magic",2),
             (troop_raise_skill, "trp_player","skl_persuasion",1),
             (troop_raise_skill, "trp_player","skl_wound_treatment",1),
             (troop_raise_skill, "trp_player","skl_surgery",1),
           ...
           (else_try),
             (eq|this_or_next,"$Born_type",cb_Swadia),
             (eq,"$Born_type",cb_Rhodoks),
           ...
           (else_try),
             ...
             (troop_raise_skill, "trp_player","skl_looting",1),
           (else_try),
             (eq,"$Born_type",cb_Nords),
             (troop_raise_skill, "trp_player","skl_power_strike",1),
             (troop_raise_skill, "trp_player","skl_weapon_master",1),
             (troop_raise_skill, "trp_player","skl_power_throw",1),
             
           (else_try),
             (eq,"$Born_type",cb_Sarranid),
             (troop_raise_skill, "trp_player","skl_power_throw",1),
             (troop_raise_skill, "trp_player","skl_power_strike",1),
      ...
      (try_begin),
        ...
        (troop_add_item, "trp_player","itm_sword_medieval_a"),
	...
	(try_begin),
        ...
        (else_try),
            (troop_add_item, "trp_player","itm_coarse_tunic"),
        (try_end),
        ...
        (troop_add_item, "trp_player","itm_woolen_cap",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_leather_boots"),
        (troop_add_item, "trp_player","itm_leather_apron",0),
        (troop_add_item, "trp_player","itm_hammer"),
        (troop_add_item, "trp_player","itm_maul"),
    ...
    (else_try),
        ...
        (try_begin),
            (eq,"$Born_type",cb_Sarranid),
            (troop_add_item, "trp_player","itm_skirmisher_armor",0),
            (troop_add_item, "trp_player","itm_sarranid_boots_b"),
            (troop_add_item, "trp_player","itm_sarranid_felt_hat",0),
            (troop_add_item, "trp_player","itm_javelin",0),
        ...
        (else_try),
            (eq,"$Born_type",cb_Khanate),
            (troop_add_item, "trp_player","itm_khergit_armor",0),
            (troop_add_item, "trp_player","itm_nomad_boots"),
            (troop_add_item, "trp_player","itm_nomad_cap",0),
            (troop_add_item, "trp_player","itm_hunting_bow",0),
            (troop_add_item, "trp_player","itm_tutorial_arrows",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_tabard"),
        (troop_add_item, "trp_player","itm_leather_boots"),
        (troop_add_item, "trp_player","itm_sword_medieval_a"),
        (troop_add_item, "trp_player","itm_lyre"),
    ...
    (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_throwing,10),
            ...
            (try_begin),
                 ...
                 (troop_add_item, "trp_player","itm_aketon_green"),
                 (troop_add_item, "trp_player","itm_leather_boots"),
                 (troop_add_item, "trp_player","itm_mail_coif"),
                 (troop_add_item, "trp_player","itm_sword_medieval_a"),
                 (troop_add_item, "trp_player","itm_tab_shield_heater_a"),
                 (troop_add_item, "trp_player","itm_hunting_crossbow"),
                 (troop_add_item, "trp_player","itm_bolts"),
            (else_try),
                 (eq,"$Born_type",cb_Zendar),
                 (troop_raise_skill, "trp_player","skl_ironflesh",1),
                 (troop_add_item, "trp_player","itm_gambeson"),
                 (troop_add_item, "trp_player","itm_leather_boots"),
                 (troop_add_item, "trp_player","itm_footman_helmet"),
                 (troop_add_item, "trp_player","itm_winged_mace"),
            ...
            (else_try),
                 ...
                 (troop_add_item, "trp_player","itm_leather_boots"),
                 (troop_add_item, "trp_player","itm_nasal_helmet"),
                 (troop_add_item, "trp_player","itm_fighting_axe"),
                 (troop_add_item, "trp_player","itm_nordic_shield"),
                 (troop_add_item, "trp_player","itm_light_throwing_axes"),
            (else_try),
                 (eq,"$Born_type",cb_Vaegirs),
                 (troop_raise_skill, "trp_player","skl_power_strike",1),
                 (troop_add_item, "trp_player","itm_leather_jerkin"),
                 (troop_add_item, "trp_player","itm_leather_boots"),
                 (troop_add_item, "trp_player","itm_vaegir_fur_cap"),
                 (troop_add_item, "trp_player","itm_fighting_axe"),
                 (troop_add_item, "trp_player","itm_tab_shield_kite_a"),
                 (troop_add_item, "trp_player","itm_axe"),
            (else_try), 
                 (eq,"$Born_type",cb_Khanate),
                 (troop_raise_skill, "trp_player","skl_power_draw",1),
                 (troop_add_item, "trp_player","itm_nomad_vest"),
                 (troop_add_item, "trp_player","itm_nomad_boots"),
                 (troop_add_item, "trp_player","itm_leather_steppe_cap_c"),
                 (troop_add_item, "trp_player","itm_sword_khergit_1"),
                 (troop_add_item, "trp_player","itm_hunting_bow"),
                 (troop_add_item, "trp_player","itm_arrows"),
            (else_try),
                 (eq,"$Born_type",cb_Sarranid),
                 (troop_raise_skill, "trp_player","skl_power_throw",1),
                 (troop_add_item, "trp_player","itm_archers_vest"),
                 (troop_add_item, "trp_player","itm_sarranid_boots_b"),
                 (troop_add_item, "trp_player","itm_sarranid_warrior_cap"),
                 (troop_add_item, "trp_player","itm_arabian_sword_a"),
                 (troop_add_item, "trp_player","itm_tab_shield_heater_a"),
                 (troop_add_item, "trp_player","itm_jarid"),
            (else_try), 
                 (troop_raise_skill, "trp_player","skl_riding",1),
                 (troop_add_item, "trp_player","itm_red_gambeson"),
                 (troop_add_item, "trp_player","itm_leather_boots"),
                 (troop_add_item, "trp_player","itm_footman_helmet"),
                 (troop_add_item, "trp_player","itm_sword_medieval_b"),
                 (troop_add_item, "trp_player","itm_tab_shield_heater_a"),
                 (troop_add_item, "trp_player","itm_spear"),        
            (try_end),
    ...
    (else_try),
        ...
        (try_begin),
            (eq,"$Born_type",cb_Swadia),
            (troop_add_item, "trp_player","itm_wimple_with_veil"),
            (troop_add_item, "trp_player","itm_dress"),
            (troop_add_item, "trp_player","itm_hunting_crossbow"),
            (troop_add_item, "trp_player","itm_bolts"),
            (troop_add_item, "trp_player","itm_hide_boots"),
        (else_try), 
            (eq,"$Born_type",cb_Sarranid),
            (troop_add_item, "trp_player","itm_sarranid_felt_hat"),
            (troop_add_item, "trp_player","itm_sarranid_common_dress"),
            (troop_add_item, "trp_player","itm_javelin"),
            (troop_add_item, "trp_player","itm_sarranid_boots_a"),
        (else_try), 
            (eq,"$Born_type",cb_Khanate),
...
#             (start_presentation, "prsnt_custom_banner"),
  ...
  ("camp",mnf_scale_picture,
   ...
   [
     ...
     (try_begin),
        (faction_slot_eq, "fac_player_faction", slot_faction_culture, fac_culture_undead),
        (set_background_mesh, "mesh_pic_camp_undead"),
     (else_try),
    ...
    [
       ...
       [
       (set_spawn_radius,1),
       (party_add_members, "p_main_party", "trp_darkness_valkyries", 10),
       (spawn_around_party,"p_main_party","pt_test_team"),
      ...
      #(try_for_range, ":stack_no", 0, ":num_stacks"),
            ...
            #(party_wound_members, "p_main_party", ":stack_troop", 1),
      #(try_end),
       ]
      ),
        
      ("get_player_possition_on_map",
       [
        (eq,"$my_debug",1),
       ],
       "{!}get player possition on map.",
       [
         (party_get_position, pos1, "p_main_party"),
         (position_get_x,reg5,pos1),
         (position_get_y,reg6,pos1),
         (position_get_z,reg7,pos1),
         (display_message, "@x = {reg5}, y = {reg6},z = {reg7}", 0xFFFFF5EE), 
       ]
        ),
        
      ("camp_mod_opition",[],"MOD options.", [(start_presentation, "prsnt_camp_mod_opition")]),
      ...
      #    (eq,":culture","fac_culture_undead"),
       ...
       #],"evil weapon forging",
       #[ 
       #   (jump_to_menu, "mnu_evil_weapon_action"),
       #]
       #),
...
("sept_action",0,
   "Choose an sept action: you have {reg50} sept action cnt",
   "none",
   [
    (assign,reg50,"$g_necromancer_act_cnt"),
    (assign,reg51,"$g_magic_cnt"),
   ...
   [
   ("purification_captive",
     [
       (party_get_num_prisoner_stacks, ":num_prisoner_stacks","p_main_party"),           ###获取队伍囚犯兵种数量
       (gt,":num_prisoner_stacks",0),
       (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
       (gt,":free_capacity",1),
       (eq,"$sacrifice_act_ok",1),
     ],"Purification captive",
     [
     
      (store_skill_level, ":level", "skl_persuasion", "trp_player"),
      (store_attribute_level, ":int", "trp_player", ca_intelligence),
         
      (store_mul,":max",":level",3),
      (assign,reg40,0),#单位数量 reg41
      (assign,reg41,0),#献祭点 reg41
      (assign,reg42,0),#经验值 reg42
      (party_get_num_prisoner_stacks, ":num_prisoner_stacks","p_main_party"),           ###获取队伍囚犯兵种数量
      (try_for_range_backwards, ":stack_no", 0, ":num_prisoner_stacks"),              ###倒序循环全部
           (gt,":max",0),
           (party_prisoner_stack_get_troop_id, ":stack_troop","p_main_party",":stack_no"),   ###获取队伍囚犯id
           (troop_get_type,":type",":stack_troop"),
           (neq, ":stack_troop", "trp_player"),
           (neg|troop_is_hero, ":stack_troop"), ##囚犯id不是英雄
           (party_prisoner_stack_get_size, ":stack_size","p_main_party",":stack_no"), ###获取当前囚犯兵种ID数量多少
           (store_character_level,":troop_level", ":stack_troop"),
            
           (try_begin),
               (neg|is_between,":type",tf_undead,tf_undead_end),
               (store_troop_faction,":faction",":stack_troop"),
               (eq,":faction",fac_kingdom_sept),
               (party_remove_prisoners,"p_main_party",":stack_troop",":stack_size"),      ## 移除囚犯
               (party_add_members,"p_main_party",":stack_troop",":stack_size"),           ## 移除的囚犯增加到队伍
               (assign,reg39,":stack_size"),
               (str_store_troop_name_link,s8,":stack_troop"),
               (display_message, "@troops {reg39} the {s8} joins the party", color_code_hot), 
           (else_try),
               (neg|is_between,":type",tf_undead,tf_undead_end),
               (assign,":p_add_members",0),#当前兵种献祭数
                
              (try_for_range, ":stack_troop_no", 0, ":stack_size"),                   #献祭概率判断
                    (store_random_in_range,":random",0,100),
                    (assign,":success_rate",50),
                    (val_add,":success_rate",":int"),                                   #概率根据智力增加
                    (val_sub,":success_rate",":troop_level"),                           #概率兵种等级减少
                    (val_clamp,":success_rate",10,81),                                       #献祭成功率为10~80
                    (gt,":success_rate",":random"),
                    (val_add,":p_add_members",1),#该兵种献祭数 + 1
              (try_end),
                
              (gt,":p_add_members",0),
                
              (try_begin),
                  (ge,":p_add_members",":max"),
                  (assign,":p_add_members",":max"),
              (try_end),
                
             (assign,":sacrificeXp",":troop_level"),
             (val_mul,":sacrificeXp",":p_add_members"),
             #(val_mul,":sacrificeXp",2),
             (val_add,reg41,":sacrificeXp"),#邪灵点 reg41
             (val_mul,":sacrificeXp",8),
             (val_add,reg42,":sacrificeXp"),#经验值 reg42
                    
             (party_remove_prisoners,"p_main_party",":stack_troop",":p_add_members"),     
             (call_script, "script_troop_to_sept_troop",":stack_troop",1), 
             (party_add_members,"p_main_party",reg8,":p_add_members"),           
                    
             (val_sub,":max",":p_add_members"),
             (assign,reg39,":p_add_members"),
             (val_add,reg40,":p_add_members"),
             (str_store_troop_name_link,s8,reg8),
             (str_store_troop_name_link,s9,":stack_troop"),
             (display_message, "@{reg39} the number of{s9} changes to {s8} joins the troops", color_code_hot), 
         (try_end),
      (try_end), 
      
      
     (assign,"$sacrifice_act_ok",0),
     (display_message, "@A total of {reg40} prisoners were transferred ", color_code_hot),  
     (display_message, "@Sept Get total of {reg41} sacrifice cnt", color_code_hot),    
 ...
 ("necromancer_action",mnf_scale_picture,
   "Choose an necromancer action: you have {reg50} necromancer action cnt",
   "none",
   [
    (assign,reg50,"$g_necromancer_act_cnt"),
    (assign,reg51,"$g_magic_cnt"),
    ...
    (assign,reg52,":int"),
     ...
     (set_background_mesh, "mesh_pic_book_undead"),
   ...
   [
     ...
     [
       ...
       (ge,"$g_necromancer_act_cnt",2000),
       (val_sub,"$g_necromancer_act_cnt",2000),
       (assign,"$g_test_tank",1),
     ]
     ),
     ...
     ("do_missionary_work_on",
     [
      (eq,"$g_missionary_work",0),
     ],"Missionary work on",
     [
      (assign,"$g_missionary_work",1),
     ]
     ...
     ("do_missionary_work_off",
     [
      (eq,"$g_missionary_work",1),
     ],"Missionary work off",
     [
      (assign,"$g_missionary_work",0),
     ]
     ),
     ...
     [
         ...
         (try_for_range_backwards, ":stack_no", 0, ":num_prisoner_stacks"),              ###倒序循环全部
            ...
            (else_try),
               (neg|is_between,":type",tf_undead,tf_undead_end),
               (store_troop_faction,":faction",":stack_troop"),
               (eq,":faction",fac_kingdom_undead),
               (party_remove_prisoners,"p_main_party",":stack_troop",":stack_size"),      ## 移除囚犯
               (party_add_members,"p_main_party",":stack_troop",":stack_size"),           ## 移除的囚犯增加到队伍
               (assign,reg39,":stack_size"),
               (str_store_troop_name_link,s8,":stack_troop"),
               (display_message, "@troops {reg39} the {s8} joins the party", color_code_purple), 
            (else_try),
                (neg|is_between,":type",tf_undead,tf_undead_end),
                (assign,":p_add_members",0),#当前兵种献祭数
                ...
                (assign,":sacrificeXp",":troop_level"),
                (val_mul,":sacrificeXp",":p_add_members"),
                #(val_mul,":sacrificeXp",2),#加强
                (val_add,reg41,":sacrificeXp"),#邪灵点 reg41
                (val_mul,":sacrificeXp",24),
                (val_add,reg42,":sacrificeXp"),#经验值 reg42
                
                (party_remove_prisoners,"p_main_party",":stack_troop",":p_add_members"),     
                (call_script, "script_troop_to_undead_skeleton",":stack_troop"), 	 ##囚犯转换成不死族
                (party_add_members,"p_main_party",reg8,":p_add_members"),           
                ...
                (str_store_troop_name_link,s8,reg8),
                (str_store_troop_name_link,s9,":stack_troop"),
                (display_message, "@{reg39} the number of{s9} changes to {s8} joins the troops", color_code_purple), 
            (try_end),
        (try_end), 
        
      (assign,"$sacrifice_act_ok",0),
      (display_message, "@A total of {reg40} prisoners were transferred ", color_code_purple),  
      (display_message, "@Get total of {reg41} sacrifice cnt", color_code_purple),    
      (display_message, "@Undead god give you xp {reg42}", color_code_purple),
      (val_mul,reg42,xp_mul_value),
      (add_xp_to_troop,reg42,"trp_player"),
      (assign,":add_xp",reg42),
      #增加和玩家同文化的英雄经验 玩家和同伴同时加xp
      (call_script,"script_increase_the_hero_and_plyer_xp_same_culture",":add_xp",fac_kingdom_undead),
      (val_add,"$g_necromancer_act_cnt",reg41),   
    ...
    ("beg_for_grace",
     ...
     [
        (jump_to_menu, "mnu_beg_for_grace"),     
     ]
    ),
    ...
    ("beg_for_evil_things",
     ...
     [
        (start_presentation, "prsnt_necromancer_redeem_items"),    
     ]
    ),
  ...
  ("beg_for_grace",mnf_scale_picture,
   "Choose an necromancer action: you have {reg50} necromancer action cnt",
   "none",
   [
    (assign,reg50,"$g_necromancer_act_cnt"),
    
    (set_background_mesh, "mesh_pic_pray_to_the_evil_gods"),
    
   ],
   [
    ("blood_flesh_intensifies",
    [],"Blood flesh intensifies",
    [
       (try_begin),
             (ge,"$g_necromancer_act_cnt",500),
             (val_sub,"$g_necromancer_act_cnt",500), 
             (troop_raise_attribute, "$g_player_troop", ca_strength, 1),
             (display_message, "@blood flesh intensifies is ok", 0xFF9400D3),
             (play_sound,"snd_curse"),
       (else_try),
             (display_message, "@Fail necromancer action", 0xFF000000),
       (try_end),
    ]
    ),
    ...
    [
       (try_begin),
             (ge,"$g_necromancer_act_cnt",500),
             (val_sub,"$g_necromancer_act_cnt",500), 
             (display_message, "@power of the ghost is ok", 0xFF9400D3),
    ...
    ("guidance_of_the_evil_gods",
    [],"guidance of the evil gods",
    [
       (try_begin),
             (ge,"$g_necromancer_act_cnt",800),
             (val_sub,"$g_necromancer_act_cnt",800), 
             (display_message, "@guidance of the evil gods is ok", 0xFF9400D3),
  ...
  ("beg_for_army",mnf_scale_picture,
   "Choose an necromancer action: you have {reg50} necromancer action cnt",
   "none",
   [
    (assign,reg50,"$g_necromancer_act_cnt"),
    
    (set_background_mesh, "mesh_pic_fallen_angel"),
    
   ],
   [
     ("summon_undead_knight",
     [],"Summon a knight",
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",100),
             (party_add_members, "p_main_party", "trp_undead_knight_a", 1),
             (val_sub,"$g_necromancer_act_cnt",100),
             (assign,":troop","trp_undead_knight_a"),
             (str_store_troop_name_link,s4,":troop"),
             (display_message, "@Necromancer action to summon succeed", 0xFF9400D3),
             (play_sound,"snd_curse_1"),
       (else_try),
             (display_message, "@Fail necromancer action", 0xFF000000),
       (try_end),
    ...
    ("summon_guaishou",
     ...
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",120),
             (party_add_members, "p_main_party", "trp_undead_ogre", 1),
             (val_sub,"$g_necromancer_act_cnt",120),
             (assign,":troop","trp_undead_ogre"),
             (str_store_troop_name_link,s4,":troop"),
             (display_message, "@Necromancer action to summon succeed", 0xFF9400D3),
              (play_sound,"snd_curse_1"),
       (else_try),
    ...
    ("summon_angel_a",
     [],"Summon a angel undead",
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",200),
             (party_add_members, "p_main_party", "trp_angel_a", 1),
             (val_sub,"$g_necromancer_act_cnt",200),
             (assign,":troop","trp_angel_a"),
             (str_store_troop_name_link,s4,":troop"),
             (display_message, "@Necromancer action to summon succeed", 0xFF9400D3),
              (play_sound,"snd_curse_1"),
       (else_try),
    ...
    ("summon_necromancer_master",
     [],"Summon a necromancer master",
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",300),
             (party_add_members, "p_main_party", "trp_necromancer_master", 1),
             (val_sub,"$g_necromancer_act_cnt",300),
             (assign,":troop","trp_necromancer_master"),
             (str_store_troop_name_link,s4,":troop"),
             (display_message, "@Necromancer action to summon succeed", 0xFF9400D3),
              (play_sound,"snd_curse_1"),
       (else_try),
    ...
    ("summon_darkness_valkyries",
     [],"Summon a darkness valkyries",
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",300),
             (assign,":troop","trp_darkness_valkyries"),
    ...
    ("summon_undead_dragon",
     [],"Summon a undead dragon",
     [
        (try_begin),
             (ge,"$g_necromancer_act_cnt",400),
             (party_add_members, "p_main_party", "trp_undead_dragon", 1),
             (val_sub,"$g_necromancer_act_cnt",400),
             (assign,":troop","trp_undead_dragon"),
             (str_store_troop_name_link,s4,":troop"),
             (display_message, "@Necromancer action to summon succeed", 0xFF9400D3),
              (play_sound,"snd_curse_1"),
       (else_try),
   ...
   [(play_sound, "snd_cow_moo"),
    ...
    [
      ("cattle_drive_away",[],"Drive the cattle onward.",
       [
        (call_script, "script_party_set_ai_state_andit", "$g_encountered_party", spai_accompanying_army, "p_main_party"),
        (change_screen_return),
        ]
       ),
...
#          (try_end),
        ...
        (else_try),
          (eq, "$g_encountered_party_template", "pt_living_dead_team"),
          (set_background_mesh, "mesh_pic_living_dead_team"),
        (else_try),
 ...
 but you'll have to leave {reg4} soldiers behind to stop the enemy from giving chase.",
  ...
  (
    ...
    [
      ...
      (call_script, "script_party_calculate_strength", "p_main_party", 1), #exclude player #玩家部队单位强度
      (assign, ":player_party_strength", reg0),
      (display_message, "@player_party_strength = {reg0}", 0xFFFFFFFF),

      (call_script, "script_party_calculate_strength", "p_collective_enemy", 0),#敌方部队单位强度
      (assign, ":enemy_party_strength", reg0),
      (display_message, "@enemy_party_strength = {reg0}", 0xFFFFFFFF),
      
      (party_collect_attachments_to_party, "p_main_party", "p_collective_ally"),
      (call_script, "script_party_calculate_strength", "p_collective_ally", 1), #友军部队单位强度
      (assign, ":total_player_and_followers_strength", reg0),
      (display_message, "@total_player_and_followers_strength = {reg0}", 0xFFFFFFFF),
      
     
      ## CC
      (party_get_num_companions, ":num_p_main_party", "p_main_party"),##玩家部队单位数量
      (party_get_num_companions, ":num_p_collective_ally", "p_collective_ally"),#我军部队单位数量(包含了玩家部队单位数量+友军部队单位数量)
      (party_get_num_companions, ":num_p_collective_enemy", "p_collective_enemy"),#敌方部队单位数量
      (assign,":num_total_player_and_followers",":num_p_collective_ally"),#我方总计单位数量 = 我军部队单位数量

      (assign,reg4,":num_p_main_party"),
      (display_message, "@num_p_main_party= {reg4}", 0xFFFFFFFF),
      (assign,reg4,":num_p_collective_enemy"),
      (display_message, "@num_p_collective_enemy= {reg4}", 0xFFFFFFFF), 
      (assign,reg4,":num_total_player_and_followers"),
      (display_message, "@num_total_player_and_followers= {reg4}", 0xFFFFFFFF),       
      
      (store_div,":average_strength_our",":total_player_and_followers_strength",":num_total_player_and_followers"),#我单位平均部队强度
      (store_div,":average_strength_enemy",":enemy_party_strength",":num_p_collective_enemy"),#敌方单位平均部队强度
      
      (assign,reg4,":average_strength_our"),
      (display_message, "@average_strength_our= {reg4}", 0xFFFFFFFF),
      (assign,reg4,":average_strength_enemy"),
      (display_message, "@average_strength_enemy= {reg4}", 0xFFFFFFFF),
      

            
      ## 根据R大关于战术技能与战场优势详解编写的分段处理程序 https://bbs.mountblade.com.cn/forum.php?mod=viewthread&tid=102969 
      ## 进行双方上场战场人数模拟 最大值2:1
      (call_script, "script_calculate_battle_advantage"),
      (assign,":raw_advantage",reg0),
      
      (try_begin),
        (ge,":raw_advantage",5),
        (val_mul,":num_total_player_and_followers",200),#2
        (val_div,":num_total_player_and_followers",100),
     (else_try),
        (ge,":raw_advantage",4),
        (lt,":raw_advantage",5),
        (val_mul,":num_total_player_and_followers",188),#1.88
        (val_div,":num_total_player_and_followers",100),
      (else_try),
        (ge,":raw_advantage",3),
        (lt,":raw_advantage",4),
        (val_mul,":num_total_player_and_followers",168),#1.68
        (val_div,":num_total_player_and_followers",100),
      (else_try),
        (ge,":raw_advantage",2),
        (lt,":raw_advantage",3),
        (val_mul,":num_total_player_and_followers",139),#1.39
        (val_div,":num_total_player_and_followers",100),
      (else_try),
        (ge,":raw_advantage",1),
        (lt,":raw_advantage",2),
        (val_mul,":num_total_player_and_followers",123),#1.23
        (val_div,":num_total_player_and_followers",100),
      (else_try),
        (gt,":raw_advantage",0),
        (lt,":raw_advantage",1), 
        (val_mul,":num_total_player_and_followers",108),#1.08
        (val_div,":num_total_player_and_followers",100),
      (else_try),
        (eq,":raw_advantage",0),
        (val_mul,":num_total_player_and_followers",1), 
        (val_mul,":num_p_collective_enemy",1), 
      (else_try),
        (ge,":raw_advantage",-1),
        (lt,":raw_advantage",0),
        (val_mul,":num_p_collective_enemy",108),#1.08
        (val_div,":num_p_collective_enemy",100),
      (else_try),
        (ge,":raw_advantage",-2),
        (lt,":raw_advantage",-1),
        (val_mul,":num_p_collective_enemy",123),#1.23
        (val_div,":num_p_collective_enemy",100),
      (else_try),
        (ge,":raw_advantage",-3),
        (lt,":raw_advantage",-2),
        (val_mul,":num_p_collective_enemy",139),#1.39
        (val_div,":num_p_collective_enemy",100),
      (else_try),
        (ge,":raw_advantage",-4),
        (lt,":raw_advantage",-3),
        (val_mul,":num_p_collective_enemy",168),#1.68
        (val_div,":num_p_collective_enemy",100),
      (else_try),
        (ge,":raw_advantage",-5),
        (lt,":raw_advantage",-4),
        (val_mul,":num_p_collective_enemy",188),#1.88
        (val_div,":num_p_collective_enemy",100),
      (else_try),
        (val_mul,":num_p_collective_enemy",200),#2
        (val_div,":num_p_collective_enemy",100),
      (try_end),
      ...
      (display_message, "@num_total_player_and_followers= {reg4}", 0xFFFFFFFF),     
       ...
       # 设定公式：双方其中一方,平均强度较高的一方获得”平均强度增益“  平均强度增益 = (【高平均强度-低平均强度)^2 )*(高平均强度部队单位数量/低平均强度部队单位数量)
      (try_begin),
        (gt,":average_strength_our",":average_strength_enemy"),
        (store_sub,":diff_val",":average_strength_our",":average_strength_enemy"),
        (val_mul,":diff_val",":diff_val"),
        (store_mul,":temp_data",":diff_val",":num_total_player_and_followers"),
        (store_div,":gain",":temp_data",":num_p_collective_enemy"),
        (val_add,":total_player_and_followers_strength",":gain"),
      (else_try), 
        (lt,":average_strength_our",":average_strength_enemy"),
        (store_sub,":diff_val",":average_strength_enemy",":average_strength_our"),
        (val_mul,":diff_val",":diff_val"),
        (store_mul,":temp_data",":diff_val",":num_p_collective_enemy"),
        (store_div,":gain",":temp_data",":num_total_player_and_followers"),
        (val_add,":enemy_party_strength",":gain"),
      (else_try), 
        (eq,":average_strength_our",":average_strength_enemy"),
      (try_end),
      
      (assign,reg4,":total_player_and_followers_strength"),
      (display_message, "@total_player_and_followers_strength = {reg4}", 0xFFFFFFFF),
      
      (assign,reg4,":enemy_party_strength"),
      (display_message, "@enemy_party_strength= {reg4}", 0xFFFFFFFF),
      
      (assign,reg4,":total_player_and_followers_strength"),
      (display_message, "@Player and followers strength = {reg4}", 0xFFFFFFFF),
      
      (try_begin),
        (lt,":enemy_party_strength",200),
        ...
        (display_message, "@In the face of your mighty army, the enemy runs like rats, without any counterattack, leaving your army to slaughter", 0xFFFFFFFF),
     (else_try),
        (lt,":enemy_party_strength",200),
        (store_mul, ":enemy_party_strength_mult_10", ":enemy_party_strength", 7),
        (ge, ":total_player_and_followers_strength", ":enemy_party_strength_mult_10"),
        (gt,":average_strength_our",":average_strength_enemy"),
        (store_mul,":temp_data",":average_strength_our",10),
        (store_div,":temp_data",":temp_data",":average_strength_enemy"),
        (ge,":temp_data",15),
        (assign, ":enemy_party_strength", 0),
        (display_message, "@In the face of your mighty army, the enemy runs like rats, without any counterattack, leaving your army to slaughter", 0xFFFFFFFF),
      (try_end),
...
#NPC companion changes end
     ...
     #(try_begin),
       ...
       #(eq, "$g_battle_result", 1),
       #(eq, "$g_enemy_fit_for_battle", 0),
       #(call_script,"script_casualties_killed_to_undead", "p_enemy_casualties"),#胜利并且计算对手死亡人数
     #(try_end),
    ...
    [
      ("resurrect_the_corpse",
      [
        (faction_get_slot,":culture","fac_player_faction",slot_faction_culture),
        (eq,":culture","fac_culture_undead"),
        (eq, "$g_battle_result", 1),
        (eq, "$g_enemy_fit_for_battle", 0),
        (eq, "$g_resurrect_the_corpse", 0),
      ],"resurrect the corpse...",
      [

       (call_script,"script_casualties_killed_to_undead", "p_enemy_casualties"),#胜利并且计算对手死亡人数
       (jump_to_menu, "$g_next_menu"),
       (play_sound,"snd_undead_yell"),
       (assign, "$g_resurrect_the_corpse",1),
      ]),
  ...
  (
    ...
    [
     ## CC
      ...
      (assign, ":player_party_strength", reg0),
      #(val_div, ":player_party_strength", 5),#官方原程序对部队强度进行除于5处理，暂时先屏蔽，后面再处理
      (display_message, "@player_party_strength = {reg0}", 0xFFFFFFFF),

      (call_script, "script_party_calculate_strength", "p_collective_friends", 0),#p_collective_friends友军部队单位party 包括 玩家+友方
      (assign, ":friend_party_strength", reg0),
      #(val_div, ":friend_party_strength", 5),#官方原程序对部队强度进行除于5处理，暂时先屏蔽，后面再处理
      (display_message, "@friend_party_strength = {reg0}", 0xFFFFFFFF),
       
      (call_script, "script_party_calculate_strength", "p_collective_enemy", 0),#敌方部队单位party
      (assign, ":enemy_party_strength", reg0),
      #(val_div, ":enemy_party_strength", 5),#官方原程序对部队强度进行除于5处理，暂时先屏蔽，后面再处理
      (display_message, "@enemy_party_strength = {reg0}", 0xFFFFFFFF),
      
      ## CC
      
      (party_get_num_companions, ":num_p_main_party", "p_main_party"),#玩家部队单位数量
      (party_get_num_companions, ":num_p_collective_friends", "p_collective_friends"),#友军部队单位数量 = 【玩家单位数量+友军单位数量】
      (party_get_num_companions, ":num_p_collective_enemy", "p_collective_enemy"),#敌方部队单位数量
      (assign,":num_total_player_and_followers",":num_p_collective_friends"),#我方总计单位数量 = (玩家单位数量+友军单位数量)
      (assign,":total_player_and_followers_strength",":friend_party_strength"),#我方部队单位强度 = (玩家部队强度+友军强度)
      
      (assign,reg4,":num_p_main_party"),
      (display_message, "@num_p_main_party= {reg4}", 0xFFFFFFFF),
      (assign,reg4,":num_p_collective_friends"),
      (display_message, "@num_p_collective_friends= {reg4}", 0xFFFFFFFF), 
      (assign,reg4,":num_p_collective_enemy"),
      (display_message, "@num_p_collective_enemy= {reg4}", 0xFFFFFFFF),   
      (assign,reg4,":num_total_player_and_followers"),
      (display_message, "@num_total_player_and_followers= {reg4}", 0xFFFFFFFF),   
      
      #计算并保留比例数据 玩家单位数量比例 =  玩家部队单位数量/我方单位数量
      (store_mul,":num_num_p_main_party_100",":num_p_main_party",100),
      (store_div,":scale_num_p_main",":num_num_p_main_party_100",":num_total_player_and_followers"),
      
      (assign,reg4,":scale_num_p_main"),
      (display_message, "@scale_num_p_main= {reg4}", 0xFFFFFFFF),
     ...
     (else_try),
      ...
      #根据比例系数重新计算玩家与友方部队强度
      (store_mul,":player_party_strength",":total_player_and_followers_strength",":scale_num_p_main"),
      (store_div,":player_party_strength",":player_party_strength",100),
      (assign,":friend_party_strength",":total_player_and_followers_strength"),
      
      (assign,reg4,":player_party_strength"),
      (display_message, "@player_party_strength= {reg4}", 0xFFFFFFFF),
      (assign,reg4,":friend_party_strength"),
      (display_message, "@friend_party_strength= {reg4}", 0xFFFFFFFF),  
      (assign,reg4,":enemy_party_strength"),
      (display_message, "@enemy_party_strength=  {reg4}", 0xFFFFFFFF),
      
      #官方原程序对部队强度进行除于5处理，这里重新开启
  ...
  (
    ...
    [
      ...
      [
        (faction_get_slot,":culture","fac_player_supporters_faction",slot_faction_culture),
        (eq,":culture","fac_culture_undead"),
        (call_script, "script_cf_village_recruit_undead_cond"),
       ]
       ,"Recruit Volunteers.",
       [
         (try_begin),
         ...
         (else_try),
           (jump_to_menu, "mnu_missionary_cult"),
         (try_end),
        ]),
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
  ...
  (
   "missionary_cult",0,
    ...
    "none",
   [
     (party_get_slot, ":volunteer_troop", "$current_town", slot_center_believer_troop_type),
     (party_get_slot, ":volunteer_amount", "$current_town", slot_center_believer_troop_amount),
     (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
     
     (store_skill_level,":level",skl_persuasion),
     (val_mul,":volunteer_amount",":level"),
     (val_div,":volunteer_amount",10),
     
     (store_troop_gold, ":gold", "trp_player"),
     (store_div, ":gold_capacity", ":gold", 5),#10 denars per man
     ...
     (try_begin),
       ...
       (str_store_string, s18, "@Persuaion_no_one_here seems to be willing to join your party."),
     (else_try),
       (store_mul, reg6, ":volunteer_amount", 0),#0 denars per man
       (str_store_troop_name_by_count, s3, ":volunteer_troop", ":volunteer_amount"),
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@Persuaion one {s3} volunteers to follow you."),
       (else_try),
         (str_store_string, s18, "@Persuaion {reg5} {s3} volunteer to follow you."),
       (try_end),
   ...
   [
    ("continue_not_enough_gold",
      ...
      "Continue...",
      [
        (party_set_slot, "$current_town", slot_center_believer_troop_amount, -1),
        (jump_to_menu,"mnu_village"),
      ]),
      ...
      [
        (call_script, "script_village_persuade_volunteers_recruit"),
...
#NPC companion changes end
    ...
    [
      ("village_loot",[], "Plunder the village, then raze it.",
       [
          ...
          (try_begin),
            (check_quest_active, "qst_loot_Khanate_village"),
            (eq, ":village_faction","fac_kingdom_3"),
            (val_add,"$loot_Khanate_village_qst_cnt",1),
            (quest_set_slot, "qst_loot_Khanate_village", slot_quest_current_state, "$loot_Khanate_village_qst_cnt"),
            (assign,reg3,"$loot_Khanate_village_qst_cnt"),
            (display_message, "str_loot_khanate_village_message",0xDEB887),
            (try_begin),
               (ge,"$loot_Khanate_village_qst_cnt",5),
               (call_script, "script_succeed_quest", "qst_loot_Khanate_village"),
            (try_end), 
          (try_end),
 ...
 and then put the buildings to the torch. From the coins and valuables that are found, you get your share of {reg1} denars.",
    ...
    [
        ...
        (assign, ":money_gained", 500),
        (party_get_slot, ":prosperity", "$current_town", slot_town_prosperity),
        (store_mul, ":prosperity_of_town_mul_5", ":prosperity", 200),
        (val_add, ":money_gained", ":prosperity_of_town_mul_5"),
        (call_script, "script_troop_add_gold", "trp_player", ":money_gained"),
		
        (assign, ":morale_increase", 6),
    ...
    "."),
     ...
     #("town_recruit_volunteers", 
        #[
            ...
            #(eq|this_or_next, ":town_lord", "trp_player"),
            #(troop_slot_eq, "trp_player", slot_troop_spouse, ":town_lord"),	
            #(call_script, "script_cf_towns_recruit_volunteers_cond"),
        #],
       # "Recruit Volunteers.",
        #[
          # (jump_to_menu, "mnu_recruit_volunteers_towns"),
        #], 
    #"."),
      ...
      [
       ...
       #("town_criminal_activity",
           #[
             ...
             #(neq, "$players_kingdom", ":town_faction"),
             #(neq, "$players_kingdom", "$g_encountered_party_faction"),
               
           #], 
       #"Try to criminal_activity...",
       #[
          #(jump_to_menu,"mnu_start_criminal_activity"),
      # ]),
    ...
    [
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (else_try),
             #Rhodoks
             (eq|this_or_next, ":town_original_faction", "fac_kingdom_5"),
    ...
    [
	  ...
	  (try_for_range, ":walled_center", walled_centers_begin, walled_centers_end),
        ...
        (try_begin),
            ...
            (faction_set_slot, "fac_player_faction",  slot_faction_leader, "trp_player"),
        (try_end),
...
#      (else_try),
  ...
  (
    ...
    [
      ...
      (else_try),        
       ...
       (try_begin),
        (ge,":relation",0),
        (str_store_string, s3, "str_bandit_hideout_welcome"),
       (else_try),
            (try_begin),
              (party_slot_eq, "$g_encountered_party", slot_party_ai_substate, 0), #used in place of global variable
      ...
      (try_end), 
	    ...
	    (try_begin),
	      ...
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_sea_raider_lair_elder"),
          (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_sea_raiders"),
	    (else_try),	
          (gt,":template",-1),   
	      (eq, ":template", "pt_forest_bandit_lair"),
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_forest_bandit_elder"),
          (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_forest_bandits"),
	    (else_try),
          (gt,":template",-1),   
	      (eq, ":template", "pt_desert_bandit_lair"),
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_desert_bandit_elder"),
          (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_desert_bandits"),
	    (else_try),
          (gt,":template",-1),   
	      (eq, ":template", "pt_mountain_bandit_lair"),
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_mountain_bandit_elder"),
	    (else_try),
          (gt,":template",-1),   
	      (eq, ":template", "pt_taiga_bandit_lair"),
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_taiga_bandit_elder"),
          (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_taiga_bandits"),
	    (else_try),
          (gt,":template",-1),   
	      (eq, ":template", "pt_steppe_bandit_lair"),
	      (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_steppe_bandit_elder"),
          (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_steppe_bandits"),
        (else_try),
          (gt,":template",-1),   
          (is_between,":template","pt_heresy_church_fores_lair","pt_bandit_lair_templates_end"),
          (party_set_slot,"$g_encountered_party", slot_town_elder, "trp_heresy_church_elder"),
          (try_begin),
            (eq,":template","pt_heresy_church_fores_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_forest_bandits"),
          (else_try),
            (eq,":template","pt_heresy_church_steppe_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_steppe_bandits"),
          (else_try),
            (eq,":template","pt_heresy_church_desert_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_desert_bandits"),
          (else_try),
            (eq,":template","pt_heresy_church_mountain_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_mountain_bandits"),
          (else_try),
            (eq,":template","pt_heresy_church_sea_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_sea_raiders"),
         (else_try),
            (eq,":template","pt_heresy_church_taiga_lair"),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_taiga_bandits"),
         (else_try),
            (party_set_slot,"$g_encountered_party", slot_town_center, "scn_lair_forest_bandits"),
         (try_end),
    ...
    [
      ...
      [
	    ...
	    (try_begin),
	      (eq, ":template", "pt_sea_raider_lair"),
	      (assign, ":scene_to_use", "scn_lair_sea_raiders_1"),
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_sea_raider"),
          (set_visitor, 3, "trp_sea_raider_senior"),
          (set_visitor, 5, "trp_sea_raider"),
          (set_visitor, 6, "trp_sea_raider_senior"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10, "trp_sea_raider_lair_elder"),
          (set_visitor, 1,  "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
	    (else_try),	
	      (eq, ":template", "pt_forest_bandit_lair"),
	      (assign, ":scene_to_use", "scn_lair_forest_bandits_1"),
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_forest_bandit"),
          (set_visitor, 3, "trp_forest_bandit_1"),
          (set_visitor, 5, "trp_forest_bandit"),
          (set_visitor, 6, "trp_forest_bandit_1"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10, "trp_forest_bandit_elder"),
          (set_visitor, 1,  "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11, "trp_secret_ransom_broker"),
	    (else_try),
	      (eq, ":template", "pt_desert_bandit_lair"),
	      (assign, ":scene_to_use", "scn_lair_desert_bandits_1"),
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_desert_bandit"),
          (set_visitor, 3, "trp_desert_bandit_1"),
          (set_visitor, 5, "trp_desert_bandit"),
          (set_visitor, 6, "trp_desert_bandit_1"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10, "trp_desert_bandit_elder"),
          (set_visitor, 1,  "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11, "trp_secret_ransom_broker"),
	    (else_try),
	      (eq, ":template", "pt_mountain_bandit_lair"),
	      (assign, ":scene_to_use", "scn_lair_mountain_bandits_1"),
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_mountain_bandit"),
          (set_visitor, 3, "trp_mountain_bandit_1"),
          (set_visitor, 5, "trp_mountain_bandit"),
          (set_visitor, 6, "trp_mountain_bandit_1"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10, "trp_mountain_bandit_elder"),
          (set_visitor, 1,  "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11, "trp_secret_ransom_broker"),
	    (else_try),
	      (eq, ":template", "pt_taiga_bandit_lair"),
	      (assign, ":scene_to_use", "scn_lair_taiga_bandits_1"),
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_taiga_bandit"),
          (set_visitor, 3, "trp_taiga_bandit_1"),
          (set_visitor, 5, "trp_taiga_bandit"),
          (set_visitor, 6, "trp_taiga_bandit_1"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10,"trp_taiga_bandit_elder"),
          (set_visitor, 1, "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11,"trp_secret_ransom_broker"),
	    (else_try),
	      (eq, ":template", "pt_steppe_bandit_lair"),
	      (assign, ":scene_to_use", "scn_lair_steppe_bandits_1"), 
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_steppe_bandit"),
          (set_visitor, 3, "trp_steppe_bandit_1"),
          (set_visitor, 5, "trp_steppe_bandit"),
          (set_visitor, 6, "trp_steppe_bandit_1"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 8, "trp_steppe_bandit_elder_1"),
          (set_visitor, 10,"trp_steppe_bandit_elder"),
          (set_visitor, 1, "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11,"trp_secret_ransom_broker"),
        (else_try),
          ...
          (try_begin),
            (eq,":template","pt_heresy_church_fores_lair"),
            (assign, ":scene_to_use", "scn_lair_forest_bandits_1"),
            (assign, ":npc_toop", "trp_npc17"),
          (else_try),
            (eq,":template","pt_heresy_church_steppe_lair"),
            (assign, ":scene_to_use", "scn_lair_steppe_bandits_1"),
            (assign, ":npc_toop", "trp_npc18"),
          (else_try),
            (eq,":template","pt_heresy_church_desert_lair"),
            (assign, ":scene_to_use", "scn_lair_desert_bandits_1"),
            (assign, ":npc_toop", "trp_npc20"),
          (else_try),
            (eq,":template","pt_heresy_church_mountain_lair"),
            (assign, ":scene_to_use", "scn_lair_mountain_bandits_1"),
            (assign, ":npc_toop", "trp_npc19"),
          (else_try),
            (eq,":template","pt_heresy_church_sea_lair"),
            (assign, ":scene_to_use", "scn_lair_sea_raiders_1"),
            (assign, ":npc_toop", "trp_npc21"),
          (else_try),
            (eq,":template","pt_heresy_church_taiga_lair"),
            (assign, ":scene_to_use", "scn_lair_taiga_bandits_1"),
            (assign, ":npc_toop", "trp_npc22"),
          (else_try),
            (assign, ":scene_to_use", "scn_lair_forest_bandits_1"), 
         (try_end),
          ...
          (modify_visitors_at_site, ":scene_to_use"),
          (reset_visitors),
          (set_visitor, 2, "trp_undead_guard_a"),
          (set_visitor, 3, "trp_undead_shoot_a"),
          (set_visitor, 5, "trp_undead_guard_a"),
          (set_visitor, 6, "trp_undead_shoot_a"),
          (set_visitor, 7, "trp_secret_horse_merchant"),
          (set_visitor, 10,"trp_heresy_church_elder"),
          (set_visitor, 1, "trp_secret_armorer"),
          (set_visitor, 4, "trp_secret_weaponsmith"),
          (set_visitor, 9, "trp_secret_supplies"),
          (set_visitor, 11,"trp_secret_ransom_broker"),
          (try_begin),
          (ge,":npc_toop",0),
          (troop_get_slot,":slot",":npc_toop", slot_troop_occupation),
             (try_begin),
             (neq,":slot",slto_player_companion),
             (set_visitor, 12,":npc_toop"),
             (try_end),
          (try_end),
        (try_end),
        
        (set_jump_mission,"mt_lair_bandits_center"),
        (jump_to_scene, ":scene_to_use"),        
        (change_screen_mission),
      ]),
	  ...
	  [
        ...
        (else_try),
          (is_between,":template","pt_heresy_church_fores_lair","pt_bandit_lair_templates_end"),
          (assign, ":bandit_troop", "trp_undead_guard_a"),
          (try_begin),
            (eq,":template","pt_heresy_church_fores_lair"),
            (assign, ":scene_to_use", "scn_lair_forest_bandits"), 
          (else_try),
    ...
    ("continue_3",
      ...
      "I'm gonna see my big brother",
      [
          (party_get_slot, ":var_0", "$g_encountered_party", slot_town_center),
          (modify_visitors_at_site, ":var_0"),
          (reset_visitors),
          (party_get_slot, ":var_1", "$g_encountered_party", slot_town_elder),
          (set_visitor, 10, ":var_1"),
           (set_jump_mission, "mt_town_center"),
          (jump_to_scene, ":var_0"),
          (change_screen_map_conversation, ":var_1"),
     ]),
      ...
      "secret bazzar",
      [
        (jump_to_menu,"mnu_secret_bazzar"),
      ]),
 ...
 (
  "secret_bazzar",0,
  "Make peace with the secret hand",
  "none",
  [],
  [
  
   ("trade_with_secret_arms_merchant",
	   [],"trade with secret arms merchant...",
       [
          (change_screen_trade, "trp_secret_weaponsmith"),
        ]),	
    
   ("trade_with_secret_armor_merchant",
	   [],"trade with secret armor merchant...",
       [
          (change_screen_trade, "trp_secret_armorer"),
        ]),	
        
   ("trade_with_secret_horse_merchant",
	   [],"trade with secret horse merchant...",
       [
          (change_screen_trade, "trp_secret_horse_merchant"),
        ]),	
   
   ("trade_with_secret_goods_merchant",
	   [],"trade with secret goods merchant...",
       [
          (change_screen_trade, "trp_secret_supplies"),
        ]),	
        
   ("trade_with_secret_ransom_broker",
	   [],"trade with secret ransom brokert...",
       [
  ...
  ("start_phase_2_5",mnf_disable_all_keys,
    ...
    [
      (try_begin),
         (eq,"$game_mod",1),
         (str_store_string, s16, "str_undead_start"),
     (else_try),
         (eq,"$game_mod",2),
     
      (else_try),
         (eq,"$game_mod",3),
         (str_store_string, s16, "str_bandit_start"),
      (else_try),
         (str_store_string, s16, "str_civilian_mod_start"),
    ],
    [
      ("continue",[], "Continue...",
       [
        (try_begin),
             (eq,"$game_mod",1),
             (party_get_position,pos50,"$g_starting_town"),
             (position_get_x,":o_x",pos50),
             (position_get_y,":o_y",pos50),
             (val_sub,":o_x",150),
             (val_sub,":o_y",150),
             (position_set_x,pos50,":o_x"),
             (position_set_y,pos50,":o_y"),
             (party_set_position, "p_main_party", pos50),
             ...
             (try_for_range,":kingdom",npc_kingdoms_begin,npc_kingdoms_end),
               (neq,":kingdom",fac_kingdom_undead),
               (call_script,"script_change_player_relation_with_faction",":kingdom",-100), 
             (try_end),
             
             
             (call_script,"script_change_player_relation_with_faction","fac_living_dead",100),  
             (call_script,"script_change_player_relation_with_faction","fac_heresy_missionary",20), 
        ...
        (else_try),
             ...
             (call_script,"script_change_player_relation_with_faction","fac_heresy_missionary",-100),
             (call_script,"script_change_player_relation_with_faction","fac_living_dead",-100),
             (call_script,"script_change_player_relation_with_faction","fac_sea_raider",-5),  
        ...
        (else_try),
             ...
             (try_for_range,":kingdom",npc_kingdoms_begin,npc_kingdoms_end),
               (neq,":kingdom",fac_kingdom_undead),
               (call_script,"script_change_player_relation_with_faction",":kingdom",-50), 
             (try_end),
             
 
            (set_relation, "fac_outlaws", "fac_player_faction", 5),
            (set_relation, "fac_outlaws", "fac_player_supporters_faction", 5),
            (set_relation, "fac_sea_raider", "fac_player_faction", 5),
            (set_relation, "fac_sea_raider", "fac_player_supporters_faction", 5),
            (set_relation, "fac_steppe_bandit", "fac_player_faction", 5),
            (set_relation, "fac_steppe_bandit", "fac_player_supporters_faction", 5),
            (set_relation, "fac_taiga_bandit", "fac_player_faction", 5),
            (set_relation, "fac_taiga_bandit", "fac_player_supporters_faction", 5),
            (set_relation, "fac_desert_bandit", "fac_player_faction", 5),
            (set_relation, "fac_desert_bandit", "fac_player_supporters_faction", 5),
            (set_relation, "fac_mountain_bandits", "fac_player_faction", 5),
            (set_relation, "fac_mountain_bandits", "fac_player_supporters_faction", 5),
            (set_relation, "fac_forest_bandits", "fac_player_faction", 5),
            (set_relation, "fac_forest_bandits", "fac_player_supporters_faction", 5),
            
            (call_script,"script_change_player_relation_with_faction","fac_outlaws",5), 
            (call_script,"script_change_player_relation_with_faction","fac_sea_raider",5), 
            (call_script,"script_change_player_relation_with_faction","fac_steppe_bandit",5), 
            (call_script,"script_change_player_relation_with_faction","fac_taiga_bandit",5), 
            (call_script,"script_change_player_relation_with_faction","fac_desert_bandit",5), 
            (call_script,"script_change_player_relation_with_faction","fac_mountain_bandits",5), 
            (call_script,"script_change_player_relation_with_faction","fac_forest_bandits",5), 
           ...
           (try_for_range,":center",centers_begin,centers_end),
             (call_script,"script_change_player_relation_with_center",":center",-10), 
           (try_end),
  ...
  ("start_criminal_activity",menu_text_color(0xFF000000),
    "Select your criminal activityr.",
    "none",
    [],
    [
      ("stealing_from_resident",[],"Stealing from passers",
       [
        #store_skill_level               = 2170	# (store_skill_level,<destination>,<skill_id>,[troop_id]),
        (store_skill_level,":looting_level","skl_looting","trp_player"),
        (store_skill_level,":athletics_level","skl_athletics","trp_player"),
        
        (rest_for_hours, 24, 24, 0), #rest while not attackable
        (change_screen_return),
        
        (store_random_in_range, ":looting_random", 0, 12),
        (store_random_in_range, ":athletics_random", 0, 12),
        
        (try_begin),
         (gt,":looting_level",":looting_random"),
         (jump_to_menu,"mnu_stealing_from_resident_succeed"),
        (else_try),
            (try_begin),
                (gt,":athletics_level",":athletics_random"),
                (jump_to_menu,"mnu_criminal_into_town_attempted"),
            (else_try),
                (jump_to_menu,"mnu_criminal_into_town_caught"),
                (try_end),  
        (try_end),
        ]
      ),
       
      ("become_the_night_robber",
      [
      ...
      ],"Become the night robber",
      [
        (rest_for_hours_interactive, 2, 5, 0), #rest while not attackable
        (call_script, "script_player_become_bandit_check"),
       ]
      ),
       
      ("give_up_criminal",[],"Give up criminal",
       [
          (jump_to_menu,"mnu_town"),
       ]),
    ]
    ...
    (
      "stealing_from_resident_succeed",0,
      "stealing from resident succeed acquire {reg6}^ denars.",
      "none",
      [],
      [
        ("continue",[],"Continue...",
            [
                (assign, ":money_gained",10),
                (assign, ":prosperity_of_town",0),
                (assign, ":looting_of_gold",0),
                (assign, ":prosperity",0),
                (assign, ":prosperity_of_town",0),
                
                (store_skill_level, ":looting_level" , "skl_looting" , "trp_player"),
                (party_get_slot, ":prosperity", "$current_town", slot_town_prosperity),
                (store_mul, ":prosperity_of_town", ":prosperity", 1),
                (store_mul, ":looting_of_gold", ":prosperity_of_town", ":looting_level"),
                (val_add, ":money_gained", ":looting_of_gold"),
                (assign, reg6 ,":money_gained"),
                (call_script, "script_troop_add_gold", "trp_player", ":money_gained"),
                (change_screen_return),
            ]
        ), 
  ...
  (
    "criminal_into_town_caught",0,
    "While you were in the act of committing a crime, the guards discovered your wickedness and began to surround you!\
     You must flee back through the gates before all the guards in the town come down on you!",
    "none",
    [
       (assign,"$auto_menu","mnu_captivity_start_castle_surrender"),
    ...
    [
      ("sneak_caught_fight",[],"Try to fight your way out!",
       [
           (call_script, "script_crime_failure",1),
           (assign,"$all_doors_locked",1),
           (party_get_slot, ":sneak_scene", "$current_town", slot_town_center), # slot_town_gate),
           (modify_visitors_at_site,":sneak_scene"),
           (reset_visitors),
           ...
           (set_jump_mission,"mt_crime_caught_fight"),
           (set_passage_menu,"mnu_town"),
           (jump_to_scene,":sneak_scene"),
           (change_screen_mission),
        ]),
      ("sneak_caught_surrender",[],"Surrender.",
       [
           (call_script, "script_crime_failure",0),
           (jump_to_menu,"mnu_captivity_start_castle_surrender"),
        ]),
    ]
  ),
  ...
  (
   "criminal_into_town_attempted",mnf_disable_all_keys,
   "You criminal into town attempted.",
   "none",
   [],
   [
     ("continue",[],"Continue...",
      [
        (call_script,"script_crime_failure",2),
        (change_screen_return),
      ]
     ),
    ]
  ...
  ("arena_duel_fight_anyone",0,
   ...
   [
     ("continue",[],"Continue...",
      [
        ...
        (set_visitor, 0, "trp_player"),
        (set_visitor, 1, "$g_duel_troop"),
        (set_jump_mission, "mt_duel_with_anyone"),
        (jump_to_scene, ":duel_scene"),
        (change_screen_mission),        
      ]),
   ...
   (
    "town_player_become_bandits_failed",mnf_disable_all_keys,
    "TIt's really funny, the hunter turns into a hunter, the sound of fighting quickly draws the guard, you drop the unconscious you, Cang runs away, and you are caught by the guard.",
    "none",
    [],
    [
      ("continue",[],"Continue...",
        [
              ...
              (call_script, "script_crime_failure",1),
              (store_troop_gold, ":total_gold", "trp_player"),
              (store_div, ":gold_loss", ":total_gold", 4),
              (store_random_in_range, ":random_loss", 40, 100),
              (val_add, ":gold_loss", ":random_loss"),
              (val_min, ":gold_loss", ":total_gold"),
              (troop_remove_gold, "trp_player", ":gold_loss"),
  ...
  (
    "town_player_become_bandits_succeeded",mnf_disable_all_keys,
    "As a hunter, you successfully hunted a fat sheep, scraped a lot of money from the fat sheep, and you and your men quickly lost in the night before the guards arrived.",
    "none",
    [],
    [
      ("continue",[],"Continue...",
      [
       (call_script, "script_troop_add_gold", "trp_player", "$player_become_bandit_get_gold"),
       (store_skill_level,":athletics_level","skl_athletics","trp_player"),
       (rest_for_hours, 8, 10, 0), #rest while not attackable
       
       (store_random_in_range, ":random", 0, 20),
       (store_random_in_range, ":athletics_random", 0, 12),
       (try_begin),
        (ge,":random",5),
        (ge,":athletics_level",":athletics_random"),
        (change_screen_return),
       (else_try),
        (jump_to_menu,"mnu_criminal_into_town_attempted"),
   ...
   (
    "player_become_zendar_king",mnf_disable_all_keys,
    "When the wedding is over, you are king of the city of Zenda, your wife, Queen Arassis, will rule with you as Prime Minister, and the bannermen are on their way to your court, Ready to be loyal to you.",
    "none",
    [],
    [
      ("continue",[],"Continue...",
  ...
  (
    "expiry_of_employment_contract",mnf_disable_all_keys,
    "Your one month commission with {s5} has expired, the next one month commission requires {reg5} dinar. You decide:",
    "none",
    [
     (assign,"$g_hire_party","$g_sea_raider_army_party"),
     (assign,"$g_hire_target","p_main_party"),
     (assign,"$g_hire_fac","fac_player_supporters_faction"),
    
    (try_begin),
        (eq,"$hire_expiry",0),
        (assign,"$g_hire_party","$g_sea_raider_army_party"),
        (assign,"$g_hire_target","p_town_13"),
        (assign,"$g_hire_fac","fac_sea_raider"),
      (else_try),
        (eq,"$hire_expiry",1),
        (assign,"$g_hire_party","$g_desert_bandit_army_party"),
        (assign,"$g_hire_target","p_town_21"),
        (assign,"$g_hire_fac","fac_desert_bandit"),
      (else_try),
        (eq,"$hire_expiry",2),
        (assign,"$g_hire_party","$g_forest_bandits_army_party"),
        (assign,"$g_hire_target","p_town_4"),
        (assign,"$g_hire_fac","fac_forest_bandits"),
      (else_try),
        (eq,"$hire_expiry",3),
        (assign,"$g_hire_party","$g_steppe_bandit_army_party"),
        (assign,"$g_hire_target","p_town_10"),
        (assign,"$g_hire_fac","fac_steppe_bandit"),
      (else_try),
        (eq,"$hire_expiry",4),
        (assign,"$g_hire_party","$g_taiga_bandit_army_party"),
        (assign,"$g_hire_target","p_town_9"),
        (assign,"$g_hire_fac","fac_taiga_bandit"),
      (else_try),
        (eq,"$hire_expiry",5),
        (assign,"$g_hire_party","$g_mountain_bandit_army_party"),
        (assign,"$g_hire_target","p_town_3"),
        (assign,"$g_hire_fac","fac_mountain_bandits"),
      (try_end),
      
      (str_store_party_name_link,s5,"$g_hire_party"),
      (call_script,"script_calculate_party_hire","$g_hire_party"),
      (assign,reg5,reg5),
    ],
    [
       
      ("continue_employment_contract",[],"Continue employment contract",
      [
        (assign,"$g_hire_target","p_main_party"),
        (assign,"$g_hire_fac","fac_player_supporters_faction"),
        
        (call_script, "script_set_party_hire_day","$g_hire_party",30),
        (call_script, "script_party_set_ai_state_andit", "$g_hire_party", spai_accompanying_army, "$g_hire_target"),
        (party_set_faction, "$g_hire_party", "$g_hire_fac"),
        (change_screen_return),
      ]),
      
      ("refused_employment_contract",[],"Refused employment contract",
      [
       (call_script, "script_party_set_ai_state_andit", "$g_hire_party", spai_patrolling_around_center, "$g_hire_target"),
       (party_set_faction, "$g_hire_party", "$g_hire_fac"),
       (change_screen_return),
      ]),
 ...
 This will surely be your best opportunity to attack him.",
    ...
    [
      ("continue",[],"Continue...",
       [
        (set_jump_mission,"mt_back_alley_kill_local_merchant_1"),
        (assign,":town_alley","scn_town_3_alley"),
        (modify_visitors_at_site,":town_alley"),
        (reset_visitors),
        (set_visitor, 0, "trp_player"),
        (set_visitor, 1, "trp_hired_blade"),
        (set_visitor, 2, "trp_hired_blade"),
        (set_visitor, 3, "trp_rich_local_merchant"),
        (jump_to_menu, "mnu_town"),
        (jump_to_scene,":town_alley"),
        (change_screen_mission),
        ]),
  ...
  (
   "faction_kingdom_undead_invasion",0,
   "Merchants from the direction of Paravin are hurrying. It is said that an army from the world of the dead has landed in Paravin. It is rumored that this is the end of the world!",
   "none",
   [],
   [
       ("jion_to_faction_kingdom_undead",
       [   
        (faction_get_slot,":culture","fac_player_supporters_faction",slot_faction_culture),
        (eq,":culture","fac_culture_undead"),
       ],"Jion to faction kingdom undead invasion...",
       [
        (change_screen_return),
       ]),
       ...
       [   
        (faction_get_slot,":culture","fac_player_supporters_faction",slot_faction_culture),
        (neq,":culture","fac_culture_undead"),
       ],"Continue...",
       [
        (change_screen_return),
       ]),
