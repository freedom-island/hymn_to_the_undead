...
slot_item_temp_slot  = 62

#死灵之书可兑换物品
slot_item_can_be_exchangedp_from_fac_undead_slot  = 70
...
slot_agent_spearwall = 29
slot_agent_x = 30
slot_agent_y = 31
slot_agent_z = 32
slot_agent_speed = 33
slot_agent_riding_shooting_ai = 34
slot_agent_walking_shooting_ai = 35
slot_agent_archer_state = 36
slot_next_shoot_time = 37
slot_agent_next_release_time = 38

slot_agent_temp_slot = 39
#ms没有直接设定agent的接口
slot_agent_party = 40
#是否被复活 1设定给尸体代表尸体被使用无法再次利用  2设定给agent代表改agent是被复活的战斗结束要加入party
slot_agent_be_resurrection = 41

#agent魔力值
slot_agent_magic_value = 42
slot_agent_magic_wait_time = 43
slot_agent_magic_wait_cnt = 44
slot_agent_roll_wait_time = 45
slot_agent_roll_wait_cnt = 46

#因为agent死后武器掉落，故自定义slot,死之前保存。
slot_agent_item_0_slot = 50
slot_agent_item_1_slot = 51
slot_agent_item_2_slot = 52
slot_agent_item_3_slot = 53

#agent是否处于变身状体
slot_agent_transformation = 60
#亡者之夜强化
slot_agent_night_of_dead = 61
slot_agent_curse = 62
slot_agent_blessing = 63

#agent是否处于飞行状态
slot_agent_fly  = 100
#agent是否处于特殊坐骑状态
slot_agent_have_a_horse_of_agent  = 101
slot_agent_is_horse_belong_player_agent  = 102
#agent弓箭武技触发 主要是防止弓箭武技重复使用
slot_agent_is_martial_arts_bow  = 103
#agent被武技锁定
slot_locked_in_a_martial_arts_lock = 104
#agent使用战争机械
slot_agent_driving_vehicle = 105
...
slot_faction_reinforcements_d        = 151
...
slot_center_believer_troop_type  = 500
slot_center_believer_troop_amount = 501
slot_agent_own_flail =   502
slot_agent_flail_id  =   503
...
scene_prop_in_use_for_agent = 30
scene_prop_slot_speed = 20
scene_prop_slot_attack_agent = 21

scene_prop_slot_use_agent = 22
scene_prop_slot_subunit = 23
scene_prop_slot_superior = 24

scene_prop_slot_turret = 25
scene_prop_slot_gun = 26


scene_prop_slot_animation_speed = 30
scene_prop_slot_acceleration_cnt = 31
scene_prop_slot_is_animation_normal_cnt = 32
scene_prop_slot_is_fly = 33
scene_prop_slot_is_fly_sub_speed = 34
scene_prop_slot_is_fly_cnt_time = 35
scene_prop_slot_opnen_fire_cnt_time = 36
...
companions_heresy_begin = "trp_npc17"
companions_heresy_end = companions_end

companions_normal_end = companions_heresy_begin
...
active_npcs_companion_begin = "trp_npc1"
active_npcs_companion_end = "trp_npc16"
...
color_code_purple = 0xFF4B0082
color_code_hot = 0xFFFFFF00
color_code_blue = 0xFF00BFFF
color_code_white = 0xFFF8F8FF
color_code_good = 0xFFBBFFFF
color_code_bad = 0xFFFF3333

fly_y_move_min = 10
fly_y_horse_move_min = 10
z_move_up = 15
fly_y_move_div = 20
fly_x_move_div = 15
fly_z_move_div = 5
fly_y_horse_move_div = 40
fly_x_horse_move_div = 35
fly_z_horse_move_div = 5
fly_z_height_limit = 3000
fly_z_height_limit_city = 10000
beg_scale = 20
xp_mul_value = 1