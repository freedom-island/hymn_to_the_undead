...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ...
 ("deal_with_night_bandits", "Deal with Night Bandits", qf_random_quest,
  ...
  ("deal_with_sea_raiders_army", "Deal with sea raiders army", qf_random_quest,
  "{!}The Guildmaster of has asked you to deal with sea raiders army."
   ),
  
  ("deal_with_desert_bandits_army", "Deal with desert banditsarmy", qf_random_quest,
  "{!}The Guildmaster of has asked you to deal with desert banditsarmy."
  ),
  
  ("deal_with_forest_bandits_army", "Deal with forest bandits army", qf_random_quest,
  "{!}The Guildmaster of has asked you to deal with forest bandits army."
  ),
  
  ("deal_with_steppe_bandits_army", "Deal with steppe bandits army", qf_random_quest,
  "{!}The Guildmaster has asked you to deal with steppe bandits army."
  ),
  
  ("deal_with_taiga_bandits_army", "Deal with taiga bandits army ", qf_random_quest,
  "{!}The Guildmaster has asked you to deal with taiga bandits army."
  ),
  
  ("deal_with_mountain_bandits_army", "Deal with mountain bandits army", qf_random_quest,
  "{!}The Guildmaster has asked you to deal with mountain bandits army}."
  ),
  
 ("deal_skolderbrotva_team", "Deal with Skolderbrotva team", qf_random_quest,
  "{!}The Ramun has asked you to deal with Skolderbrotva team}."
  ),
  
  ("kill_local_merchant_1", "Assassinate Rich Local Merchant at {s3}", qf_random_quest,
  "{!}{s9} asked you to assassinate a rich local merchant at {s3}."
  ),
  
  ("loot_Khanate_village", "Ransacked five Kujit villages", qf_random_quest,
  "{!}Ransacked five Kujit villages."
  ),
  
  ("loot_Sarranid_merchant", "loot Sarranid merchant", qf_random_quest,
  "{!}loot Sarranid merchant."
  ),
